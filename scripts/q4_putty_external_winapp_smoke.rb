...
result = plan.merge(
  ...
  "delegated_request_type" => delegated.fetch("request_type"),
  ...
  "staged_external_winapp_acceptance_artifact_fetched" => bool(delegated, "go_owned_q4_staged_external_winapp_acceptance_artifact_fetched"),
  "staged_external_winapp_acceptance_artifact_output_path" => delegated.fetch("go_owned_q4_staged_external_winapp_acceptance_artifact_output_path", ""),
