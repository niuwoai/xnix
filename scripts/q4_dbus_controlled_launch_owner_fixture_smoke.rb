...
plan = {
  ...
  "desktop_trigger_preflight_command" => "desktop-trigger-request-preflight-preview",
  "desktop_trigger_preflight_checked" => false,
  "desktop_trigger_preflight_blocked_missing_promotion" => false,
  "desktop_trigger_preflight_ready_for_operator_request" => false,
  "desktop_trigger_preflight_owner_service_shape_verified" => false,
