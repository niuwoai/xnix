...
known_bundle_application_detail_command = [
  remote_runtime_bin,
  "external-winapp-application-detail-preview",
  "--compatibility-evidence-bundle", remote_known_bundle_compatibility_bundle,
  "--output", remote_known_bundle_application_detail
]

known_bundle_kde_page_from_detail_command = [
  remote_runtime_bin,
  "kde-center-page-preview",
...
plan = {
  ...
  "known_portable_bundle_application_detail_planned" => true,
  "known_portable_bundle_application_detail_command" => known_bundle_application_detail_command,
  "known_portable_bundle_application_detail_report" => remote_known_bundle_application_detail,
  "known_portable_bundle_application_detail_status" => "planned",
  "known_portable_bundle_kde_page_from_detail_planned" => true,
...
known_bundle_application_detail_stdout = remote_step!(
  options.fetch(:local_shell),
  remote_host,
  "cd #{Shellwords.escape(remote_source_root)} && #{shell_join(known_bundle_application_detail_command)}",
  options.fetch(:remote_timeout_seconds),
  "q4 Notepad++ Go Runtime known portable bundle application detail failed"
)
known_bundle_application_detail = JSON.parse(known_bundle_application_detail_stdout)
unless known_bundle_application_detail.fetch("request_type") == "external-winapp-application-detail-preview" &&
       known_bundle_application_detail.fetch("application_id") == "org.xnix.external.notepadplusplus" &&
       known_bundle_application_detail.fetch("display_name") == "Notepad++ Portable" &&
       known_bundle_application_detail.fetch("launch_source_request_type") == "windows-known-app-bundle-stage-and-launch" &&
       bool(known_bundle_application_detail, "known_portable_bundle_stage_launch_consumed") &&
       bool(known_bundle_application_detail, "known_portable_bundle_stage_launch_verified") &&
       bool(known_bundle_application_detail, "real_windows_app_run_verified") &&
       bool(known_bundle_application_detail, "file_open_verified") &&
       bool(known_bundle_application_detail, "runtime_gui_evidence_verified") &&
       bool(known_bundle_application_detail, "desktop_evidence_verified") &&
       bool(known_bundle_application_detail, "kde_page_evidence_verified") &&
       bool(known_bundle_application_detail, "safe_for_kde") &&
       bool(known_bundle_application_detail, "safe_for_ai_diagnostics") &&
       !bool(known_bundle_application_detail, "backend_details_exposed") &&
       !bool(known_bundle_application_detail, "raw_paths_exposed") &&
       !bool(known_bundle_application_detail, "host_root_modified")
  warn JSON.pretty_generate(known_bundle_application_detail)
  abort "q4 Notepad++ Go Runtime known portable bundle application detail did not pass"
end
known_bundle_kde_page_from_detail_stdout = remote_step!(
  options.fetch(:local_shell),
  remote_host,
  "cd #{Shellwords.escape(remote_source_root)} && #{shell_join(known_bundle_kde_page_from_detail_command)}",
  options.fetch(:remote_timeout_seconds),
  "q4 Notepad++ Go Runtime known portable bundle KDE page from detail failed"
)
known_bundle_kde_page_from_detail = JSON.parse(known_bundle_kde_page_from_detail_stdout)
known_bundle_detail_cards = known_bundle_kde_page_from_detail.fetch("external_winapp_application_detail_cards")
known_bundle_detail_card = known_bundle_detail_cards.fetch(0)
unless known_bundle_kde_page_from_detail.fetch("request_type") == "kde-center-page-preview" &&
       known_bundle_kde_page_from_detail.fetch("application_id") == "org.xnix.external.notepadplusplus" &&
       known_bundle_kde_page_from_detail.fetch("application_name") == "Notepad++ Portable" &&
       known_bundle_kde_page_from_detail.fetch("external_winapp_application_detail_count") == 1 &&
       known_bundle_detail_card.fetch("launch_source_request_type") == "windows-known-app-bundle-stage-and-launch" &&
       bool(known_bundle_detail_card, "known_portable_bundle_stage_launch_consumed") &&
       bool(known_bundle_detail_card, "known_portable_bundle_stage_launch_verified") &&
       bool(known_bundle_detail_card, "real_windows_app_run_verified") &&
       bool(known_bundle_detail_card, "file_open_verified") &&
       bool(known_bundle_detail_card, "runtime_gui_evidence_verified") &&
       bool(known_bundle_detail_card, "desktop_evidence_verified") &&
       bool(known_bundle_detail_card, "kde_page_evidence_verified") &&
       !bool(known_bundle_detail_card, "backend_details_exposed") &&
       !bool(known_bundle_detail_card, "raw_paths_exposed") &&
       !bool(known_bundle_detail_card, "host_root_modified")
  warn JSON.pretty_generate(known_bundle_kde_page_from_detail)
  abort "q4 Notepad++ Go Runtime known portable bundle KDE page from detail did not pass"
end
known_bundle_application_detail_local_path = artifact_output_root.join("known-portable-bundle-application-detail.json")
known_bundle_application_detail_fetched = fetch_remote_artifact(
  options.fetch(:local_shell),
  remote_host,
  remote_known_bundle_application_detail,
  known_bundle_application_detail_local_path,
  timeout_seconds: options.fetch(:remote_timeout_seconds)
)
known_bundle_kde_page_from_detail_local_path = artifact_output_root.join("known-portable-bundle-kde-page-from-detail.json")
known_bundle_kde_page_from_detail_fetched = fetch_remote_artifact(
  options.fetch(:local_shell),
  remote_host,
  remote_known_bundle_kde_page_from_detail,
  known_bundle_kde_page_from_detail_local_path,
  timeout_seconds: options.fetch(:remote_timeout_seconds)
)
...
plan["known_portable_bundle_application_detail_status"] = "passed"
plan["known_portable_bundle_kde_page_from_detail_status"] = "passed"
...
result = plan.merge(
  ...
  "known_portable_bundle_application_detail_status" => "passed",
  "known_portable_bundle_application_detail_request_type" => known_bundle_application_detail.fetch("request_type"),
  "known_portable_bundle_application_detail_launch_source_request_type" => known_bundle_application_detail.fetch("launch_source_request_type"),
  "known_portable_bundle_application_detail_stage_launch_consumed" => bool(known_bundle_application_detail, "known_portable_bundle_stage_launch_consumed"),
  "known_portable_bundle_application_detail_real_windows_app_run_verified" => bool(known_bundle_application_detail, "real_windows_app_run_verified"),
  "known_portable_bundle_application_detail_file_open_verified" => bool(known_bundle_application_detail, "file_open_verified"),
  "known_portable_bundle_application_detail_artifact_fetched" => known_bundle_application_detail_fetched,
  "known_portable_bundle_application_detail_artifact_output_path" => known_bundle_application_detail_local_path.to_s,
  "known_portable_bundle_kde_page_from_detail_status" => "passed",
  "known_portable_bundle_kde_page_from_detail_request_type" => known_bundle_kde_page_from_detail.fetch("request_type"),
  "known_portable_bundle_kde_page_from_detail_launch_source_request_type" => known_bundle_detail_card.fetch("launch_source_request_type"),
  "known_portable_bundle_kde_page_from_detail_stage_launch_consumed" => bool(known_bundle_detail_card, "known_portable_bundle_stage_launch_consumed"),
  "known_portable_bundle_kde_page_from_detail_artifact_fetched" => known_bundle_kde_page_from_detail_fetched,
  "known_portable_bundle_kde_page_from_detail_artifact_output_path" => known_bundle_kde_page_from_detail_local_path.to_s,
