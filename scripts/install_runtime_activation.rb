...
SOURCE_DBUS_SMOKE_RUNTIME_MODELS = PROJECT_ROOT.join("runtime/dbus/xnix_compatd_runtime_models.inc")
...
install_map = {
  ...
  SOURCE_DBUS_SMOKE_RUNTIME_MODELS => root.join("usr/runtime/dbus/xnix_compatd_runtime_models.inc"),
