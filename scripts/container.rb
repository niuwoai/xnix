...
when "winapp-container-x-gui-smoke"
  abort "Usage: ruby scripts/container.rb winapp-container-x-gui-smoke" unless ARGV.empty?

  exec(*container.winapp_container_x_gui_smoke_command)
