...
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-audit-ready-receipt-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-audit-blocked current-mainline-consumed writer-authorization-gate-consumed writer-authorization-receipt-modeled compatibility-center-and-runtime-receipts-modeled ten-receipt-items-ready-acceptance-disabled receipt-acceptance-and-writers-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-redacted-status-writer-authorization-receipt review-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-redacted-status-writer-authorization-receipt renew-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-redacted-status-writer-authorization-receipt renew-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-redacted-status-writer-authorization-receipt open-compatibility-center-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-redacted-status-writer-authorization-receipt open-compatibility-center-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-redacted-status-writer-authorization-receipt dismiss-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-redacted-status-writer-authorization-receipt dismiss-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-redacted-status-writer-authorization-receipt support-info-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-redacted-status-writer-authorization-receipt support-info-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-redacted-status-writer-authorization-receipt].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt audit must include #{token}")
end
%w[CurrentMainlineConsumed WriterAuthorizationGateAuditConsumed WriterAuthorizationGateReady WriterAuthorizationReceiptRequired WriterAuthorizationReceiptModeled WriterAuthorizationReceiptReady OpaqueWriterAuthorizationReceipt KDESafeRedactedStatusOnly CompatibilityCenterReceiptModeled RuntimeDiagnosticsReceiptModeled ReceiptPresent ReceiptAccepted AuthorizationAccepted WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled ReceiptItemCount RequiredReceiptItemCount ReadyReceiptItemCount MissingReceiptItemCount AcceptedReceiptItemCount GrantedWriterItemCount EnabledWriterItemCount PersistedWriterItemCount RawExposedReceiptItemCount SideEffectReceiptItemCount CompatibilityCenterReceiptItemCount RuntimeDiagnosticsReceiptItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_gate_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit_test.go") +
                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAuditPreviewModelsReceipt TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-audit-preview current_mainline_consumed writer_authorization_gate_audit_consumed writer_authorization_gate_ready writer_authorization_receipt_required writer_authorization_receipt_modeled writer_authorization_receipt_ready opaque_writer_authorization_receipt compatibility_center_receipt_modeled runtime_diagnostics_receipt_modeled receipt_present receipt_accepted authorization_accepted writer_authorization_granted status_writer_enabled status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled receipt_item_count ready_receipt_item_count missing_receipt_item_count accepted_receipt_item_count granted_writer_item_count enabled_writer_item_count persisted_writer_item_count raw_exposed_receipt_item_count side_effect_receipt_item_count compatibility_center_receipt_item_count runtime_diagnostics_receipt_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAcceptanceAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAcceptanceAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAcceptanceAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAcceptanceAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-acceptance-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-acceptance-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-acceptance-audit-ready-acceptance-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-acceptance-audit-blocked current-mainline-consumed writer-authorization-receipt-audit-consumed acceptance-authorization-boundary-modeled compatibility-center-and-runtime-acceptance-modeled ten-acceptance-items-ready-acceptance-disabled receipt-acceptance-writers-and-persistence-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt acceptance audit must include #{token}")
end
%w[CurrentMainlineConsumed WriterAuthorizationReceiptAuditConsumed WriterAuthorizationReceiptReady AcceptanceAuthorizationRequired AcceptanceAuthorizationModeled AcceptanceAuthorizationReady ReceiptAcceptanceBoundaryReady OpaqueWriterAuthorizationReceipt KDESafeRedactedStatusOnly CompatibilityCenterAcceptanceModeled RuntimeDiagnosticsAcceptanceModeled ReceiptPresent ReceiptAccepted AuthorizationAccepted WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled AcceptanceItemCount RequiredAcceptanceItemCount ReadyAcceptanceItemCount MissingAcceptanceItemCount AcceptedReceiptItemCount GrantedWriterItemCount EnabledWriterItemCount PersistedWriterItemCount RawExposedAcceptanceItemCount SideEffectAcceptanceItemCount CompatibilityCenterAcceptanceItemCount RuntimeDiagnosticsAcceptanceItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt acceptance audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt acceptance audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit_test.go") +
                                                                                                                                                                     read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                     read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                     read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAcceptanceAuditPreviewModelsAcceptance TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAcceptanceAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAuthorizationReceiptAcceptanceAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-authorization-receipt-acceptance-audit-preview current_mainline_consumed writer_authorization_receipt_audit_consumed writer_authorization_receipt_ready acceptance_authorization_required acceptance_authorization_modeled acceptance_authorization_ready receipt_acceptance_boundary_ready opaque_writer_authorization_receipt compatibility_center_acceptance_modeled runtime_diagnostics_acceptance_modeled receipt_present receipt_accepted authorization_accepted writer_authorization_granted status_writer_enabled status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled acceptance_item_count ready_acceptance_item_count missing_acceptance_item_count accepted_receipt_item_count granted_writer_item_count enabled_writer_item_count persisted_writer_item_count raw_exposed_acceptance_item_count side_effect_acceptance_item_count compatibility_center_acceptance_item_count runtime_diagnostics_acceptance_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer authorization receipt acceptance audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAcceptedReceiptGateAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAcceptedReceiptGateAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAcceptedReceiptGateAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAcceptedReceiptGateAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-accepted-receipt-gate-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-accepted-receipt-gate-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-accepted-receipt-gate-audit-ready-writer-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-accepted-receipt-gate-audit-blocked current-mainline-consumed writer-authorization-receipt-acceptance-audit-consumed accepted-receipt-gate-modeled compatibility-center-and-runtime-gates-modeled ten-gate-items-ready-writer-disabled receipt-writers-and-persistence-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer accepted receipt gate audit must include #{token}")
end
%w[CurrentMainlineConsumed WriterAuthorizationReceiptAcceptanceAuditConsumed WriterAuthorizationReceiptAcceptanceReady AcceptedReceiptGateRequired AcceptedReceiptGateModeled AcceptedReceiptGateReady AcceptedReceiptGateBoundaryReady OpaqueWriterAuthorizationReceipt KDESafeRedactedStatusOnly CompatibilityCenterGateModeled RuntimeDiagnosticsGateModeled ReceiptPresent ReceiptAccepted AuthorizationAccepted WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled GateItemCount RequiredGateItemCount ReadyGateItemCount MissingGateItemCount AcceptedReceiptItemCount GrantedWriterItemCount EnabledWriterItemCount PersistedWriterItemCount RawExposedGateItemCount SideEffectGateItemCount CompatibilityCenterGateItemCount RuntimeDiagnosticsGateItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer accepted receipt gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_authorization_receipt_acceptance_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer accepted receipt gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit_test.go") +
                                                                                                                                                                  read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                  read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                  read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAcceptedReceiptGateAuditPreviewModelsGate TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAcceptedReceiptGateAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterAcceptedReceiptGateAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-accepted-receipt-gate-audit-preview current_mainline_consumed writer_authorization_receipt_acceptance_audit_consumed writer_authorization_receipt_acceptance_ready accepted_receipt_gate_required accepted_receipt_gate_modeled accepted_receipt_gate_ready accepted_receipt_gate_boundary_ready opaque_writer_authorization_receipt compatibility_center_gate_modeled runtime_diagnostics_gate_modeled receipt_present receipt_accepted authorization_accepted writer_authorization_granted status_writer_enabled status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled gate_item_count ready_gate_item_count missing_gate_item_count accepted_receipt_item_count granted_writer_item_count enabled_writer_item_count persisted_writer_item_count raw_exposed_gate_item_count side_effect_gate_item_count compatibility_center_gate_item_count runtime_diagnostics_gate_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer accepted receipt gate audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterGrantAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterGrantAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterGrantAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterGrantAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-grant-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-grant-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-grant-audit-ready-writer-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-grant-audit-blocked current-mainline-consumed accepted-receipt-gate-audit-consumed writer-grant-boundary-modeled compatibility-center-and-runtime-grants-modeled ten-grant-items-ready-writer-disabled writer-grants-writers-and-persistence-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer grant audit must include #{token}")
end
%w[CurrentMainlineConsumed AcceptedReceiptGateAuditConsumed AcceptedReceiptGateReady WriterGrantRequired WriterGrantModeled WriterGrantReady WriterGrantBoundaryReady OpaqueWriterAuthorizationReceipt KDESafeRedactedStatusOnly CompatibilityCenterGrantModeled RuntimeDiagnosticsGrantModeled ReceiptPresent ReceiptAccepted AuthorizationAccepted WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled GrantItemCount RequiredGrantItemCount ReadyGrantItemCount MissingGrantItemCount AcceptedReceiptItemCount GrantedWriterItemCount EnabledWriterItemCount PersistedWriterItemCount RawExposedGrantItemCount SideEffectGrantItemCount CompatibilityCenterGrantItemCount RuntimeDiagnosticsGrantItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer grant audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_accepted_receipt_gate_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer grant audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit_test.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterGrantAuditPreviewModelsGrant TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterGrantAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterGrantAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-grant-audit-preview current_mainline_consumed accepted_receipt_gate_audit_consumed accepted_receipt_gate_ready writer_grant_required writer_grant_modeled writer_grant_ready writer_grant_boundary_ready opaque_writer_authorization_receipt compatibility_center_grant_modeled runtime_diagnostics_grant_modeled receipt_present receipt_accepted authorization_accepted writer_authorization_granted status_writer_enabled status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled grant_item_count ready_grant_item_count missing_grant_item_count accepted_receipt_item_count granted_writer_item_count enabled_writer_item_count persisted_writer_item_count raw_exposed_grant_item_count side_effect_grant_item_count compatibility_center_grant_item_count runtime_diagnostics_grant_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer grant audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterEnablementAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterEnablementAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterEnablementAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterEnablementAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-enablement-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-enablement-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-enablement-audit-ready-writer-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-enablement-audit-blocked current-mainline-consumed writer-grant-audit-consumed writer-enablement-boundary-modeled compatibility-center-and-runtime-enablement-modeled ten-enablement-items-ready-writer-disabled writer-enablement-writes-and-persistence-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer enablement audit must include #{token}")
end
%w[CurrentMainlineConsumed WriterGrantAuditConsumed WriterGrantReady WriterEnablementRequired WriterEnablementModeled WriterEnablementBoundaryReady GrantConsumptionModeled KDESafeRedactedStatusOnly CompatibilityCenterModeled RuntimeDiagnosticsModeled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled EnablementItemCount RequiredEnablementItemCount ReadyEnablementItemCount MissingEnablementItemCount GrantConsumedItemCount EnabledWriterItemCount PersistedWriterItemCount RawExposedEnablementItemCount SideEffectEnablementItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer enablement audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_grant_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer enablement audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit_test.go") +
                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterEnablementAuditPreviewModelsEnablement TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterEnablementAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterEnablementAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-enablement-audit-preview current_mainline_consumed writer_grant_audit_consumed writer_grant_ready writer_enablement_required writer_enablement_modeled writer_enablement_boundary_ready grant_consumption_modeled compatibility_center_modeled runtime_diagnostics_modeled writer_authorization_granted status_writer_enabled status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled enablement_item_count ready_enablement_item_count missing_enablement_item_count grant_consumed_item_count enabled_writer_item_count persisted_writer_item_count raw_exposed_enablement_item_count side_effect_enablement_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer enablement audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedWriterImplementationPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedWriterImplementationItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedWriterImplementationCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedWriterImplementationPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-writer-implementation-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-writer-implementation production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-writer-implementation-ready-writer-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-writer-implementation-blocked current-mainline-consumed writer-enablement-audit-consumed closed-writer-shape-modeled writer-input-and-output-boundaries-modeled ten-implementation-items-ready-call-disabled writer-calls-writes-and-persistence-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed writer implementation preview must include #{token}")
end
%w[CurrentMainlineConsumed WriterEnablementAuditConsumed WriterEnablementReady WriterImplementationRequired WriterImplementationModeled WriterImplementationReady ClosedWriterShapeModeled WriterInputBoundaryModeled WriterOutputBoundaryModeled KDESafeRedactedStatusOnly CompatibilityCenterModeled RuntimeDiagnosticsModeled WriterCallable WriterImplementationEnabled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled ImplementationItemCount RequiredImplementationItemCount ReadyImplementationItemCount MissingImplementationItemCount CallableWriterItemCount EnabledWriterItemCount PersistedWriterItemCount RawExposedImplementationItemCount SideEffectImplementationItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed writer implementation preview must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_enablement_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed writer implementation preview must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_preview_test.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedWriterImplementationPreviewModelsClosedWriter TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedWriterImplementationPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedWriterImplementationPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-writer-implementation-preview current_mainline_consumed writer_enablement_audit_consumed writer_enablement_ready writer_implementation_required writer_implementation_modeled writer_implementation_ready closed_writer_shape_modeled writer_input_boundary_modeled writer_output_boundary_modeled writer_callable writer_implementation_enabled status_writer_enabled status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled implementation_item_count ready_implementation_item_count missing_implementation_item_count callable_writer_item_count enabled_writer_item_count persisted_writer_item_count raw_exposed_implementation_item_count side_effect_implementation_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed writer implementation preview tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterPersistenceAuthorizationPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterPersistenceAuthorizationItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterPersistenceAuthorizationCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterPersistenceAuthorizationPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-persistence-authorization-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-persistence-authorization production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-persistence-authorization-ready-persistence-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-persistence-authorization-blocked current-mainline-consumed closed-writer-implementation-consumed writer-persistence-authorization-modeled compatibility-center-and-runtime-authorization-modeled ten-authorization-items-ready-persistence-disabled writer-persistence-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer persistence authorization preview must include #{token}")
end
%w[CurrentMainlineConsumed ClosedWriterImplementationConsumed ClosedWriterImplementationReady PersistenceAuthorizationRequired PersistenceAuthorizationModeled PersistenceAuthorizationReady WriterPersistenceBoundaryReady KDESafeRedactedStatusOnly CompatibilityCenterAuthorizationModeled RuntimeDiagnosticsAuthorizationModeled WriterCallable WriterImplementationEnabled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceAuthorized StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount AuthorizedPersistenceItemCount CallableWriterItemCount PersistedWriterItemCount RawExposedAuthorizationItemCount SideEffectAuthorizationItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer persistence authorization preview must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_writer_implementation_preview.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer persistence authorization preview must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_preview_test.go") +
                                                                                                                                                             read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                             read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                             read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterPersistenceAuthorizationPreviewModelsAuthorization TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterPersistenceAuthorizationPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusWriterPersistenceAuthorizationPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-writer-persistence-authorization-preview current_mainline_consumed closed_writer_implementation_consumed closed_writer_implementation_ready persistence_authorization_required persistence_authorization_modeled persistence_authorization_ready writer_persistence_boundary_ready compatibility_center_authorization_modeled runtime_diagnostics_authorization_modeled writer_callable writer_implementation_enabled status_writer_enabled status_persistence_authorized status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled authorization_item_count ready_authorization_item_count missing_authorization_item_count authorized_persistence_item_count callable_writer_item_count persisted_writer_item_count raw_exposed_authorization_item_count side_effect_authorization_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status writer persistence authorization preview tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedPersistenceWriterPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedPersistenceWriterItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedPersistenceWriterCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedPersistenceWriterPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-persistence-writer-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-persistence-writer production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-persistence-writer-ready-storage-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-persistence-writer-blocked current-mainline-consumed writer-persistence-authorization-consumed closed-persistence-writer-shape-modeled compatibility-center-and-runtime-storage-writers-modeled ten-writer-items-ready-storage-disabled closed-persistence-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed persistence writer preview must include #{token}")
end
%w[CurrentMainlineConsumed WriterPersistenceAuthorizationConsumed WriterPersistenceAuthorizationReady ClosedPersistenceWriterRequired ClosedPersistenceWriterModeled ClosedPersistenceWriterReady StorageWriterShapeModeled StorageInputBoundaryModeled StorageOutputBoundaryModeled KDESafeRedactedStatusOnly CompatibilityCenterStorageModeled RuntimeDiagnosticsStorageModeled WriterCallable ClosedPersistenceWriterEnabled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceAuthorized StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled StorageWriteEnabled WriterItemCount RequiredWriterItemCount ReadyWriterItemCount MissingWriterItemCount CallableWriterItemCount EnabledPersistenceWriterItemCount PersistedWriterItemCount RawExposedWriterItemCount SideEffectWriterItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed persistence writer preview must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_writer_persistence_authorization_preview.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed persistence writer preview must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_preview_test.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedPersistenceWriterPreviewModelsWriter TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedPersistenceWriterPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedPersistenceWriterPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-persistence-writer-preview current_mainline_consumed writer_persistence_authorization_consumed writer_persistence_authorization_ready closed_persistence_writer_required closed_persistence_writer_modeled closed_persistence_writer_ready storage_writer_shape_modeled storage_input_boundary_modeled storage_output_boundary_modeled compatibility_center_storage_modeled runtime_diagnostics_storage_modeled writer_callable closed_persistence_writer_enabled status_writer_enabled status_persistence_authorized status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled storage_write_enabled writer_item_count ready_writer_item_count missing_writer_item_count callable_writer_item_count enabled_persistence_writer_item_count persisted_writer_item_count raw_exposed_writer_item_count side_effect_writer_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed persistence writer preview tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusStoragePersistenceGateAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusStoragePersistenceGateAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusStoragePersistenceGateAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusStoragePersistenceGateAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-storage-persistence-gate-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-storage-persistence-gate-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-storage-persistence-gate-audit-ready-storage-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-storage-persistence-gate-audit-blocked current-mainline-consumed closed-persistence-writer-consumed storage-persistence-gate-modeled compatibility-center-and-runtime-storage-gates-modeled ten-gate-items-ready-storage-disabled storage-persistence-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status storage persistence gate audit must include #{token}")
end
%w[CurrentMainlineConsumed ClosedPersistenceWriterConsumed ClosedPersistenceWriterReady StoragePersistenceGateRequired StoragePersistenceGateModeled StoragePersistenceGateReady GateInputBoundaryModeled GateOutputBoundaryModeled KDESafeRedactedStatusOnly CompatibilityCenterGateModeled RuntimeDiagnosticsGateModeled WriterCallable ClosedPersistenceWriterEnabled StorageGatePassed StoragePersistenceAuthorized WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceAuthorized StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled StorageWriteEnabled GateItemCount RequiredGateItemCount ReadyGateItemCount MissingGateItemCount PassedStorageGateItemCount AuthorizedStorageItemCount CallableWriterItemCount EnabledPersistenceWriterItemCount PersistedWriterItemCount RawExposedGateItemCount SideEffectGateItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status storage persistence gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_persistence_writer_preview.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status storage persistence gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit_test.go") +
                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusStoragePersistenceGateAuditPreviewModelsGate TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusStoragePersistenceGateAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusStoragePersistenceGateAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-storage-persistence-gate-audit-preview current_mainline_consumed closed_persistence_writer_consumed closed_persistence_writer_ready storage_persistence_gate_required storage_persistence_gate_modeled storage_persistence_gate_ready gate_input_boundary_modeled gate_output_boundary_modeled compatibility_center_gate_modeled runtime_diagnostics_gate_modeled writer_callable closed_persistence_writer_enabled storage_gate_passed storage_persistence_authorized status_writer_enabled status_persistence_authorized status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled storage_write_enabled gate_item_count ready_gate_item_count missing_gate_item_count passed_storage_gate_item_count authorized_storage_item_count callable_writer_item_count enabled_persistence_writer_item_count persisted_writer_item_count raw_exposed_gate_item_count side_effect_gate_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status storage persistence gate audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusPersistenceRecordContractPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusPersistenceRecordContractItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusPersistenceRecordContractCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusPersistenceRecordContractPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-persistence-record-contract-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-persistence-record-contract production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-persistence-record-contract-ready-writes-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-persistence-record-contract-blocked current-mainline-consumed storage-persistence-gate-consumed persistence-record-contract-modeled compatibility-center-and-runtime-record-contracts-modeled ten-record-items-ready-writes-disabled persistence-record-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status persistence record contract preview must include #{token}")
end
%w[CurrentMainlineConsumed StoragePersistenceGateConsumed StoragePersistenceGateReady PersistenceRecordContractRequired PersistenceRecordContractModeled PersistenceRecordContractReady RecordShapeModeled RecordIdentityBoundaryModeled RecordRedactionBoundaryModeled KDESafeRedactedStatusOnly CompatibilityCenterRecordModeled RuntimeDiagnosticsRecordModeled WriterCallable ClosedPersistenceWriterEnabled StorageGatePassed StoragePersistenceAuthorized DurableRecordWriteEnabled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceAuthorized StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled StorageWriteEnabled RecordItemCount RequiredRecordItemCount ReadyRecordItemCount MissingRecordItemCount DurableRecordItemCount WritableRecordItemCount PersistedRecordItemCount RawExposedRecordItemCount SideEffectRecordItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status persistence record contract preview must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_storage_persistence_gate_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status persistence record contract preview must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_preview_test.go") +
                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusPersistenceRecordContractPreviewModelsRecord TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusPersistenceRecordContractPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusPersistenceRecordContractPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-persistence-record-contract-preview current_mainline_consumed storage_persistence_gate_consumed storage_persistence_gate_ready persistence_record_contract_required persistence_record_contract_modeled persistence_record_contract_ready record_shape_modeled record_identity_boundary_modeled record_redaction_boundary_modeled compatibility_center_record_modeled runtime_diagnostics_record_modeled writer_callable closed_persistence_writer_enabled storage_gate_passed storage_persistence_authorized durable_record_write_enabled status_writer_enabled status_persistence_authorized status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled storage_write_enabled record_item_count ready_record_item_count missing_record_item_count durable_record_item_count writable_record_item_count persisted_record_item_count raw_exposed_record_item_count side_effect_record_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status persistence record contract preview tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterImplementationPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterImplementationItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterImplementationCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterImplementationPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-implementation-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-implementation production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-implementation-ready-writes-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-implementation-blocked current-mainline-consumed persistence-record-contract-consumed closed-record-writer-implementation-modeled compatibility-center-and-runtime-record-writers-modeled ten-implementation-items-ready-writes-disabled closed-record-writer-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer implementation preview must include #{token}")
end
%w[CurrentMainlineConsumed PersistenceRecordContractConsumed PersistenceRecordContractReady ClosedRecordWriterImplementationRequired ClosedRecordWriterImplementationModeled ClosedRecordWriterImplementationReady RecordWriterShapeModeled RecordWriterInputBoundaryModeled RecordWriterOutputBoundaryModeled DurableRecordContractConsumed KDESafeRedactedStatusOnly CompatibilityCenterWriterModeled RuntimeDiagnosticsWriterModeled WriterCallable ClosedRecordWriterEnabled StorageGatePassed StoragePersistenceAuthorized DurableRecordWriteEnabled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceAuthorized StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled StorageWriteEnabled ImplementationItemCount RequiredImplementationItemCount ReadyImplementationItemCount MissingImplementationItemCount CallableRecordWriterItemCount EnabledRecordWriterItemCount DurableWrittenRecordItemCount PersistedRecordItemCount RawExposedImplementationItemCount SideEffectImplementationItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer implementation preview must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_persistence_record_contract_preview.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer implementation preview must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_preview_test.go") +
                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterImplementationPreviewModelsWriter TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterImplementationPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterImplementationPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-implementation-preview current_mainline_consumed persistence_record_contract_consumed persistence_record_contract_ready closed_record_writer_implementation_required closed_record_writer_implementation_modeled closed_record_writer_implementation_ready record_writer_shape_modeled record_writer_input_boundary_modeled record_writer_output_boundary_modeled durable_record_contract_consumed compatibility_center_writer_modeled runtime_diagnostics_writer_modeled writer_callable closed_record_writer_enabled storage_gate_passed storage_persistence_authorized durable_record_write_enabled status_writer_enabled status_persistence_authorized status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled storage_write_enabled implementation_item_count ready_implementation_item_count missing_implementation_item_count callable_record_writer_item_count enabled_record_writer_item_count durable_written_record_item_count persisted_record_item_count raw_exposed_implementation_item_count side_effect_implementation_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer implementation preview tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootPolicyAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootPolicyItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootPolicyCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootPolicyAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-policy-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-policy-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-policy-audit-ready-writes-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-policy-audit-blocked current-mainline-consumed closed-record-writer-consumed storage-root-policy-modeled compatibility-center-and-runtime-storage-root-policies-modeled ten-policy-items-ready-writes-disabled storage-root-and-writer-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root policy audit must include #{token}")
end
%w[CurrentMainlineConsumed ClosedRecordWriterConsumed ClosedRecordWriterReady StorageRootPolicyRequired StorageRootPolicyModeled StorageRootPolicyReady StorageRootOwnershipModeled StorageRootNamespaceModeled StorageRootRetentionModeled StorageRootRedactionModeled RecordWriterCallGuardModeled KDESafeRedactedStatusOnly CompatibilityCenterPolicyModeled RuntimeDiagnosticsPolicyModeled WriterCallable ClosedRecordWriterEnabled StorageRootResolved StorageRootCreated StorageRootMounted StorageRootOwnershipGranted StorageRootNamespaceGranted StorageRetentionEnforced StorageRedactionEnforced StorageGatePassed StoragePersistenceAuthorized DurableRecordWriteEnabled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceAuthorized StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled StorageWriteEnabled PolicyItemCount RequiredPolicyItemCount ReadyPolicyItemCount MissingPolicyItemCount ResolvedStorageRootItemCount GrantedStorageRootItemCount EnforcedRetentionItemCount EnforcedRedactionItemCount CallableWriterItemCount EnabledRecordWriterItemCount DurableWrittenRecordItemCount RawExposedPolicyItemCount SideEffectPolicyItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root policy audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_implementation_preview.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root policy audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_audit_test.go") +
                                                                                                                                                                 read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                 read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                 read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootPolicyAuditPreviewModelsPolicy TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootPolicyAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootPolicyAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-policy-audit-preview current_mainline_consumed closed_record_writer_consumed closed_record_writer_ready storage_root_policy_required storage_root_policy_modeled storage_root_policy_ready storage_root_ownership_modeled storage_root_namespace_modeled storage_root_retention_modeled storage_root_redaction_modeled record_writer_call_guard_modeled compatibility_center_policy_modeled runtime_diagnostics_policy_modeled writer_callable closed_record_writer_enabled storage_root_resolved storage_root_created storage_root_mounted storage_root_ownership_granted storage_root_namespace_granted storage_retention_enforced storage_redaction_enforced storage_gate_passed storage_persistence_authorized durable_record_write_enabled status_writer_enabled status_persistence_authorized status_persistence_write_enabled kde_status_write_enabled runtime_diagnostics_write_enabled storage_write_enabled policy_item_count ready_policy_item_count missing_policy_item_count resolved_storage_root_item_count granted_storage_root_item_count enforced_retention_item_count enforced_redaction_item_count callable_writer_item_count enabled_record_writer_item_count durable_written_record_item_count raw_exposed_policy_item_count side_effect_policy_item_count compatibility_center_item_count runtime_diagnostics_item_count kde_status_persisted runtime_diagnostics_persisted state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root policy audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_audit.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptConsumptionAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptConsumptionItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptConsumptionCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptConsumptionAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-consumption-audit-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-consumption-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-consumption-audit-ready-writes-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-consumption-audit-blocked current-mainline-consumed storage-root-policy-consumed authorization-receipt-consumption-modeled compatibility-center-and-runtime-consumption-modeled ten-consumption-items-ready-writes-disabled authorization-consumption-and-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt consumption audit must include #{token}")
end
%w[CurrentMainlineConsumed StorageRootPolicyConsumed StorageRootPolicyReady AuthorizationReceiptConsumptionRequired AuthorizationReceiptConsumptionModeled AuthorizationReceiptConsumptionReady AcceptedReceiptBoundaryModeled ReceiptScopeBoundaryModeled StorageRootPolicyGrantBoundaryModeled RecordWriterCallGrantBoundaryModeled KDESafeRedactedStatusOnly CompatibilityCenterConsumptionModeled RuntimeDiagnosticsConsumptionModeled ReceiptPresent ReceiptAccepted ReceiptConsumed StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable ClosedRecordWriterEnabled StorageRootResolved StorageRootCreated StorageRootMounted StorageRootOwnershipGranted StorageRootNamespaceGranted StorageRetentionEnforced StorageRedactionEnforced StorageGatePassed StoragePersistenceAuthorized DurableRecordWriteEnabled WriterAuthorizationGranted StatusWriterEnabled StatusPersistenceAuthorized StatusPersistenceWriteEnabled KDEStatusWriteEnabled RuntimeDiagnosticsWriteEnabled StorageWriteEnabled ConsumptionItemCount RequiredConsumptionItemCount ReadyConsumptionItemCount MissingConsumptionItemCount AcceptedReceiptItemCount ConsumedReceiptItemCount AuthorizedStorageRootGrantItemCount AuthorizedRecordWriterCallItemCount CallableWriterItemCount EnabledRecordWriterItemCount DurableWrittenRecordItemCount RawExposedConsumptionItemCount SideEffectConsumptionItemCount CompatibilityCenterItemCount RuntimeDiagnosticsItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted SnapshotRestoreExecuted StateCleanupExecuted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt consumption audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_policy_audit.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt consumption audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_audit_test.go") +
                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptConsumptionAuditPreviewModelsConsumption TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptConsumptionAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptConsumptionAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-consumption-audit-preview current_mainline_consumed storage_root_policy_consumed storage_root_policy_ready authorization_receipt_consumption_required authorization_receipt_consumption_modeled authorization_receipt_consumption_ready accepted_receipt_boundary_modeled receipt_scope_boundary_modeled storage_root_policy_grant_boundary_modeled record_writer_call_grant_boundary_modeled compatibility_center_consumption_modeled runtime_diagnostics_consumption_modeled receipt_present receipt_accepted receipt_consumed storage_root_policy_grant_authorized record_writer_call_authorized writer_callable closed_record_writer_enabled storage_root_resolved storage_write_enabled consumption_item_count ready_consumption_item_count missing_consumption_item_count accepted_receipt_item_count consumed_receipt_item_count authorized_storage_root_grant_item_count authorized_record_writer_call_item_count callable_writer_item_count enabled_record_writer_item_count durable_written_record_item_count raw_exposed_consumption_item_count side_effect_consumption_item_count compatibility_center_item_count runtime_diagnostics_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt consumption audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupEvidencePreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupEvidenceItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupEvidenceCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupEvidencePreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-evidence-preview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-evidence production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-evidence-ready-writes-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-evidence-blocked current-mainline-consumed authorization-receipt-consumption-audit-consumed authorization-receipt-dry-run-lookup-evidence-modeled compatibility-center-and-runtime-dry-run-lookup-evidence-modeled ten-dry-run-lookup-evidence-items-ready-writes-disabled authorization-dry-run-lookup-evidence-and-writes-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup evidence must include #{token}")
end
%w[CurrentMainlineConsumed AuthorizationReceiptConsumptionAuditConsumed AuthorizationReceiptConsumptionAuditReady AuthorizationReceiptDryRunLookupEvidenceRequired AuthorizationReceiptDryRunLookupEvidenceModeled AuthorizationReceiptDryRunLookupEvidenceReady AcceptedReceiptBoundaryModeled ReceiptScopeBoundaryModeled StorageRootPolicyGrantBoundaryModeled RecordWriterCallGrantBoundaryModeled KDESafeRedactedStatusOnly CompatibilityCenterDryRunLookupEvidenceModeled RuntimeDiagnosticsDryRunLookupEvidenceModeled ReceiptPresent ReceiptAccepted ReceiptConsumed StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable ClosedRecordWriterEnabled StorageRootResolved StorageWriteEnabled DryRunLookupEvidenceItemCount RequiredDryRunLookupEvidenceItemCount ReadyDryRunLookupEvidenceItemCount MissingDryRunLookupEvidenceItemCount RawExposedDryRunLookupEvidenceItemCount SideEffectDryRunLookupEvidenceItemCount ConsumerDryRunLookupEvidenceAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SupportBundleExported SupportCaseCreated RuntimeOwned GoRuntimeBacked KDEPolicyOwner ProductionReadiness ProductionOwnershipReady SystemServiceStarted SessionBusClaimed ProductionBusClaimed ProductionOwnerEnabled WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SettingsPersisted AdapterInvocationEnabled BackendLaunchEnabled BackendProcessStarted NetworkRequired HostRootModified PrivilegedContainerRequired CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead RawCommandExposed RawExecutableExposed BackendDetailsExposed validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup evidence must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_audit.go production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_consumption_audit_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup evidence must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_test.go") +
                                                                                                                                                                                           read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                           read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                           read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupEvidencePreviewModelsDryRunLookupEvidence TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupEvidencePreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupEvidencePreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-evidence-preview current_mainline_consumed authorization_receipt_consumption_audit_consumed authorization_receipt_consumption_audit_ready authorization_receipt_dry_run_lookup_evidence_required authorization_receipt_dry_run_lookup_evidence_modeled authorization_receipt_dry_run_lookup_evidence_ready accepted_receipt_boundary_modeled receipt_scope_boundary_modeled storage_root_policy_grant_boundary_modeled record_writer_call_grant_boundary_modeled compatibility_center_dry_run_lookup_evidence_modeled runtime_diagnostics_dry_run_lookup_evidence_modeled receipt_present receipt_accepted receipt_consumed storage_root_policy_grant_authorized record_writer_call_authorized writer_callable closed_record_writer_enabled storage_root_resolved storage_write_enabled dry_run_lookup_evidence_item_count ready_dry_run_lookup_evidence_item_count missing_dry_run_lookup_evidence_item_count raw_exposed_dry_run_lookup_evidence_item_count side_effect_dry_run_lookup_evidence_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup evidence tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultBoundaryPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultBoundaryItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultBoundaryCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultBoundaryPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-boundary-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-boundary-ready-writes-disabled authorization-receipt-dry-run-lookup-evidence-consumed authorization-receipt-dry-run-lookup-result-boundary-modeled redacted_lookup_result_identity_modeled redacted_lookup_result_readiness_modeled redacted_lookup_result_failure_boundary_modeled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result boundary must include #{token}")
end
%w[CurrentMainlineConsumed AuthorizationReceiptDryRunLookupEvidenceConsumed AuthorizationReceiptDryRunLookupEvidenceReady AuthorizationReceiptDryRunLookupResultBoundaryRequired AuthorizationReceiptDryRunLookupResultBoundaryModeled AuthorizationReceiptDryRunLookupResultBoundaryReady RedactedLookupResultIdentityModeled RedactedLookupResultReadinessModeled RedactedLookupResultFailureBoundaryModeled ReceiptPresent ReceiptAccepted ReceiptConsumed StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable ClosedRecordWriterEnabled StorageRootResolved StorageWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized LookupRouteEnabled OpaqueLookupEnabled RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result boundary must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence.go production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_evidence_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result boundary must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_test.go") +
                                                                                                                                                                                                  read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                  read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                  read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultBoundaryPreviewModelsDryRunLookupResultBoundary TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultBoundaryPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultBoundaryPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-boundary-preview current_mainline_consumed authorization_receipt_dry_run_lookup_evidence_consumed authorization_receipt_dry_run_lookup_evidence_ready authorization_receipt_dry_run_lookup_result_boundary_required authorization_receipt_dry_run_lookup_result_boundary_modeled authorization_receipt_dry_run_lookup_result_boundary_ready redacted_lookup_result_identity_modeled redacted_lookup_result_readiness_modeled redacted_lookup_result_failure_boundary_modeled receipt_present receipt_accepted receipt_consumed storage_root_policy_grant_authorized record_writer_call_authorized writer_callable closed_record_writer_enabled storage_root_resolved storage_write_enabled dry_run_lookup_result_boundary_item_count ready_dry_run_lookup_result_boundary_item_count missing_dry_run_lookup_result_boundary_item_count raw_exposed_dry_run_lookup_result_boundary_item_count side_effect_dry_run_lookup_result_boundary_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result boundary tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-ready-writes-disabled authorization-receipt-dry-run-lookup-result-boundary-consumed result-consumer-projection-modeled compatibility-center-and-runtime-result-consumer-projections-modeled ten-result-consumer-projection-items-ready-writes-disabled result-consumer-projection-and-writes-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection must include #{token}")
end
%w[CurrentMainlineConsumed AuthorizationReceiptDryRunLookupResultBoundaryConsumed AuthorizationReceiptDryRunLookupResultBoundaryReady ResultConsumerProjectionRequired ResultConsumerProjectionModeled ResultConsumerProjectionReady CompatibilityCenterProjectionModeled RuntimeDiagnosticsProjectionModeled RedactedLookupResultProjectionModeled UserVisibleProjectionModeled FailureProjectionModeled KDESafeRedactedStatusOnly ReceiptPresent ReceiptAccepted ReceiptConsumed StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary.go production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_boundary_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_preview_test.go") +
                                                                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionPreviewModelsConsumerProjection TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-preview current_mainline_consumed authorization_receipt_dry_run_lookup_result_boundary_consumed authorization_receipt_dry_run_lookup_result_boundary_ready result_consumer_projection_required result_consumer_projection_modeled result_consumer_projection_ready compatibility_center_projection_modeled runtime_diagnostics_projection_modeled redacted_lookup_result_projection_modeled user_visible_projection_modeled failure_projection_modeled receipt_present receipt_accepted receipt_consumed storage_root_policy_grant_authorized record_writer_call_authorized writer_callable storage_write_enabled consumer_projection_item_count ready_consumer_projection_item_count missing_consumer_projection_item_count raw_exposed_consumer_projection_item_count side_effect_consumer_projection_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionEvidenceAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionEvidenceAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionEvidenceAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionEvidenceAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-evidence-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-evidence-audit-ready-writes-disabled result-consumer-projection-preview-consumed result-consumer-projection-evidence-audited compatibility-center-and-runtime-projection-evidence-audited ten-projection-evidence-items-ready-writes-disabled projection-evidence-and-writes-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection evidence audit must include #{token}")
end
%w[CurrentMainlineConsumed ResultConsumerProjectionPreviewConsumed ResultConsumerProjectionPreviewReady ResultConsumerProjectionEvidenceRequired ResultConsumerProjectionEvidenceAudited ResultConsumerProjectionEvidenceReady CompatibilityCenterEvidenceAudited RuntimeDiagnosticsEvidenceAudited RedactedProjectionEvidenceAudited UserVisibleEvidenceAudited FailureProjectionEvidenceAudited KDESafeRedactedStatusOnly ReceiptPresent ReceiptAccepted ReceiptConsumed StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection evidence audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_preview.go production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection evidence audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_test_source = read_project_file("internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_preview_test.go") +
                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionEvidenceAuditPreviewAuditsProjectionEvidence TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionEvidenceAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionEvidenceAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-evidence-audit-preview current_mainline_consumed result_consumer_projection_preview_consumed result_consumer_projection_preview_ready result_consumer_projection_evidence_required result_consumer_projection_evidence_audited result_consumer_projection_evidence_ready compatibility_center_evidence_audited runtime_diagnostics_evidence_audited redacted_projection_evidence_audited user_visible_evidence_audited failure_projection_evidence_audited receipt_present receipt_accepted receipt_consumed storage_root_policy_grant_authorized record_writer_call_authorized writer_callable storage_write_enabled evidence_item_count ready_evidence_item_count missing_evidence_item_count raw_exposed_evidence_item_count side_effect_evidence_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection evidence audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_authorization_evidence_gate_source = read_project_file("internal/runtime/owner/route_authorization_evidence_gate_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteAuthorizationEvidenceGatePreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteAuthorizationEvidenceGateItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteAuthorizationEvidenceGateCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteAuthorizationEvidenceGatePreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_authorization_evidence_gate.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-authorization-evidence-gate-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-authorization-evidence-gate-ready-routes-disabled result-consumer-projection-evidence-audit-consumed result-consumer-projection-route-authorization-evidence-gated compatibility-center-and-runtime-route-authorization-evidence-gated ten-route-authorization-evidence-items-ready-routes-disabled route-authorization-evidence-and-writes-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_authorization_evidence_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route authorization evidence gate must include #{token}")
end
%w[CurrentMainlineConsumed ResultConsumerProjectionEvidenceAuditConsumed ResultConsumerProjectionEvidenceAuditReady RouteAuthorizationEvidenceGateRequired ResultConsumerProjectionRouteAuthorizationEvidenceGated RouteAuthorizationEvidenceGateReady CompatibilityCenterRouteAuthorizationEvidenceGated RuntimeDiagnosticsRouteAuthorizationEvidenceGated RedactedProjectionRouteAuthorizationEvidenceGated UserVisibleRouteAuthorizationEvidenceGated FailureProjectionRouteAuthorizationEvidenceGated KDESafeRedactedStatusOnly ReceiptPresent ReceiptAccepted ReceiptConsumed StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_authorization_evidence_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route authorization evidence gate must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_preview.go production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_evidence_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_authorization_evidence_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route authorization evidence gate must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_authorization_evidence_gate_test_source = read_project_file("internal/runtime/owner/route_authorization_evidence_gate_preview_test.go") +
                                                                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteAuthorizationEvidenceGatePreviewAuditsProjectionEvidence TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteAuthorizationEvidenceGatePreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteAuthorizationEvidenceGatePreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-authorization-evidence-gate-preview current_mainline_consumed result_consumer_projection_evidence_audit_consumed result_consumer_projection_evidence_audit_ready route_authorization_evidence_gate_required result_consumer_projection_route_authorization_evidence_gated route_authorization_evidence_gate_ready compatibility_center_route_authorization_evidence_gated runtime_diagnostics_route_authorization_evidence_gated redacted_projection_route_authorization_evidence_gated user_visible_route_authorization_evidence_gated failure_projection_route_authorization_evidence_gated receipt_present receipt_accepted receipt_consumed storage_root_policy_grant_authorized record_writer_call_authorized writer_callable storage_write_enabled evidence_item_count ready_evidence_item_count missing_evidence_item_count raw_exposed_evidence_item_count side_effect_evidence_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_authorization_evidence_gate_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route authorization evidence gate tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_evidence_gate_source = read_project_file("internal/runtime/owner/route_enablement_evidence_gate_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementEvidenceGatePreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementEvidenceGateItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementEvidenceGateCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementEvidenceGatePreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_evidence_gate.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-evidence-gate-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-evidence-gate-ready-routes-disabled route-authorization-evidence-gate-consumed result-consumer-projection-route-enablement-gated compatibility-center-and-runtime-route-enablement-gated ten-route-enablement-evidence-items-ready-routes-disabled route-enablement-evidence-and-writes-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_evidence_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement evidence gate must include #{token}")
end
%w[CurrentMainlineConsumed RouteAuthorizationEvidenceGateConsumed RouteAuthorizationEvidenceGateReady RouteEnablementEvidenceGateRequired ResultConsumerProjectionRouteEnablementGated RouteEnablementEvidenceGateReady CompatibilityCenterRouteEnablementGated RuntimeDiagnosticsRouteEnablementGated RedactedProjectionRouteEnablementGated UserVisibleRouteEnablementGated FailureProjectionRouteEnablementGated KDESafeRedactedStatusOnly ReceiptPresent ReceiptAccepted ReceiptConsumed StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_evidence_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement evidence gate must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_authorization_evidence_gate_preview.go route_authorization_evidence_gate_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_evidence_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement evidence gate must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_evidence_gate_test_source = read_project_file("internal/runtime/owner/route_enablement_evidence_gate_preview_test.go") +
                                                                                                                                                                                                                                read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementEvidenceGatePreviewAuditsRouteAuthorizationGate TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementEvidenceGatePreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementEvidenceGatePreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-evidence-gate-preview current_mainline_consumed route_authorization_evidence_gate_consumed route_authorization_evidence_gate_ready route_enablement_evidence_gate_required result_consumer_projection_route_enablement_gated route_enablement_evidence_gate_ready compatibility_center_route_enablement_gated runtime_diagnostics_route_enablement_gated redacted_projection_route_enablement_gated user_visible_route_enablement_gated failure_projection_route_enablement_gated receipt_present receipt_accepted receipt_consumed storage_root_policy_grant_authorized record_writer_call_authorized writer_callable storage_write_enabled evidence_item_count ready_evidence_item_count missing_evidence_item_count raw_exposed_evidence_item_count side_effect_evidence_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_evidence_gate_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement evidence gate tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_gate_source = read_project_file("internal/runtime/owner/route_enablement_receipt_gate_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptGatePreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptGateItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptGateCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptGatePreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_gate.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-receipt-gate-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-receipt-gate-ready-routes-disabled route-enablement-evidence-gate-consumed operator-reviewed-receipt-gate-modeled compatibility-center-and-runtime-receipt-gates-modeled ten-receipt-gate-items-ready-routes-disabled receipt-writes-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt gate must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementEvidenceGateConsumed RouteEnablementEvidenceGateReady RouteEnablementReceiptGateRequired RouteEnablementReceiptGateModeled RouteEnablementReceiptGateReady OperatorReviewedReceiptGateRequired OperatorReviewedReceiptModeled CompatibilityCenterReceiptGateModeled RuntimeDiagnosticsReceiptGateModeled RedactedProjectionReceiptGateModeled UserVisibleReceiptGateModeled FailureProjectionReceiptGateModeled KDESafeRedactedStatusOnly ReceiptPresent ReceiptAccepted ReceiptConsumed ReceiptCreated ReceiptPersisted ReceiptAcceptanceAuthorized StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt gate must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_evidence_gate_preview.go route_enablement_evidence_gate_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_gate_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt gate must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_gate_test_source = read_project_file("internal/runtime/owner/route_enablement_receipt_gate_preview_test.go") +
                                                                                                                                                                                                                               read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                               read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                               read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptGatePreviewModelsReceiptGate TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptGatePreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptGatePreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-receipt-gate-preview current_mainline_consumed route_enablement_evidence_gate_consumed route_enablement_evidence_gate_ready route_enablement_receipt_gate_required route_enablement_receipt_gate_modeled route_enablement_receipt_gate_ready operator_reviewed_receipt_gate_required operator_reviewed_receipt_modeled compatibility_center_receipt_gate_modeled runtime_diagnostics_receipt_gate_modeled redacted_projection_receipt_gate_modeled user_visible_receipt_gate_modeled failure_projection_receipt_gate_modeled receipt_present receipt_accepted receipt_consumed receipt_created receipt_persisted receipt_acceptance_authorized storage_root_policy_grant_authorized record_writer_call_authorized writer_callable storage_write_enabled evidence_item_count ready_evidence_item_count missing_evidence_item_count raw_exposed_evidence_item_count side_effect_evidence_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_gate_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt gate tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_acceptance_audit_source = read_project_file("internal/runtime/owner/route_enablement_receipt_acceptance_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptAcceptanceAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptAcceptanceAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptAcceptanceAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptAcceptanceAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_acceptance_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-receipt-acceptance-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-receipt-acceptance-audit-ready-acceptance-disabled-routes-disabled route-enablement-receipt-gate-consumed acceptance-authorization-boundary-modeled compatibility-center-and-runtime-acceptance-modeled ten-acceptance-items-ready-acceptance-disabled receipt-acceptance-routes-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt acceptance audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementReceiptGateConsumed RouteEnablementReceiptGateReady AcceptanceAuthorizationRequired AcceptanceAuthorizationModeled AcceptanceAuthorizationReady RouteEnablementAcceptanceBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterAcceptanceModeled RuntimeDiagnosticsAcceptanceModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteEnabled StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt acceptance audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_receipt_gate_preview.go route_enablement_receipt_gate_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt acceptance audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_acceptance_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_receipt_acceptance_audit_preview_test.go") +
                                                                                                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptAcceptanceAuditPreviewModelsAcceptance TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptAcceptanceAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementReceiptAcceptanceAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-receipt-acceptance-audit-preview current_mainline_consumed route_enablement_receipt_gate_consumed route_enablement_receipt_gate_ready acceptance_authorization_required acceptance_authorization_modeled acceptance_authorization_ready route_enablement_acceptance_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_enabled storage_write_enabled acceptance_item_count ready_acceptance_item_count missing_acceptance_item_count raw_exposed_acceptance_item_count side_effect_acceptance_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_receipt_acceptance_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement receipt acceptance audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_accepted_receipt_gate_audit_source = read_project_file("internal/runtime/owner/route_enablement_accepted_receipt_gate_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementAcceptedReceiptGateAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementAcceptedReceiptGateAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementAcceptedReceiptGateAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementAcceptedReceiptGateAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_accepted_receipt_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-accepted-receipt-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-accepted-receipt-gate-audit-ready-gate-disabled-routes-disabled route-enablement-receipt-acceptance-audit-consumed accepted-receipt-gate-modeled compatibility-center-and-runtime-accepted-receipt-gates-modeled ten-gate-items-ready-gate-disabled accepted-receipt-routes-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_accepted_receipt_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement accepted receipt gate audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementReceiptAcceptanceAuditConsumed RouteEnablementReceiptAcceptanceReady AcceptedReceiptGateRequired AcceptedReceiptGateModeled AcceptedReceiptGateReady RouteEnablementAcceptedReceiptBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterAcceptedReceiptModeled RuntimeDiagnosticsAcceptedReceiptModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteEnabled StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_accepted_receipt_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement accepted receipt gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_receipt_acceptance_audit_preview.go route_enablement_receipt_acceptance_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_accepted_receipt_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement accepted receipt gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_accepted_receipt_gate_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_accepted_receipt_gate_audit_preview_test.go") +
                                                                                                                                                                                                                                         read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                         read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                         read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementAcceptedReceiptGateAuditPreviewModelsGate TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementAcceptedReceiptGateAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementAcceptedReceiptGateAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-accepted-receipt-gate-audit-preview current_mainline_consumed route_enablement_receipt_acceptance_audit_consumed route_enablement_receipt_acceptance_ready accepted_receipt_gate_required accepted_receipt_gate_modeled accepted_receipt_gate_ready route_enablement_accepted_receipt_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_enabled storage_write_enabled gate_item_count ready_gate_item_count missing_gate_item_count raw_exposed_gate_item_count side_effect_gate_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_accepted_receipt_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement accepted receipt gate audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_grant_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_grant_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteGrantAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteGrantAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteGrantAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteGrantAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_grant_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-grant-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-grant-audit-ready-grant-disabled-routes-disabled route-enablement-accepted-receipt-gate-consumed lookup-route-grant-modeled compatibility-center-and-runtime-lookup-route-grants-modeled ten-grant-items-ready-grant-disabled lookup-route-grants-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route grant audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementAcceptedReceiptGateConsumed RouteEnablementAcceptedReceiptGateReady LookupRouteGrantRequired LookupRouteGrantModeled LookupRouteGrantReady RouteEnablementLookupRouteGrantBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterLookupRouteGrantModeled RuntimeDiagnosticsLookupRouteGrantModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteGrantAuthorized LookupRouteEnabled StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route grant audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_accepted_receipt_gate_audit_preview.go route_enablement_accepted_receipt_gate_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route grant audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_grant_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_grant_audit_preview_test.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteGrantAuditPreviewModelsGrant TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteGrantAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteGrantAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-grant-audit-preview current_mainline_consumed route_enablement_accepted_receipt_gate_consumed route_enablement_accepted_receipt_gate_ready lookup_route_grant_required lookup_route_grant_modeled lookup_route_grant_ready route_enablement_lookup_route_grant_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_grant_authorized lookup_route_enabled storage_write_enabled grant_item_count ready_grant_item_count missing_grant_item_count raw_exposed_grant_item_count side_effect_grant_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_grant_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route grant audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_enablement_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_enablement_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteEnablementAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteEnablementAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteEnablementAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteEnablementAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_enablement_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-enablement-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-enablement-audit-ready-route-disabled-dispatch-disabled route-enablement-lookup-route-grant-consumed lookup-route-enablement-modeled compatibility-center-and-runtime-lookup-route-enablements-modeled ten-enablement-items-ready-route-disabled lookup-route-enablement-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_enablement_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route enablement audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteGrantConsumed RouteEnablementLookupRouteGrantReady LookupRouteEnablementRequired LookupRouteEnablementModeled LookupRouteEnablementReady RouteEnablementLookupRouteEnablementBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterLookupRouteEnablementModeled RuntimeDiagnosticsLookupRouteEnablementModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteGrantAuthorized LookupRouteEnabled StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_enablement_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route enablement audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_grant_audit_preview.go route_enablement_lookup_route_grant_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_enablement_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route enablement audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_enablement_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_enablement_audit_preview_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteEnablementAuditPreviewModelsEnablement TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteEnablementAuditPreviewFailsClosedWithoutSources TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteEnablementAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-enablement-audit-preview current_mainline_consumed route_enablement_lookup_route_grant_consumed route_enablement_lookup_route_grant_ready lookup_route_enablement_required lookup_route_enablement_modeled lookup_route_enablement_ready route_enablement_lookup_route_enablement_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_grant_authorized lookup_route_enabled storage_write_enabled enablement_item_count ready_enablement_item_count missing_enablement_item_count raw_exposed_enablement_item_count side_effect_enablement_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_enablement_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route enablement audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_gate_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_gate_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchGateAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchGateAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchGateAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchGateAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-gate-audit-ready-route-disabled-dispatch-disabled route-enablement-lookup-route-enablement-consumed lookup-route-dispatch-gate-modeled compatibility-center-and-runtime-lookup-route-dispatch-gates-modeled ten-dispatch-gate-items-ready-dispatch-disabled lookup-route-dispatch-gate-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch gate audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteEnablementConsumed RouteEnablementLookupRouteEnablementReady LookupRouteDispatchGateRequired LookupRouteDispatchGateModeled LookupRouteDispatchGateReady RouteEnablementLookupRouteDispatchGateBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterLookupRouteDispatchGateModeled RuntimeDiagnosticsLookupRouteDispatchGateModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteGrantAuthorized LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchGatePassed LookupRouteDispatchCallable StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_enablement_audit_preview.go route_enablement_lookup_route_enablement_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_gate_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_gate_audit_preview_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/main.go")
%w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchGateAuditPreviewModelsDispatchGate  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchGateAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-gate-audit-preview current_mainline_consumed route_enablement_lookup_route_enablement_consumed route_enablement_lookup_route_enablement_ready lookup_route_dispatch_gate_required lookup_route_dispatch_gate_modeled lookup_route_dispatch_gate_ready route_enablement_lookup_route_dispatch_gate_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_grant_authorized lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_gate_passed lookup_route_dispatch_callable storage_write_enabled dispatch_gate_item_count ready_dispatch_gate_item_count missing_dispatch_gate_item_count raw_exposed_dispatch_gate_item_count side_effect_dispatch_gate_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch gate audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_authorization_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_authorization_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchAuthorizationAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchAuthorizationAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchAuthorizationAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchAuthorizationAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-authorization-audit-ready-route-disabled-dispatch-disabled route-enablement-lookup-route-dispatch-gate-consumed lookup-route-dispatch-authorization-modeled compatibility-center-and-runtime-lookup-route-dispatch-authorizations-modeled ten-dispatch-authorization-items-ready-dispatch-disabled lookup-route-dispatch-authorization-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch authorization audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchGateConsumed RouteEnablementLookupRouteDispatchGateReady LookupRouteDispatchAuthorizationRequired LookupRouteDispatchAuthorizationModeled LookupRouteDispatchAuthorizationReady RouteEnablementLookupRouteDispatchAuthorizationBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterLookupRouteDispatchAuthorizationModeled RuntimeDiagnosticsLookupRouteDispatchAuthorizationModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteGrantAuthorized LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchAuthorizationPassed LookupRouteDispatchCallable StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch authorization audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_gate_audit_preview.go route_enablement_lookup_route_dispatch_gate_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch authorization audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_authorization_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_authorization_audit_preview_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchAuthorizationAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-authorization-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_gate_consumed route_enablement_lookup_route_dispatch_gate_ready lookup_route_dispatch_authorization_required lookup_route_dispatch_authorization_modeled lookup_route_dispatch_authorization_ready route_enablement_lookup_route_dispatch_authorization_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_grant_authorized lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_authorization_passed lookup_route_dispatch_callable storage_write_enabled dispatch_authorization_item_count ready_dispatch_authorization_item_count missing_dispatch_authorization_item_count raw_exposed_dispatch_authorization_item_count side_effect_dispatch_authorization_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_authorization_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch authorization audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunExecutionGateAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunExecutionGateAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunExecutionGateAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunExecutionGateAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-execution-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-execution-gate-audit-ready-route-disabled-dispatch-disabled route-enablement-lookup-route-dispatch-authorization-consumed lookup-route-dispatch-dry-run-execution-gate-modeled compatibility-center-and-runtime-lookup-route-dispatch-dry-run-execution-gates-modeled ten-dispatch-dry-run-execution-gate-items-ready-dispatch-disabled lookup-route-dispatch-dry-run-execution-gate-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run execution gate audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchAuthorizationConsumed RouteEnablementLookupRouteDispatchAuthorizationReady LookupRouteDispatchDryRunExecutionGateRequired LookupRouteDispatchDryRunExecutionGateModeled LookupRouteDispatchDryRunExecutionGateReady RouteEnablementLookupRouteDispatchDryRunExecutionGateBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterLookupRouteDispatchDryRunExecutionGateModeled RuntimeDiagnosticsLookupRouteDispatchDryRunExecutionGateModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteGrantAuthorized LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchDryRunExecutionGatePassed LookupRouteDispatchCallable StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run execution gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_authorization_audit_preview.go route_enablement_lookup_route_dispatch_authorization_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run execution gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_preview_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunExecutionGateAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-execution-gate-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_authorization_consumed route_enablement_lookup_route_dispatch_authorization_ready lookup_route_dispatch_dry_run_execution_gate_required lookup_route_dispatch_dry_run_execution_gate_modeled lookup_route_dispatch_dry_run_execution_gate_ready route_enablement_lookup_route_dispatch_dry_run_execution_gate_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_grant_authorized lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_dry_run_execution_gate_passed lookup_route_dispatch_callable storage_write_enabled dispatch_dry_run_execution_gate_item_count ready_dispatch_dry_run_execution_gate_item_count missing_dispatch_dry_run_execution_gate_item_count raw_exposed_dispatch_dry_run_execution_gate_item_count side_effect_dispatch_dry_run_execution_gate_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run execution gate audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultCaptureAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultCaptureAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultCaptureAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultCaptureAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_capture_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-capture-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-capture-audit-ready-route-disabled-dispatch-disabled route-enablement-lookup-route-dispatch-dry-run-execution-gate-consumed lookup-route-dispatch-dry-run-result-capture-modeled compatibility-center-and-runtime-lookup-route-dispatch-dry-run-result-captures-modeled ten-dispatch-dry-run-result-capture-items-ready-dispatch-disabled lookup-route-dispatch-dry-run-result-capture-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result capture audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchDryRunExecutionGateConsumed RouteEnablementLookupRouteDispatchDryRunExecutionGateReady LookupRouteDispatchDryRunResultCaptureRequired LookupRouteDispatchDryRunResultCaptureModeled LookupRouteDispatchDryRunResultCaptureReady RouteEnablementLookupRouteDispatchDryRunResultCaptureBoundaryReady OpaqueRouteEnablementReceipt KDESafeRedactedStatusOnly CompatibilityCenterLookupRouteDispatchDryRunResultCaptureModeled RuntimeDiagnosticsLookupRouteDispatchDryRunResultCaptureModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteGrantAuthorized LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchDryRunResultCapturePassed LookupRouteDispatchCallable StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result capture audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_execution_gate_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result capture audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_preview_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                            read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultCaptureAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-capture-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_execution_gate_consumed route_enablement_lookup_route_dispatch_dry_run_execution_gate_ready lookup_route_dispatch_dry_run_result_capture_required lookup_route_dispatch_dry_run_result_capture_modeled lookup_route_dispatch_dry_run_result_capture_ready route_enablement_lookup_route_dispatch_dry_run_result_capture_boundary_ready opaque_route_enablement_receipt receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_grant_authorized lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_dry_run_result_capture_passed lookup_route_dispatch_callable storage_write_enabled dispatch_dry_run_result_capture_item_count ready_dispatch_dry_run_result_capture_item_count missing_dispatch_dry_run_result_capture_item_count raw_exposed_dispatch_dry_run_result_capture_item_count side_effect_dispatch_dry_run_result_capture_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result capture audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultRedactionBoundaryAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultRedactionBoundaryAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultRedactionBoundaryAuditCheck NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultRedactionBoundaryAuditPreview xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-redaction-boundary-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-redaction-boundary-audit-ready-route-disabled-dispatch-disabled-raw-result-hidden route-enablement-lookup-route-dispatch-dry-run-result-capture-consumed lookup-route-dispatch-dry-run-result-redaction-boundary-modeled compatibility-center-and-runtime-lookup-route-dispatch-dry-run-result-redaction-boundaries-modeled ten-dispatch-dry-run-result-redaction-boundary-items-ready-dispatch-disabled raw-result-exposure-and-persistence-disabled consumer-routes-dispatch-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redaction boundary audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchDryRunResultCaptureConsumed RouteEnablementLookupRouteDispatchDryRunResultCaptureReady LookupRouteDispatchDryRunResultRedactionBoundaryRequired LookupRouteDispatchDryRunResultRedactionBoundaryModeled LookupRouteDispatchDryRunResultRedactionBoundaryReady RouteEnablementLookupRouteDispatchDryRunResultRedactionBoundaryReady CapturedDryRunResultOpaque KDESafeRedactedResultOnly CompatibilityCenterLookupRouteDispatchDryRunResultRedactionModeled RuntimeDiagnosticsLookupRouteDispatchDryRunResultRedactionModeled ReceiptPresent ReceiptAccepted ReceiptConsumed AcceptanceAuthorized RouteEnablementAccepted LookupRouteEnablementGranted LookupRouteGrantAuthorized LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchDryRunResultCapturePassed LookupRouteDispatchDryRunResultRedactionPassed LookupRouteDispatchCallable StorageRootPolicyGrantAuthorized RecordWriterCallAuthorized WriterCallable StorageRootResolved StorageWriteEnabled StatusPersistenceWriteEnabled ConsumerDryRunLookupResultBoundaryAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnablementAuthorized OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redaction boundary audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_capture_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redaction boundary audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_preview_test.go") +
                                                                                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                                   read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultRedactionBoundaryAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-redaction-boundary-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_capture_consumed route_enablement_lookup_route_dispatch_dry_run_result_capture_ready lookup_route_dispatch_dry_run_result_redaction_boundary_required lookup_route_dispatch_dry_run_result_redaction_boundary_modeled lookup_route_dispatch_dry_run_result_redaction_boundary_ready route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_ready captured_dry_run_result_opaque kde_safe_redacted_result_only receipt_present receipt_accepted receipt_consumed acceptance_authorized route_enablement_accepted lookup_route_enablement_granted lookup_route_grant_authorized lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_dry_run_result_capture_passed lookup_route_dispatch_dry_run_result_redaction_passed lookup_route_dispatch_callable storage_write_enabled dispatch_dry_run_result_redaction_boundary_item_count ready_dispatch_dry_run_result_redaction_boundary_item_count missing_dispatch_dry_run_result_redaction_boundary_item_count raw_exposed_dispatch_dry_run_result_item_count side_effect_dispatch_dry_run_result_redaction_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redaction boundary audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_preview.go")
%w[    xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-redacted-presentation-eligibility-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-redacted-presentation-eligibility-audit-ready-presentation-review-only-raw-result-hidden route-enablement-lookup-route-dispatch-dry-run-result-redaction-boundary-consumed lookup-route-dispatch-dry-run-result-redacted-presentation-eligibility-modeled four-kde-presentation-surfaces-eligible-review-only raw-result-exposure-and-persistence-disabled routes-dispatch-notifications-and-support-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redacted presentation eligibility audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchDryRunResultRedactionBoundaryConsumed RouteEnablementLookupRouteDispatchDryRunResultRedactionBoundaryReady LookupRouteDispatchDryRunResultRedactedPresentationEligibilityRequired LookupRouteDispatchDryRunResultRedactedPresentationEligibilityModeled LookupRouteDispatchDryRunResultRedactedPresentationEligibilityReady RouteEnablementLookupRouteDispatchDryRunResultRedactedPresentationReady KDEPresentationSurfaceEligibilityModeled CompatibilityCenterPresentationEligible NotificationCenterPresentationEligible SettingsPresentationEligible RuntimeDiagnosticsPresentationEligible KDESafeRedactedResultOnly RawResultHidden PresentationEligibilityItemCount ReadyPresentationEligibilityItemCount MissingPresentationEligibilityItemCount UserVisiblePresentationItemCount PersistedPresentationEligibilityItemCount RawExposedPresentationEligibilityItemCount SideEffectPresentationEligibilityItemCount ReceiptPresent ReceiptAccepted ReceiptConsumed RouteEnablementAccepted LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchDryRunResultRedactionPassed LookupRouteDispatchCallable StorageWriteEnabled StatusPersistenceWriteEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redacted presentation eligibility audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redacted presentation eligibility audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_preview_test.go") +
                                                                                                                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                                          read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultRedactedPresentationEligibilityAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-redacted-presentation-eligibility-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_consumed route_enablement_lookup_route_dispatch_dry_run_result_redaction_boundary_ready lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_required lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_modeled lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_ready route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_ready kde_presentation_surface_eligibility_modeled raw_result_hidden presentation_eligibility_item_count ready_presentation_eligibility_item_count missing_presentation_eligibility_item_count raw_exposed_presentation_eligibility_item_count side_effect_presentation_eligibility_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result redacted presentation eligibility audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_preview.go")
%w[ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultPresentationConsentAuditPreview ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultPresentationConsentAuditItem ProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupResultConsumerProjectionRouteEnablementLookupRouteDispatchDryRunResultPresentationConsentAuditCheck  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-presentation-consent-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-presentation-consent-audit-ready-consent-review-only-notifications-disabled-action-cards-disabled route-enablement-lookup-route-dispatch-dry-run-result-redacted-presentation-eligibility-consumed lookup-route-dispatch-dry-run-result-presentation-consent-modeled four-kde-presentation-surfaces-consent-review-only notifications-and-action-cards-disabled raw-result-exposure-and-persistence-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result presentation consent audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchDryRunResultRedactedPresentationEligibilityConsumed RouteEnablementLookupRouteDispatchDryRunResultRedactedPresentationEligibilityReady LookupRouteDispatchDryRunResultPresentationConsentRequired LookupRouteDispatchDryRunResultPresentationConsentModeled LookupRouteDispatchDryRunResultPresentationConsentReady RouteEnablementLookupRouteDispatchDryRunResultPresentationConsentReady EligibleRedactedPresentationConsumed KDEPresentationConsentModeled CompatibilityCenterPresentationConsentModeled NotificationCenterPresentationConsentModeled SettingsPresentationConsentModeled RuntimeDiagnosticsPresentationConsentModeled NotificationAndActionCardConsentBoundaryReady ExplicitUserConsentRequired ExplicitUserConsentCollected ConsentReviewOnly NotificationsRemainDisabled ActionCardsRemainDisabled KDESafeRedactedResultOnly RawResultHidden PresentationConsentItemCount RequiredPresentationConsentItemCount ReadyPresentationConsentItemCount MissingPresentationConsentItemCount ExplicitConsentGrantedItemCount NotificationTriggerEnabledItemCount ActionCardEnabledItemCount SideEffectPresentationConsentItemCount ReceiptPresent ReceiptAccepted ReceiptConsumed RouteEnablementAccepted LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchDryRunResultRedactionPassed LookupRouteDispatchCallable StorageWriteEnabled StatusPersistenceWriteEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled NotificationCenterEventTriggered ActionCardEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result presentation consent audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result presentation consent audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_preview_test.go") +
                                                                                                                                                                                                                                        read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                        read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                        read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultPresentationConsentAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-presentation-consent-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_consumed route_enablement_lookup_route_dispatch_dry_run_result_redacted_presentation_eligibility_ready lookup_route_dispatch_dry_run_result_presentation_consent_required lookup_route_dispatch_dry_run_result_presentation_consent_modeled lookup_route_dispatch_dry_run_result_presentation_consent_ready route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_ready explicit_user_consent_required explicit_user_consent_collected notifications_remain_disabled action_cards_remain_disabled presentation_consent_item_count ready_presentation_consent_item_count missing_presentation_consent_item_count notification_trigger_enabled_item_count action_card_enabled_item_count side_effect_presentation_consent_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result presentation consent audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_preview.go")
%w[    xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-presentation-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-presentation-audit-ready-notification-review-only-delivery-disabled route-enablement-lookup-route-dispatch-dry-run-result-presentation-consent-consumed lookup-route-dispatch-dry-run-result-notification-presentation-modeled four-kde-notification-events-review-only notification-delivery-actions-and-action-cards-disabled raw-result-exposure-and-persistence-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification presentation audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchDryRunResultPresentationConsentConsumed RouteEnablementLookupRouteDispatchDryRunResultPresentationConsentReady LookupRouteDispatchDryRunResultNotificationPresentationRequired LookupRouteDispatchDryRunResultNotificationPresentationModeled LookupRouteDispatchDryRunResultNotificationPresentationReady RouteEnablementLookupRouteDispatchDryRunResultNotificationPresentationReady ConsentModeledRedactedPresentationConsumed KDENotificationPresentationModeled NotificationCenterSurfaceModeled InstallFailureNotificationModeled RepairSuggestionNotificationModeled EnvironmentSwitchNotificationModeled ApprovalInfoNotificationModeled NotificationPresentationReviewOnly NotificationDeliveryDisabled NotificationActionDisabled ActionCardsRemainDisabled ExplicitUserConsentRequired ExplicitUserConsentCollected KDESafeRedactedResultOnly RawResultHidden NotificationPresentationItemCount RequiredNotificationPresentationItemCount ReadyNotificationPresentationItemCount MissingNotificationPresentationItemCount DeliveredNotificationItemCount NotificationActionEnabledItemCount ActionCardEnabledItemCount SideEffectNotificationPresentationItemCount ReceiptPresent ReceiptAccepted ReceiptConsumed RouteEnablementAccepted LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchCallable StorageWriteEnabled StatusPersistenceWriteEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationDeliveryEnabled NotificationSent NotificationCenterEventTriggered NotificationActionEnabled ActionCardEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification presentation audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification presentation audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_preview_test.go") +
                                                                                                                                                                                                                                             read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                             read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                             read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultNotificationPresentationAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-presentation-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_consumed route_enablement_lookup_route_dispatch_dry_run_result_presentation_consent_ready lookup_route_dispatch_dry_run_result_notification_presentation_required lookup_route_dispatch_dry_run_result_notification_presentation_modeled lookup_route_dispatch_dry_run_result_notification_presentation_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_ready notification_delivery_disabled notification_action_disabled notification_presentation_item_count ready_notification_presentation_item_count missing_notification_presentation_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_presentation_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification presentation audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_preview.go")
%w[    xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-authorization-audit-ready-delivery-grant-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-presentation-consumed lookup-route-dispatch-dry-run-result-notification-delivery-authorization-modeled four-kde-notification-delivery-events-review-only delivery-grants-sending-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery authorization audit must include #{token}")
end
%w[CurrentMainlineConsumed RouteEnablementLookupRouteDispatchDryRunResultNotificationPresentationConsumed RouteEnablementLookupRouteDispatchDryRunResultNotificationPresentationReady LookupRouteDispatchDryRunResultNotificationDeliveryAuthorizationRequired LookupRouteDispatchDryRunResultNotificationDeliveryAuthorizationModeled LookupRouteDispatchDryRunResultNotificationDeliveryAuthorizationReady RouteEnablementLookupRouteDispatchDryRunResultNotificationDeliveryReady NotificationPresentationReviewOnlyConsumed KDENotificationDeliveryAuthorizationModeled NotificationCenterDeliveryAuthorizationModeled InstallFailureDeliveryAuthorizationModeled RepairSuggestionDeliveryAuthorizationModeled EnvironmentSwitchDeliveryAuthorizationModeled ApprovalInfoDeliveryAuthorizationModeled NotificationDeliveryAuthorizationReviewOnly NotificationDeliveryAuthorizationGranted NotificationDeliveryDisabled NotificationActionDisabled ActionCardsRemainDisabled ExplicitUserConsentRequired ExplicitUserConsentCollected KDESafeRedactedResultOnly RawResultHidden NotificationDeliveryAuthorizationItemCount RequiredNotificationDeliveryAuthorizationItemCount ReadyNotificationDeliveryAuthorizationItemCount MissingNotificationDeliveryAuthorizationItemCount AuthorizedNotificationDeliveryItemCount DeliveredNotificationItemCount NotificationActionEnabledItemCount ActionCardEnabledItemCount SideEffectNotificationDeliveryAuthorizationItemCount ReceiptPresent ReceiptAccepted ReceiptConsumed RouteEnablementAccepted LookupRouteEnabled LookupRouteDispatchAuthorized LookupRouteDispatchCallable StorageWriteEnabled StatusPersistenceWriteEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationDeliveryEnabled NotificationSent NotificationCenterEventTriggered NotificationActionEnabled ActionCardEnabled ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled HostRootModified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery authorization audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery authorization audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_preview_test.go") +
                                                                                                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultNotificationDeliveryAuthorizationAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-authorization-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_presentation_ready lookup_route_dispatch_dry_run_result_notification_delivery_authorization_required lookup_route_dispatch_dry_run_result_notification_delivery_authorization_modeled lookup_route_dispatch_dry_run_result_notification_delivery_authorization_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_ready notification_delivery_authorization_review_only notification_delivery_authorization_granted notification_delivery_authorization_item_count ready_notification_delivery_authorization_item_count missing_notification_delivery_authorization_item_count authorized_notification_delivery_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_authorization_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery authorization audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-grant-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-grant-audit-ready-grant-issuance-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-authorization-consumed lookup-route-dispatch-dry-run-result-notification-delivery-grant-modeled four-kde-notification-delivery-events-grant-review-only grant-issuance-sending-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery grant audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_ready lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_grant_modeled lookup_route_dispatch_dry_run_result_notification_delivery_grant_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_ready notification_delivery_authorization_review_only_consumed kde_notification_delivery_grant_modeled notification_center_delivery_grant_modeled install_failure_delivery_grant_modeled repair_suggestion_delivery_grant_modeled environment_switch_delivery_grant_modeled approval_info_delivery_grant_modeled notification_delivery_grant_review_only notification_delivery_grant_issued notification_delivery_authorization_granted notification_delivery_disabled notification_action_disabled action_cards_remain_disabled explicit_user_consent_required explicit_user_consent_collected kde_safe_redacted_result_only raw_result_hidden notification_delivery_grant_item_count required_notification_delivery_grant_item_count ready_notification_delivery_grant_item_count missing_notification_delivery_grant_item_count issued_notification_delivery_grant_item_count authorized_notification_delivery_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_grant_item_count receipt_present receipt_accepted receipt_consumed route_enablement_accepted lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_callable storage_write_enabled status_persistence_write_enabled redacted_summary_persisted kde_status_persisted runtime_diagnostics_persisted dry_run_result_persisted raw_result_exposed dispatch_dry_run_executed request_object_creation_enabled request_object_dispatch_enabled portal_request_created notification_delivery_enabled notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled production_bus_claimed write_methods_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery grant audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery grant audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_preview_test.go") +
                                                                                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                              read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultNotificationDeliveryGrantAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-grant-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_authorization_ready lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_grant_modeled lookup_route_dispatch_dry_run_result_notification_delivery_grant_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_ready notification_delivery_grant_review_only notification_delivery_grant_issued notification_delivery_grant_item_count ready_notification_delivery_grant_item_count missing_notification_delivery_grant_item_count issued_notification_delivery_grant_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_grant_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery grant audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-explicit-consent-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-explicit-consent-audit-ready-consent-collection-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-grant-consumed lookup-route-dispatch-dry-run-result-notification-delivery-explicit-consent-modeled four-kde-notification-delivery-events-explicit-consent-review-only consent-collection-grant-issuance-sending-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery explicit consent audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_ready lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_modeled lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_ready notification_delivery_grant_review_only_consumed kde_notification_delivery_explicit_consent_modeled notification_center_delivery_explicit_consent_modeled install_failure_explicit_consent_modeled repair_suggestion_explicit_consent_modeled environment_switch_explicit_consent_modeled approval_info_explicit_consent_modeled notification_delivery_explicit_consent_review_only explicit_user_consent_required explicit_user_consent_prepared explicit_user_consent_collected explicit_user_consent_collection_enabled notification_delivery_grant_issued notification_delivery_authorization_granted notification_delivery_disabled notification_action_disabled action_cards_remain_disabled kde_safe_redacted_result_only raw_result_hidden notification_delivery_explicit_consent_item_count required_notification_delivery_explicit_consent_item_count ready_notification_delivery_explicit_consent_item_count missing_notification_delivery_explicit_consent_item_count prepared_explicit_consent_item_count collected_explicit_consent_item_count issued_notification_delivery_grant_item_count authorized_notification_delivery_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_explicit_consent_item_count receipt_present receipt_accepted receipt_consumed route_enablement_accepted lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_callable storage_write_enabled status_persistence_write_enabled redacted_summary_persisted kde_status_persisted runtime_diagnostics_persisted dry_run_result_persisted raw_result_exposed dispatch_dry_run_executed request_object_creation_enabled request_object_dispatch_enabled portal_request_created notification_delivery_enabled notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled production_bus_claimed write_methods_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery explicit consent audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery explicit consent audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_preview_test.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultNotificationDeliveryExplicitConsentAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-explicit-consent-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_grant_ready lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_modeled lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_ready notification_delivery_explicit_consent_review_only explicit_user_consent_prepared explicit_user_consent_collected explicit_user_consent_collection_enabled notification_delivery_explicit_consent_item_count ready_notification_delivery_explicit_consent_item_count missing_notification_delivery_explicit_consent_item_count prepared_explicit_consent_item_count collected_explicit_consent_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_explicit_consent_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery explicit consent audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-gate-audit-ready-collection-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-explicit-consent-consumed lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-gate-modeled four-kde-notification-delivery-events-consent-collection-gate-review-only consent-collection-persistence-grant-issuance-sending-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection gate audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_ready lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_ready notification_delivery_explicit_consent_review_only_consumed kde_notification_delivery_consent_collection_gate_modeled notification_center_delivery_consent_collection_gate_modeled install_failure_consent_collection_gate_modeled repair_suggestion_consent_collection_gate_modeled environment_switch_consent_collection_gate_modeled approval_info_consent_collection_gate_modeled notification_delivery_consent_collection_gate_review_only explicit_user_consent_required explicit_user_consent_prepared explicit_user_consent_collection_gate_modeled explicit_user_consent_collection_gate_ready explicit_user_consent_collection_allowed explicit_user_consent_collection_enabled explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted notification_delivery_grant_issued notification_delivery_authorization_granted notification_delivery_disabled notification_action_disabled action_cards_remain_disabled kde_safe_redacted_result_only raw_result_hidden notification_delivery_consent_collection_gate_item_count required_notification_delivery_consent_collection_gate_item_count ready_notification_delivery_consent_collection_gate_item_count missing_notification_delivery_consent_collection_gate_item_count prepared_explicit_consent_item_count collection_gate_modeled_item_count collected_explicit_consent_item_count persisted_explicit_consent_item_count consent_receipt_created_item_count issued_notification_delivery_grant_item_count authorized_notification_delivery_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_consent_collection_gate_item_count receipt_present receipt_accepted receipt_consumed route_enablement_accepted lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_callable storage_write_enabled status_persistence_write_enabled redacted_summary_persisted kde_status_persisted runtime_diagnostics_persisted dry_run_result_persisted raw_result_exposed dispatch_dry_run_executed request_object_creation_enabled request_object_dispatch_enabled portal_request_created notification_delivery_enabled notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled production_bus_claimed write_methods_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_preview_test.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                      read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionGateAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-gate-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_explicit_consent_ready lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_ready notification_delivery_consent_collection_gate_review_only explicit_user_consent_collection_allowed explicit_user_consent_collection_enabled explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted notification_delivery_consent_collection_gate_item_count ready_notification_delivery_consent_collection_gate_item_count missing_notification_delivery_consent_collection_gate_item_count collection_gate_modeled_item_count persisted_explicit_consent_item_count side_effect_notification_delivery_consent_collection_gate_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection gate audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-audit-ready-receipt-creation-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-gate-consumed lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-modeled four-kde-notification-delivery-events-consent-collection-receipt-review-only consent-collection-receipt-persistence-grant-issuance-sending-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_ready lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_ready notification_delivery_consent_collection_gate_review_only_consumed notification_delivery_consent_collection_receipt_review_only explicit_user_consent_required explicit_user_consent_prepared explicit_user_consent_collection_gate_ready consent_collection_receipt_required consent_collection_receipt_modeled consent_collection_receipt_ready consent_collection_receipt_creation_allowed consent_collection_receipt_creation_enabled explicit_user_consent_collection_allowed explicit_user_consent_collection_enabled explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted consent_receipt_accepted consent_receipt_consumed notification_delivery_grant_issued notification_delivery_authorization_granted notification_delivery_disabled notification_action_disabled action_cards_remain_disabled kde_safe_redacted_result_only raw_result_hidden notification_delivery_consent_collection_receipt_item_count required_notification_delivery_consent_collection_receipt_item_count ready_notification_delivery_consent_collection_receipt_item_count missing_notification_delivery_consent_collection_receipt_item_count prepared_explicit_consent_item_count collection_gate_consumed_item_count receipt_modeled_item_count collected_explicit_consent_item_count persisted_explicit_consent_item_count consent_receipt_created_item_count consent_receipt_persisted_item_count consent_receipt_accepted_item_count consent_receipt_consumed_item_count issued_notification_delivery_grant_item_count authorized_notification_delivery_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_consent_collection_receipt_item_count receipt_present receipt_accepted receipt_consumed route_enablement_accepted lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_callable storage_write_enabled status_persistence_write_enabled redacted_summary_persisted kde_status_persisted runtime_diagnostics_persisted dry_run_result_persisted raw_result_exposed dispatch_dry_run_executed request_object_creation_enabled request_object_dispatch_enabled portal_request_created notification_delivery_enabled notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled production_bus_claimed write_methods_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_preview_test.go") +
                                                                                                                                                                                                                                         read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                         read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                         read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_gate_consumed lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_ready notification_delivery_consent_collection_receipt_review_only consent_collection_receipt_creation_enabled explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted consent_receipt_accepted consent_receipt_consumed notification_delivery_consent_collection_receipt_item_count ready_notification_delivery_consent_collection_receipt_item_count missing_notification_delivery_consent_collection_receipt_item_count collection_gate_consumed_item_count receipt_modeled_item_count consent_receipt_created_item_count consent_receipt_accepted_item_count side_effect_notification_delivery_consent_collection_receipt_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-acceptance-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-acceptance-audit-ready-acceptance-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-audit-consumed lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-acceptance-modeled four-kde-notification-delivery-events-consent-collection-receipt-acceptance-review-only consent-collection-receipt-acceptance-consumption-grant-issuance-sending-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt acceptance audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_ready lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_ready notification_delivery_consent_collection_receipt_review_only_consumed notification_delivery_consent_collection_receipt_acceptance_review_only consent_collection_receipt_acceptance_required consent_collection_receipt_acceptance_modeled consent_collection_receipt_acceptance_ready consent_collection_receipt_acceptance_allowed consent_collection_receipt_acceptance_enabled acceptance_authorization_required acceptance_authorization_modeled acceptance_authorization_ready consent_collection_receipt_creation_allowed consent_collection_receipt_creation_enabled explicit_user_consent_collection_allowed explicit_user_consent_collection_enabled explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted consent_receipt_accepted consent_receipt_consumed notification_delivery_grant_issued notification_delivery_authorization_granted notification_delivery_disabled notification_action_disabled action_cards_remain_disabled kde_safe_redacted_result_only raw_result_hidden notification_delivery_consent_collection_receipt_acceptance_item_count required_notification_delivery_consent_collection_receipt_acceptance_item_count ready_notification_delivery_consent_collection_receipt_acceptance_item_count missing_notification_delivery_consent_collection_receipt_acceptance_item_count prepared_explicit_consent_item_count receipt_audit_consumed_item_count receipt_acceptance_modeled_item_count collected_explicit_consent_item_count persisted_explicit_consent_item_count consent_receipt_created_item_count consent_receipt_persisted_item_count consent_receipt_accepted_item_count consent_receipt_consumed_item_count issued_notification_delivery_grant_item_count authorized_notification_delivery_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_consent_collection_receipt_acceptance_item_count receipt_present receipt_accepted receipt_consumed route_enablement_accepted lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_callable storage_write_enabled status_persistence_write_enabled redacted_summary_persisted kde_status_persisted runtime_diagnostics_persisted dry_run_result_persisted raw_result_exposed dispatch_dry_run_executed request_object_creation_enabled request_object_dispatch_enabled portal_request_created notification_delivery_enabled notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled production_bus_claimed write_methods_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt acceptance audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt acceptance audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview_test.go") +
                                                                                                                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/main.go")
%w[  TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeRedactedStatusClosedRecordWriterStorageRootAuthorizationReceiptDryRunLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptAcceptanceAuditPreviewCommand production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-acceptance-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_audit_consumed lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_ready notification_delivery_consent_collection_receipt_acceptance_review_only consent_collection_receipt_acceptance_enabled acceptance_authorization_required acceptance_authorization_modeled acceptance_authorization_ready explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted consent_receipt_accepted consent_receipt_consumed notification_delivery_consent_collection_receipt_acceptance_item_count ready_notification_delivery_consent_collection_receipt_acceptance_item_count missing_notification_delivery_consent_collection_receipt_acceptance_item_count receipt_audit_consumed_item_count receipt_acceptance_modeled_item_count consent_receipt_created_item_count consent_receipt_accepted_item_count side_effect_notification_delivery_consent_collection_receipt_acceptance_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt acceptance audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumption-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumption-gate-audit-ready-consumption-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-acceptance-audit-consumed lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumption-gate-modeled four-kde-notification-delivery-events-consent-collection-receipt-consumption-gate-review-only consent-collection-receipt-consumption-delivery-grant-issuance-sending-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumption gate audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_ready lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_ready notification_delivery_consent_collection_receipt_acceptance_review_only_consumed notification_delivery_consent_collection_receipt_consumption_gate_review_only consent_collection_receipt_consumption_gate_required consent_collection_receipt_consumption_gate_modeled consent_collection_receipt_consumption_gate_ready consent_collection_receipt_consumption_allowed consent_collection_receipt_consumption_enabled consumption_authorization_required consumption_authorization_modeled consumption_authorization_ready consent_collection_receipt_creation_allowed consent_collection_receipt_creation_enabled explicit_user_consent_collection_allowed explicit_user_consent_collection_enabled explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted consent_receipt_accepted consent_receipt_consumed notification_delivery_grant_issued notification_delivery_authorization_granted notification_delivery_disabled notification_action_disabled action_cards_remain_disabled kde_safe_redacted_result_only raw_result_hidden notification_delivery_consent_collection_receipt_consumption_gate_item_count required_notification_delivery_consent_collection_receipt_consumption_gate_item_count ready_notification_delivery_consent_collection_receipt_consumption_gate_item_count missing_notification_delivery_consent_collection_receipt_consumption_gate_item_count prepared_explicit_consent_item_count receipt_acceptance_audit_consumed_item_count receipt_consumption_gate_modeled_item_count collected_explicit_consent_item_count persisted_explicit_consent_item_count consent_receipt_created_item_count consent_receipt_persisted_item_count consent_receipt_accepted_item_count consent_receipt_consumed_item_count issued_notification_delivery_grant_item_count authorized_notification_delivery_item_count delivered_notification_item_count notification_action_enabled_item_count action_card_enabled_item_count side_effect_notification_delivery_consent_collection_receipt_consumption_gate_item_count receipt_present receipt_accepted receipt_consumed route_enablement_accepted lookup_route_enabled lookup_route_dispatch_authorized lookup_route_dispatch_callable storage_write_enabled status_persistence_write_enabled redacted_summary_persisted kde_status_persisted runtime_diagnostics_persisted dry_run_result_persisted raw_result_exposed dispatch_dry_run_executed request_object_creation_enabled request_object_dispatch_enabled portal_request_created notification_delivery_enabled notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled production_bus_claimed write_methods_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumption gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumption gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_preview_test.go") +
                                                                                                                                                                                                                                                     read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                                     read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                                     read_project_file("cmd/xnix-runtime-go/main.go")
%w[   production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumption-gate-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_consumed lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_ready notification_delivery_consent_collection_receipt_consumption_gate_review_only consent_collection_receipt_consumption_enabled consumption_authorization_required consumption_authorization_modeled consumption_authorization_ready explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted consent_receipt_accepted consent_receipt_consumed notification_delivery_consent_collection_receipt_consumption_gate_item_count ready_notification_delivery_consent_collection_receipt_consumption_gate_item_count missing_notification_delivery_consent_collection_receipt_consumption_gate_item_count receipt_acceptance_audit_consumed_item_count receipt_consumption_gate_modeled_item_count consent_receipt_created_item_count consent_receipt_consumed_item_count side_effect_notification_delivery_consent_collection_receipt_consumption_gate_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumption gate audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-authorization-audit-ready-authorization-disabled route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumption-gate-audit-consumed route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-acceptance-audit-consumed lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-authorization-modeled four-kde-notification-delivery-events-consent-collection-receipt-consumer-authorization-review-only consumer-authorization-grants-consumption-delivery-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer authorization audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_ready lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_ready notification_delivery_consent_collection_receipt_consumer_authorization_review_only consumer_authorization_required consumer_authorization_modeled consumer_authorization_ready consumer_authorization_grant_required consumer_authorization_grant_modeled consumer_authorization_grant_ready consumer_authorization_granted kde_consumer_authorized runtime_consumer_authorized kde_consumer_enabled runtime_consumer_enabled consent_collection_receipt_consumption_enabled explicit_user_consent_collected explicit_user_consent_persisted consent_receipt_created consent_receipt_persisted consent_receipt_accepted consent_receipt_consumed notification_delivery_grant_issued notification_delivery_disabled notification_delivery_consent_collection_receipt_consumer_authorization_item_count ready_notification_delivery_consent_collection_receipt_consumer_authorization_item_count missing_notification_delivery_consent_collection_receipt_consumer_authorization_item_count receipt_acceptance_audit_consumed_item_count receipt_consumption_gate_audit_consumed_item_count receipt_consumer_authorization_modeled_item_count consent_receipt_created_item_count consent_receipt_consumed_item_count consumer_authorization_granted_item_count authorized_kde_consumer_item_count authorized_runtime_consumer_item_count enabled_consumer_item_count side_effect_notification_delivery_consent_collection_receipt_consumer_authorization_item_count notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled storage_write_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer authorization audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_preview_test.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer authorization audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_preview_test.go") +
                                                                                                                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                                       read_project_file("cmd/xnix-runtime-go/main.go")
%w[   production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-authorization-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_consumed lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_ready notification_delivery_consent_collection_receipt_consumer_authorization_review_only consumer_authorization_required consumer_authorization_modeled consumer_authorization_ready consumer_authorization_grant_required consumer_authorization_grant_modeled consumer_authorization_grant_ready consumer_authorization_granted kde_consumer_authorized runtime_consumer_authorized kde_consumer_enabled runtime_consumer_enabled consent_receipt_created consent_receipt_consumed notification_delivery_consent_collection_receipt_consumer_authorization_item_count ready_notification_delivery_consent_collection_receipt_consumer_authorization_item_count missing_notification_delivery_consent_collection_receipt_consumer_authorization_item_count receipt_consumption_gate_audit_consumed_item_count receipt_consumer_authorization_modeled_item_count consumer_authorization_granted_item_count enabled_consumer_item_count side_effect_notification_delivery_consent_collection_receipt_consumer_authorization_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer authorization audit tests and CLI must include #{token}")
end

go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_preview.go")
%w[  xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-audit-ready-consumers-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-audit-blocked route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-authorization-audit-consumed route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumption-gate-audit-consumed lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-modeled four-kde-notification-delivery-events-consent-collection-receipt-consumer-enablement-gate-review-only consumer-enablements-authorization-grants-consumption-delivery-and-events-disabled notification-actions-action-cards-and-raw-results-disabled production-and-host-boundary-closed].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer enablement gate audit must include #{token}")
end
%w[current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_ready route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_ready lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_ready notification_delivery_consent_collection_receipt_consumer_enablement_gate_review_only consumer_authorization_required consumer_authorization_modeled consumer_authorization_ready consumer_enablement_gate_required consumer_enablement_gate_modeled consumer_enablement_gate_ready consumer_enablement_required consumer_enablement_modeled consumer_enablement_ready consumer_authorization_granted kde_consumer_authorized runtime_consumer_authorized kde_consumer_enabled runtime_consumer_enabled consumer_enabled consent_receipt_created consent_receipt_accepted consent_receipt_consumed notification_delivery_grant_issued notification_delivery_disabled notification_action_disabled action_cards_remain_disabled kde_safe_redacted_result_only raw_result_hidden notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count ready_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count missing_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count receipt_consumer_authorization_audit_consumed_item_count receipt_consumption_gate_audit_consumed_item_count receipt_consumer_enablement_gate_modeled_item_count enabled_consumer_item_count side_effect_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count notification_sent notification_center_event_triggered notification_action_enabled action_card_enabled storage_write_enabled runtime_writes_enabled host_root_modified validateNoBackendTerms].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer enablement gate audit must expose safety gate #{token}")
end
%w[docs/xnix-current-mainline.md route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_preview_test.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumption_gate_audit_preview_test.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview.go route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_acceptance_audit_preview_test.go].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer enablement gate audit must consume #{token}")
end
go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_test_source = read_project_file("internal/runtime/owner/route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_preview_test.go") +
                                                                                                                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_cli_test.go") +
                                                                                                                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/production_dbus_gate_commands.go") +
                                                                                                                                                                                                                                                    read_project_file("cmd/xnix-runtime-go/main.go")
%w[   production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-audit-preview current_mainline_consumed route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_authorization_audit_consumed lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_required lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_modeled lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_ready notification_delivery_consent_collection_receipt_consumer_enablement_gate_review_only consumer_authorization_required consumer_authorization_modeled consumer_authorization_ready consumer_enablement_gate_required consumer_enablement_gate_modeled consumer_enablement_gate_ready consumer_enablement_required consumer_enablement_modeled consumer_enablement_ready consumer_authorization_granted kde_consumer_enabled runtime_consumer_enabled consumer_enabled consent_receipt_created consent_receipt_consumed notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count ready_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count missing_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count receipt_consumer_authorization_audit_consumed_item_count receipt_consumer_enablement_gate_modeled_item_count enabled_consumer_item_count side_effect_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count state_root_path_exposed file_paths_exposed file_content_read].each do |token|
  assert(go_runtime_production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_test_source.include?(token), "Go Runtime production receipt notification action dry-run result lookup consumer enablement KDE-safe redacted status closed record writer storage-root authorization receipt dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer enablement gate audit tests and CLI must include #{token}")
end

xnix_current_mainline_source = read_project_file("docs/xnix-current-mainline.md")
%w[Xnix\ Current\ Mainline Codex-owned\ current\ mainline Product\ Goal Ownership\ Rules First-Release\ KDE\ Entrypoints Current\ Safe\ Next\ Task Safety\ Gates KDE\ Plasma\ is\ the\ only\ flagship\ desktop Runtime\ business\ logic\ is\ Go-first Ruby\ is\ for\ tests C\ remains\ for\ low-level redacted\ status\ writer\ authorization\ gate\ audit redacted\ status\ writer\ authorization\ receipt\ audit redacted\ status\ writer\ authorization\ receipt\ acceptance\ audit redacted\ status\ writer\ accepted\ receipt\ gate\ audit redacted\ status\ writer\ grant\ audit redacted\ status\ writer\ enablement\ audit redacted\ status\ closed\ writer\ implementation\ preview redacted\ status\ writer\ persistence\ authorization\ preview redacted\ status\ closed\ persistence\ writer\ preview redacted\ status\ storage\ persistence\ gate\ audit redacted\ status\ persistence\ record\ contract\ preview redacted\ status\ closed\ record\ writer\ implementation\ preview redacted\ status\ closed\ record\ writer\ storage-root\ policy\ audit\ preview redacted\ status\ closed\ record\ writer\ storage-root\ authorization\ receipt\ consumption\ audit\ preview redacted\ status\ closed\ record\ writer\ storage-root\ authorization\ receipt\ dry-run\ lookup\ evidence\ preview redacted\ status\ closed\ record\ writer\ storage-root\ authorization\ receipt\ dry-run\ lookup\ result\ boundary\ preview redacted\ status\ closed\ record\ writer\ storage-root\ authorization\ receipt\ dry-run\ lookup\ result\ consumer\ projection\ preview redacted\ status\ closed\ record\ writer\ storage-root\ authorization\ receipt\ dry-run\ lookup\ result\ consumer\ projection\ evidence\ audit\ preview redacted\ status\ closed\ record\ writer\ storage-root\ authorization\ receipt\ dry-run\ lookup\ result\ consumer\ projection\ route\ authorization\ evidence\ gate\ preview route\ enablement\ evidence\ gate\ preview route\ enablement\ receipt\ gate\ preview route\ enablement\ receipt\ acceptance\ audit\ preview route\ enablement\ accepted\ receipt\ gate\ audit\ preview route\ enablement\ lookup\ route\ grant\ audit\ preview route\ enablement\ lookup\ route\ enablement\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ gate\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ authorization\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ execution\ gate\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ capture\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ redaction\ boundary\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ redacted\ presentation\ eligibility\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ presentation\ consent\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ presentation\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ authorization\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ grant\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ explicit\ consent\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ consent\ collection\ gate\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ consent\ collection\ receipt\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ consent\ collection\ receipt\ acceptance\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ consent\ collection\ receipt\ consumption\ gate\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ consent\ collection\ receipt\ consumer\ authorization\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ consent\ collection\ receipt\ consumer\ enablement\ gate\ audit\ preview route\ enablement\ lookup\ route\ dispatch\ dry-run\ result\ notification\ delivery\ execution\ authorization\ audit\ preview].each do |token|
