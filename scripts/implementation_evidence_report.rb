...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/owner/restricted_smoke_receipt_fanout_owner_route_audit.go" => %w[xnix.runtime.restricted_owner_smoke_receipt_fanout_owner_route_audit.v1 restricted-owner-smoke-receipt-fanout-owner-route-audit-preview NewRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditPreview GetRestrictedOwnerSmokeReceiptFanOutOwnerRouteAudit remain-cli-only cli-preview-ready-owner-route-blocked caller-state-root-boundary owner-managed-receipt-lookup route-decision ConsumesExistingReceipt RequiresCallerStateRoot ReceiptLookupOwnerManaged OpaqueReceiptIDSupported FanOutWritesEnabled StateRootWritesEnabled BackendLaunchEnabled HostRootModified],
      "internal/runtime/owner/restricted_smoke_receipt_fanout_owner_route_audit_test.go" => %w[TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditKeepsFanOutCLIOnly TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditFailsClosedWithoutSources remain-cli-only caller-state-root-boundary owner-managed-receipt-lookup],
      "cmd/xnix-runtime-go/restricted_owner_smoke_receipt_commands.go" => %w[restricted-owner-smoke-receipt-record runRestrictedOwnerSmokeReceiptRecord authorize-restricted-owner-smoke restricted-owner-smoke-receipt-fanout-owner-route-audit-preview runRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditPreview],
      "cmd/xnix-runtime-go/restricted_owner_smoke_receipt_cli_test.go" => %w[TestRestrictedOwnerSmokeReceiptRecordCommandPersistsReceipt TestRestrictedOwnerSmokeReceiptRecordCommandRequiresAuthorization TestRestrictedOwnerSmokeReceiptFanOutPreviewCommandCoversReadinessAndSupportSurfaces TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditPreviewCommand xnix.runtime.restricted_owner_smoke_receipt.v1 xnix.runtime.restricted_owner_smoke_receipt_fanout.v1 xnix.runtime.restricted_owner_smoke_receipt_fanout_owner_route_audit.v1],
