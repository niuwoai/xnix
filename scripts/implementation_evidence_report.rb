...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "cmd/xnix-runtime-go/production_dbus_gate_commands.go" => %w[production-dbus-gate-review-preview runProductionDBusGateReviewPreview NewProductionDBusGateReviewPreview production-dbus-human-authorization-preflight-preview runProductionDBusHumanAuthorizationPreflightPreview NewProductionDBusHumanAuthorizationPreflightPreview production-dbus-method-review-preview runProductionDBusMethodReviewPreview NewProductionDBusMethodReviewPreview production-rollback-diagnostics-review-preview runProductionRollbackDiagnosticsReviewPreview NewProductionRollbackDiagnosticsReviewPreview],
      "cmd/xnix-runtime-go/production_dbus_gate_cli_test.go" => %w[TestProductionDBusGateReviewPreviewCommand TestProductionDBusHumanAuthorizationPreflightPreviewCommand TestProductionDBusMethodReviewPreviewCommand TestProductionRollbackDiagnosticsReviewPreviewCommand production-dbus-gate-review-preview production-dbus-human-authorization-preflight-preview production-dbus-method-review-preview production-rollback-diagnostics-review-preview smoke_covered_route_count production_readiness human_authorization_required human_authorization_preflight_ready authorization_receipt_present authorization_accepted read_only_contract_method_count owner_local_candidate_count write_method_count production_exposure_ready_count production_owner_enabled production_activation_ready rollback_control_count diagnostics_control_count side_effect_control_count production_ownership_ready snapshot_restore_executed state_cleanup_executed],
