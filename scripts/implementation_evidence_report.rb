...
DOMAIN_DEFINITIONS = [
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/kde_offline_application_identity.go" => %w[xnix.runtime.kde_offline_application_identity.v1 kde-offline-application-identity-preview GetKDEOfflineApplicationIdentity GetKDEOfflineApplicationIdentityPreview DesktopEntry MIMEAssociations KRunner TaskManager KWin Tray Notification CrossSurfaceIdentityConsistent NotificationIDNamespace DesktopFilesWritten MIMEDefaultsWritten KRunnerIndexPersisted TaskManagerEntryActive KWinRuleApplied LiveTrayBridgeEnabled TrayBridgePersisted NotificationSent NotificationDeliveryEnabled NotificationActionsEnabled LaunchEnabled ExecutionStarted BackendProcessStarted HostRootModified],
