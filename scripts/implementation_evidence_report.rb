...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "cmd/xnix-runtime-go/restricted_owner_smoke_receipt_commands.go" => %w[restricted-owner-smoke-receipt-record runRestrictedOwnerSmokeReceiptRecord authorize-restricted-owner-smoke],
