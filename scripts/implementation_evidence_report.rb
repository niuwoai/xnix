...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "cmd/xnix-runtime-go/production_dbus_gate_commands.go" => %w[production-dbus-gate-review-preview runProductionDBusGateReviewPreview NewProductionDBusGateReviewPreview production-dbus-human-authorization-preflight-preview runProductionDBusHumanAuthorizationPreflightPreview NewProductionDBusHumanAuthorizationPreflightPreview production-dbus-method-review-preview runProductionDBusMethodReviewPreview NewProductionDBusMethodReviewPreview],
      "cmd/xnix-runtime-go/production_dbus_gate_cli_test.go" => %w[TestProductionDBusGateReviewPreviewCommand TestProductionDBusHumanAuthorizationPreflightPreviewCommand TestProductionDBusMethodReviewPreviewCommand production-dbus-gate-review-preview production-dbus-human-authorization-preflight-preview production-dbus-method-review-preview smoke_covered_route_count production_readiness human_authorization_required human_authorization_preflight_ready authorization_receipt_present authorization_accepted read_only_contract_method_count owner_local_candidate_count write_method_count production_exposure_ready_count production_owner_enabled production_activation_ready],
