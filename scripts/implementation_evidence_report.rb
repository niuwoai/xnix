...
DOMAIN_DEFINITIONS = [
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/identity.go" => %w[KRunnerQueryOptions ActivationReceiptBacked ReceiptBackedMatchCount FileOpenOptions TrayStatusOptions NotificationOptions ActivationReceiptRoot]
    },
    summary: "KDE activation can stage desktop files, MIME data, service menus, manifests, and receipts under explicit roots, and KDE status, Compatibility Center pages, KRunner query previews, Dolphin file-manager previews, tray status previews, and notification previews can consume staged activation receipt evidence."
  },
  {
