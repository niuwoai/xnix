...
DOMAIN_DEFINITIONS = [
  {
    ...
    fixture_files: %w[
      ...
      internal/runtime/owner/production_dbus_gate_review.go
      internal/runtime/owner/production_dbus_gate_review_test.go
      internal/runtime/owner/production_dbus_human_authorization_preflight.go
      internal/runtime/owner/production_dbus_human_authorization_preflight_test.go
      internal/runtime/owner/production_human_authorization_receipt_consolidation.go
      internal/runtime/owner/production_human_authorization_receipt_consolidation_test.go
      internal/runtime/owner/production_authorization_consumption_audit.go
      internal/runtime/owner/production_authorization_consumption_audit_test.go
      internal/runtime/owner/production_receipt_acceptance_propagation_preflight.go
      internal/runtime/owner/production_receipt_acceptance_propagation_preflight_test.go
      internal/runtime/owner/production_receipt_writer_authorization_review.go
      internal/runtime/owner/production_receipt_writer_authorization_review_test.go
      internal/runtime/owner/production_receipt_persistence_threat_review.go
      internal/runtime/owner/production_receipt_persistence_threat_review_test.go
      internal/runtime/owner/production_receipt_revocation_visibility_audit.go
      internal/runtime/owner/production_receipt_revocation_visibility_audit_test.go
      internal/runtime/owner/production_receipt_notification_delivery_gate_audit.go
      internal/runtime/owner/production_receipt_notification_delivery_gate_audit_test.go
      internal/runtime/owner/production_receipt_notification_action_safety_audit.go
      internal/runtime/owner/production_receipt_notification_action_safety_audit_test.go
      internal/runtime/owner/production_desktop_side_effect_review.go
      internal/runtime/owner/production_desktop_side_effect_review_test.go
      internal/runtime/owner/production_rollback_diagnostics_review.go
      internal/runtime/owner/production_rollback_diagnostics_review_test.go
      ...
      cmd/xnix-runtime-go/production_dbus_gate_commands.go
      cmd/xnix-runtime-go/production_dbus_gate_cli_test.go
    ],
    state_files: [],
    smoke_files: %w[
    ...
    gate_tokens: {
      ...
      "internal/runtime/owner/production_dbus_gate_review.go" => %w[xnix.runtime.production_dbus_gate_review.v1 production-dbus-gate-review-preview NewProductionDBusGateReviewPreview owner-local-smoke-covered-production-dbus-gate-review production-dbus-gate-review-ready materialization-fanout-owner-route restricted-smoke-fanout-owner-route redacted-adapter-profile-owner-route smoke-coverage-present production-dbus-disabled human-authorization-preflight-present human-authorization-required HumanAuthorizationPreflightReady HumanAuthorizationGranted AuthorizationReceiptAccepted ProductionReadiness HumanAuthorizationRequired ProductionOwnerEnabled ProductionActivationReady WriteMethodsEnabled RuntimeWritesEnabled BackendLaunchEnabled HostRootModified],
      "internal/runtime/owner/production_dbus_gate_review_test.go" => %w[TestProductionDBusGateReviewPreviewInventoriesSmokeCoveredRoutes TestProductionDBusGateReviewPreviewFailsClosedWithoutSources production-dbus-gate-review-ready human-authorization-preflight-present human-authorization-required],
      "internal/runtime/owner/production_dbus_human_authorization_preflight.go" => %w[xnix.runtime.production_dbus_human_authorization_preflight.v1 production-dbus-human-authorization-preflight-preview NewProductionDBusHumanAuthorizationPreflightPreview read-only-production-dbus-human-authorization-preflight production-dbus-human-authorization-receipt-id gate-review-present route-inventory-present human-authorization-required receipt-shape-declared authorization-not-granted production-ownership-disabled unsafe-gates-closed PreflightReady AuthorizationReceiptRequired AuthorizationReceiptPresent AuthorizationGrantReady AuthorizationAccepted ProductionReadiness ProductionOwnerEnabled ProductionActivationReady BackendLaunchEnabled HostRootModified],
      "internal/runtime/owner/production_dbus_human_authorization_preflight_test.go" => %w[TestProductionDBusHumanAuthorizationPreflightPreviewDefinesReceiptShape TestProductionDBusHumanAuthorizationPreflightPreviewFailsClosedWithoutGateReview production-dbus-human-authorization-preflight-preview authorization-not-granted],
      "internal/runtime/owner/production_human_authorization_receipt_consolidation.go" => %w[xnix.runtime.production_human_authorization_receipt_consolidation.v1 production-human-authorization-receipt-consolidation-preview NewProductionHumanAuthorizationReceiptConsolidationPreview owner-managed-opaque-human-authorization-receipt-boundary production-human-authorization-receipt-consolidation-ready-authorization-disabled production-human-authorization-receipt-consolidation-blocked production-dbus-human-authorization-preflight-preview production-dbus-gate-review-preview production-dbus-method-review-preview runtime-service-activation-preflight-preview runtime-write-gate-preview production-rollback-diagnostics-review-preview production-desktop-side-effect-review-preview preflight-shape-consumed production-gate-consumed method-review-consumed service-and-write-gates-consumed rollback-and-desktop-reviews-consumed opaque-receipt-boundary authorization-not-granted unsafe-gates-closed ReceiptBoundaryConsolidated OwnerManagedOpaqueReceiptLookupReady CallerStateRootRequired ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled AuthorizationGrantReady AuthorizationAccepted ProductionReadiness ProductionOwnershipReady GateCount RequiredGateCount ConsumedGateCount MissingGateCount AuthorizationAcceptedGateCount ProductionReadyGateCount SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten NotificationSent SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_human_authorization_receipt_consolidation_test.go" => %w[TestProductionHumanAuthorizationReceiptConsolidationPreviewConsumesProductionGates TestProductionHumanAuthorizationReceiptConsolidationPreviewFailsClosedWithoutSources production-human-authorization-receipt-consolidation-preview production-human-authorization-receipt-consolidation-ready-authorization-disabled],
      "internal/runtime/owner/production_authorization_consumption_audit.go" => %w[xnix.runtime.production_authorization_consumption_audit.v1 production-authorization-consumption-audit-preview NewProductionAuthorizationConsumptionAuditPreview production-gate-consolidated-authorization-consumption-audit production-authorization-consumption-audit-ready-authorization-disabled production-authorization-consumption-audit-blocked production-human-authorization-receipt-consolidation-preview production-dbus-gate-review-preview production-dbus-method-review-preview runtime-service-activation-preflight-preview runtime-write-gate-preview production-rollback-diagnostics-review-preview production-desktop-side-effect-review-preview consolidation-preview-consumed six-production-consumers-present consumers-use-consolidated-boundary authorization-not-accepted production-ownership-disabled write-and-launch-disabled desktop-and-support-side-effects-disabled host-boundary-closed ReceiptBoundaryConsolidated ConsolidationPreviewConsumed OwnerManagedOpaqueBoundaryReady CallerStateRootRequired ConsumerCount RequiredConsumerCount ConsumedConsumerCount MissingConsumerCount AuthorizationAcceptedConsumerCount ProductionReadyConsumerCount SideEffectConsumerCount ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled AuthorizationAccepted ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_authorization_consumption_audit_test.go" => %w[TestProductionAuthorizationConsumptionAuditPreviewVerifiesConsumers TestProductionAuthorizationConsumptionAuditPreviewFailsClosedWithoutSources production-authorization-consumption-audit-preview production-authorization-consumption-audit-ready-authorization-disabled],
      "internal/runtime/owner/production_receipt_acceptance_propagation_preflight.go" => %w[xnix.runtime.production_receipt_acceptance_propagation_preflight.v1 production-receipt-acceptance-propagation-preflight-preview NewProductionReceiptAcceptancePropagationPreflightPreview future-authorization-receipt-acceptance-propagation-preflight production-receipt-acceptance-propagation-ready-acceptance-disabled production-receipt-acceptance-propagation-preflight-blocked production-authorization-consumption-audit-preview production-dbus-gate-review-preview production-dbus-method-review-preview runtime-service-activation-preflight-preview runtime-write-gate-preview production-rollback-diagnostics-review-preview production-desktop-side-effect-review-preview consumption-audit-consumed future-acceptance-modeled-only six-propagation-targets-present targets-propagate-future-acceptance acceptance-and-production-disabled production-ownership-disabled write-and-launch-disabled desktop-support-and-host-boundary-closed FutureAcceptanceModeled AcceptanceSimulationOnly ConsumptionAuditConsumed OwnerManagedOpaqueBoundaryReady PropagationPreflightReady TargetCount RequiredTargetCount PropagationReadyTargetCount MissingTargetCount AcceptanceEnabledTargetCount ProductionReadyTargetCount SideEffectTargetCount ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled AuthorizationAccepted ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_acceptance_propagation_preflight_test.go" => %w[TestProductionReceiptAcceptancePropagationPreflightPreviewModelsFutureAcceptance TestProductionReceiptAcceptancePropagationPreflightPreviewFailsClosedWithoutSources production-receipt-acceptance-propagation-preflight-preview production-receipt-acceptance-propagation-ready-acceptance-disabled],
      "internal/runtime/owner/production_receipt_writer_authorization_review.go" => %w[xnix.runtime.production_receipt_writer_authorization_review.v1 production-receipt-writer-authorization-review-preview NewProductionReceiptWriterAuthorizationReviewPreview receipt-writer-operator-authorization-boundary-review production-receipt-writer-authorization-review-ready-writes-disabled production-receipt-writer-authorization-review-blocked production-receipt-acceptance-propagation-preflight-preview production-human-authorization-receipt-consolidation-preview production-authorization-consumption-audit-preview acceptance-propagation-consumed writer-authorization-modeled-only five-review-items-present review-items-ready-writes-disabled receipt-writes-disabled production-ownership-disabled runtime-side-effects-disabled host-boundary-closed WriterAuthorizationRequired WriterAuthorizationModeled OperatorActionRequired AcceptancePropagationConsumed OwnerManagedOpaqueBoundaryReady WriterReviewReady ReviewItemCount RequiredReviewItemCount ReadyReviewItemCount MissingReviewItemCount WriteEnabledReviewItemCount AcceptanceEnabledReviewItemCount SideEffectReviewItemCount ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ReceiptReplayEnabled AuthorizationAccepted ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_writer_authorization_review_test.go" => %w[TestProductionReceiptWriterAuthorizationReviewPreviewModelsWriterBoundary TestProductionReceiptWriterAuthorizationReviewPreviewFailsClosedWithoutSources production-receipt-writer-authorization-review-preview production-receipt-writer-authorization-review-ready-writes-disabled],
      "internal/runtime/owner/production_receipt_persistence_threat_review.go" => %w[xnix.runtime.production_receipt_persistence_threat_review.v1 production-receipt-persistence-threat-review-preview NewProductionReceiptPersistenceThreatReviewPreview receipt-persistence-expiry-revocation-replay-threat-review production-receipt-persistence-threat-review-ready-persistence-disabled production-receipt-persistence-threat-review-blocked production-receipt-writer-authorization-review-preview production-receipt-acceptance-propagation-preflight-preview writer-authorization-review-consumed persistence-threat-modeled-only five-threat-items-present threat-items-ready-persistence-disabled receipt-persistence-disabled production-ownership-disabled runtime-side-effects-disabled host-boundary-closed storage-confidentiality expiry-policy revocation-policy replay-protection audit-visibility PersistenceThreatReviewRequired PersistenceThreatReviewModeled WriterAuthorizationReviewConsumed OwnerManagedOpaqueBoundaryReady PersistenceThreatReviewReady ThreatItemCount RequiredThreatItemCount ReadyThreatItemCount MissingThreatItemCount PersistenceEnabledThreatCount ReplayEnabledThreatCount AcceptanceEnabledThreatCount SideEffectThreatCount ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ReceiptReplayEnabled ReceiptExpiryWriteEnabled ReceiptRevocationWriteEnabled AuthorizationAccepted ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_persistence_threat_review_test.go" => %w[TestProductionReceiptPersistenceThreatReviewPreviewModelsThreats TestProductionReceiptPersistenceThreatReviewPreviewFailsClosedWithoutSources production-receipt-persistence-threat-review-preview production-receipt-persistence-threat-review-ready-persistence-disabled],
      "internal/runtime/owner/production_receipt_revocation_visibility_audit.go" => %w[xnix.runtime.production_receipt_revocation_visibility_audit.v1 production-receipt-revocation-visibility-audit-preview NewProductionReceiptRevocationVisibilityAuditPreview receipt-expiry-revocation-production-kde-visibility-audit production-receipt-revocation-visibility-audit-ready-visibility-only production-receipt-revocation-visibility-audit-blocked production-receipt-persistence-threat-review-preview production-desktop-side-effect-review-preview persistence-threat-review-consumed desktop-side-effect-review-consumed revocation-visibility-modeled-only five-visibility-items-present visibility-items-ready-writes-disabled revocation-expiry-writes-disabled notifications-and-desktop-side-effects-disabled production-ownership-disabled host-boundary-closed receipt-current-visible receipt-expiring-visible receipt-expired-visible receipt-revoked-visible receipt-missing-review-visible VisibilityAuditRequired VisibilityAuditModeled PersistenceThreatReviewConsumed DesktopSideEffectReviewConsumed ProductionGateVisibilityModeled KDEStatusVisibilityModeled RevocationVisibilityReady VisibilityItemCount RequiredVisibilityItemCount ReadyVisibilityItemCount MissingVisibilityItemCount RevocationWriteEnabledItemCount ExpiryWriteEnabledItemCount NotificationEnabledItemCount SideEffectItemCount ReceiptRevocationWriteEnabled ReceiptExpiryWriteEnabled ReceiptRevocationVisibilityPersisted NotificationDeliveryEnabled CompatibilityCenterPersisted ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_revocation_visibility_audit_test.go" => %w[TestProductionReceiptRevocationVisibilityAuditPreviewModelsVisibility TestProductionReceiptRevocationVisibilityAuditPreviewFailsClosedWithoutSources production-receipt-revocation-visibility-audit-preview production-receipt-revocation-visibility-audit-ready-visibility-only],
      "internal/runtime/owner/production_receipt_notification_delivery_gate_audit.go" => %w[xnix.runtime.production_receipt_notification_delivery_gate_audit.v1 production-receipt-notification-delivery-gate-audit-preview NewProductionReceiptNotificationDeliveryGateAuditPreview receipt-expiry-revocation-notification-delivery-gate-audit production-receipt-notification-delivery-gate-audit-ready-delivery-disabled production-receipt-notification-delivery-gate-audit-blocked production-receipt-revocation-visibility-audit-preview production-desktop-side-effect-review-preview revocation-visibility-audit-consumed desktop-side-effect-review-consumed notification-gate-modeled-only five-notification-gate-items-present gate-items-ready-delivery-disabled notification-delivery-disabled requests-and-persistence-disabled receipt-writes-disabled production-and-host-boundary-closed expiring-receipt-warning-gate expired-receipt-blocker-gate revoked-receipt-blocker-gate missing-review-reminder-gate operator-approval-gate NotificationGateRequired NotificationGateModeled RevocationVisibilityAuditConsumed DesktopSideEffectReviewConsumed OperatorNotificationApprovalRequired OperatorNotificationApprovalPresent NotificationDeliveryGateReady GateItemCount RequiredGateItemCount ReadyGateItemCount MissingGateItemCount DeliveryEnabledItemCount NotificationSentItemCount RequestCreatedItemCount SideEffectItemCount NotificationDeliveryGatePersisted NotificationActionEnabled NotificationSent NotificationDeliveryEnabled PortalRequestCreated RequestObjectsCreated ReceiptRevocationWriteEnabled ReceiptExpiryWriteEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_delivery_gate_audit_test.go" => %w[TestProductionReceiptNotificationDeliveryGateAuditPreviewModelsGate TestProductionReceiptNotificationDeliveryGateAuditPreviewFailsClosedWithoutSources production-receipt-notification-delivery-gate-audit-preview production-receipt-notification-delivery-gate-audit-ready-delivery-disabled],
      "internal/runtime/owner/production_receipt_notification_action_safety_audit.go" => %w[xnix.runtime.production_receipt_notification_action_safety_audit.v1 production-receipt-notification-action-safety-audit-preview NewProductionReceiptNotificationActionSafetyAuditPreview receipt-notification-action-request-safety-audit production-receipt-notification-action-safety-audit-ready-actions-disabled production-receipt-notification-action-safety-audit-blocked production-receipt-notification-delivery-gate-audit-preview production-desktop-side-effect-review-preview notification-delivery-gate-consumed desktop-side-effect-review-consumed action-safety-modeled-only five-action-items-present action-items-ready-actions-disabled notification-actions-disabled requests-and-navigation-disabled receipt-and-notification-writes-disabled production-and-host-boundary-closed review-receipt-action renew-receipt-action open-compatibility-center-action dismiss-receipt-action support-info-action ActionSafetyAuditRequired ActionSafetyAuditModeled NotificationDeliveryGateConsumed DesktopSideEffectReviewConsumed OperatorActionApprovalRequired OperatorActionApprovalPresent NotificationActionSafetyReady ActionItemCount RequiredActionItemCount ReadyActionItemCount MissingActionItemCount EnabledActionItemCount RequestCreatedItemCount NavigationEnabledItemCount SideEffectItemCount NotificationActionSafetyPersisted ReviewActionEnabled RenewActionEnabled OpenCompatibilityCenterEnabled DismissActionEnabled SupportInfoActionEnabled CompatibilityCenterOpened NotificationActionEnabled PortalRequestCreated RequestObjectsCreated ReceiptRevocationWriteEnabled ReceiptExpiryWriteEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_safety_audit_test.go" => %w[TestProductionReceiptNotificationActionSafetyAuditPreviewModelsActions TestProductionReceiptNotificationActionSafetyAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-safety-audit-preview production-receipt-notification-action-safety-audit-ready-actions-disabled],
      "internal/runtime/owner/production_receipt_notification_action_request_object_audit.go" => %w[xnix.runtime.production_receipt_notification_action_request_object_audit.v1 production-receipt-notification-action-request-object-audit-preview NewProductionReceiptNotificationActionRequestObjectAuditPreview receipt-notification-action-runtime-request-object-audit production-receipt-notification-action-request-object-audit-ready-requests-disabled production-receipt-notification-action-request-object-audit-blocked production-receipt-notification-action-safety-audit-preview windows-app-compatibility-implementation-brief action-safety-audit-consumed dispatch-request-boundary-consumed request-object-modeled-only five-request-objects-present request-objects-ready-creation-disabled request-creation-disabled actions-navigation-and-portal-disabled receipt-notification-and-support-writes-disabled production-and-host-boundary-closed review-receipt-request-object renew-receipt-request-object open-compatibility-center-request-object dismiss-receipt-request-object support-info-request-object RequestObjectAuditRequired RequestObjectAuditModeled ActionSafetyAuditConsumed DispatchRequestBoundaryConsumed OperatorActionApprovalRequired OperatorActionApprovalPresent RequestObjectBoundaryReady RequestObjectCount RequiredRequestObjectCount ReadyRequestObjectCount MissingRequestObjectCount CreatedRequestObjectCount DispatchedRequestObjectCount PortalRequestCreatedCount NavigationRequestedCount SideEffectRequestObjectCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled ReviewActionEnabled RenewActionEnabled OpenCompatibilityCenterEnabled DismissActionEnabled SupportInfoActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_request_object_audit_test.go" => %w[TestProductionReceiptNotificationActionRequestObjectAuditPreviewModelsRequests TestProductionReceiptNotificationActionRequestObjectAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-request-object-audit-preview production-receipt-notification-action-request-object-audit-ready-requests-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dispatch_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dispatch_authorization_audit.v1 production-receipt-notification-action-dispatch-authorization-audit-preview NewProductionReceiptNotificationActionDispatchAuthorizationAuditPreview receipt-notification-action-request-dispatch-authorization-audit production-receipt-notification-action-dispatch-authorization-audit-ready-dispatch-disabled production-receipt-notification-action-dispatch-authorization-audit-blocked production-receipt-notification-action-request-object-audit-preview production-authorization-consumption-audit-preview request-object-audit-consumed receipt-authorization-boundary-consumed dispatch-authorization-modeled-only five-dispatch-authorizations-present dispatch-authorizations-ready-dispatch-disabled dispatch-disabled request-creation-actions-and-portal-disabled receipt-notification-navigation-and-support-writes-disabled production-and-host-boundary-closed review-receipt-dispatch-authorization renew-receipt-dispatch-authorization open-compatibility-center-dispatch-authorization dismiss-receipt-dispatch-authorization support-info-dispatch-authorization DispatchAuthorizationAuditRequired DispatchAuthorizationAuditModeled RequestObjectAuditConsumed ReceiptAuthorizationBoundaryConsumed OperatorDispatchApprovalRequired OperatorDispatchApprovalPresent DispatchAuthorizationReady DispatchAuthorizationGranted AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount GrantedAuthorizationItemCount DispatchedAuthorizationItemCount CreatedRequestObjectCount PortalRequestCreatedCount SideEffectAuthorizationItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled DispatchAuthorizationPersisted RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled ReviewActionEnabled RenewActionEnabled OpenCompatibilityCenterEnabled DismissActionEnabled SupportInfoActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dispatch_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDispatchAuthorizationAuditPreviewModelsDispatch TestProductionReceiptNotificationActionDispatchAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dispatch-authorization-audit-preview production-receipt-notification-action-dispatch-authorization-audit-ready-dispatch-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dispatch_dry_run_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dispatch_dry_run_audit.v1 production-receipt-notification-action-dispatch-dry-run-audit-preview NewProductionReceiptNotificationActionDispatchDryRunAuditPreview receipt-notification-action-request-dispatch-dry-run-audit production-receipt-notification-action-dispatch-dry-run-audit-ready-dry-run-only production-receipt-notification-action-dispatch-dry-run-audit-blocked production-receipt-notification-action-dispatch-authorization-audit-preview dispatch-authorization-audit-consumed dispatch-dry-run-guidance-consumed dispatch-dry-run-modeled-only five-dispatch-dry-run-items-present dispatch-dry-run-items-ready-execution-disabled dry-run-execution-disabled request-creation-dispatch-actions-and-portal-disabled receipt-notification-navigation-and-support-writes-disabled production-and-host-boundary-closed review-receipt-dispatch-dry-run renew-receipt-dispatch-dry-run open-compatibility-center-dispatch-dry-run dismiss-receipt-dispatch-dry-run support-info-dispatch-dry-run DispatchDryRunAuditRequired DispatchDryRunAuditModeled DispatchAuthorizationAuditConsumed DispatchDryRunGuidanceConsumed DispatchDryRunPlanReady DispatchDryRunExecuted DispatchAuthorizationGranted DryRunItemCount RequiredDryRunItemCount ReadyDryRunItemCount MissingDryRunItemCount ExecutedDryRunItemCount DispatchedDryRunItemCount CreatedRequestObjectCount PortalRequestCreatedCount SideEffectDryRunItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled DispatchAuthorizationPersisted DispatchDryRunExecutionEnabled DryRunResultPersisted RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled ReviewActionEnabled RenewActionEnabled OpenCompatibilityCenterEnabled DismissActionEnabled SupportInfoActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dispatch_dry_run_audit_test.go" => %w[TestProductionReceiptNotificationActionDispatchDryRunAuditPreviewModelsDryRun TestProductionReceiptNotificationActionDispatchDryRunAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dispatch-dry-run-audit-preview production-receipt-notification-action-dispatch-dry-run-audit-ready-dry-run-only],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_visibility_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_visibility_audit.v1 production-receipt-notification-action-dry-run-result-visibility-audit-preview NewProductionReceiptNotificationActionDryRunResultVisibilityAuditPreview receipt-notification-action-dry-run-result-visibility-audit production-receipt-notification-action-dry-run-result-visibility-audit-ready-visibility-only production-receipt-notification-action-dry-run-result-visibility-audit-blocked production-receipt-notification-action-dispatch-dry-run-audit-preview dispatch-dry-run-audit-consumed dry-run-result-visibility-guidance-consumed dry-run-result-visibility-modeled-only five-dry-run-result-visibility-items-present visibility-items-ready-results-redacted dry-run-execution-and-result-persistence-disabled request-creation-dispatch-actions-and-portal-disabled receipt-notification-navigation-and-support-writes-disabled production-and-host-boundary-closed review-receipt-dry-run-result-visibility renew-receipt-dry-run-result-visibility open-compatibility-center-dry-run-result-visibility dismiss-receipt-dry-run-result-visibility support-info-dry-run-result-visibility ResultVisibilityAuditRequired ResultVisibilityAuditModeled DispatchDryRunAuditConsumed ResultVisibilityGuidanceConsumed ResultVisibilityPlanReady RedactedKDEVisibilityModeled RuntimeDiagnosticsVisibilityModeled DispatchDryRunExecuted DryRunResultPersisted VisibilityItemCount RequiredVisibilityItemCount ReadyVisibilityItemCount MissingVisibilityItemCount PersistedVisibilityItemCount ExecutedDryRunItemCount DispatchedDryRunItemCount CreatedRequestObjectCount PortalRequestCreatedCount SideEffectVisibilityItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled DispatchAuthorizationPersisted DispatchDryRunExecutionEnabled DryRunResultPersistenceEnabled ResultVisibilityPersistenceEnabled RuntimeDiagnosticsPersisted RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled ReviewActionEnabled RenewActionEnabled OpenCompatibilityCenterEnabled DismissActionEnabled SupportInfoActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_visibility_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultVisibilityAuditPreviewModelsVisibility TestProductionReceiptNotificationActionDryRunResultVisibilityAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-visibility-audit-preview production-receipt-notification-action-dry-run-result-visibility-audit-ready-visibility-only],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_persistence_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_persistence_authorization_audit.v1 production-receipt-notification-action-dry-run-result-persistence-authorization-audit-preview NewProductionReceiptNotificationActionDryRunResultPersistenceAuthorizationAuditPreview receipt-notification-action-dry-run-result-persistence-authorization-audit production-receipt-notification-action-dry-run-result-persistence-authorization-audit-ready-persistence-disabled production-receipt-notification-action-dry-run-result-persistence-authorization-audit-blocked production-receipt-notification-action-dry-run-result-visibility-audit-preview result-visibility-audit-consumed persistence-authorization-guidance-consumed persistence-authorization-modeled-only five-persistence-authorizations-present persistence-authorizations-ready-persistence-disabled dry-run-execution-result-and-visibility-persistence-disabled request-creation-dispatch-actions-and-portal-disabled receipt-notification-navigation-and-support-writes-disabled production-and-host-boundary-closed review-receipt-dry-run-result-persistence-authorization renew-receipt-dry-run-result-persistence-authorization open-compatibility-center-dry-run-result-persistence-authorization dismiss-receipt-dry-run-result-persistence-authorization support-info-dry-run-result-persistence-authorization PersistenceAuthorizationAuditRequired PersistenceAuthorizationAuditModeled ResultVisibilityAuditConsumed PersistenceAuthorizationGuidanceConsumed PersistenceAuthorizationReady ResultPersistenceAuthorized DispatchDryRunExecuted DryRunResultPersisted ResultVisibilityPersisted AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount GrantedPersistenceItemCount PersistedResultItemCount ExecutedDryRunItemCount CreatedRequestObjectCount PortalRequestCreatedCount SideEffectAuthorizationItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled DispatchAuthorizationPersisted DispatchDryRunExecutionEnabled DryRunResultPersistenceEnabled ResultVisibilityPersistenceEnabled RuntimeDiagnosticsPersisted RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled ReviewActionEnabled RenewActionEnabled OpenCompatibilityCenterEnabled DismissActionEnabled SupportInfoActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_persistence_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultPersistenceAuthorizationAuditPreviewModelsAuthorization TestProductionReceiptNotificationActionDryRunResultPersistenceAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-persistence-authorization-audit-preview production-receipt-notification-action-dry-run-result-persistence-authorization-audit-ready-persistence-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_retention_redaction_policy_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_retention_redaction_policy_audit.v1 production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-preview NewProductionReceiptNotificationActionDryRunResultRetentionRedactionPolicyAuditPreview receipt-notification-action-dry-run-result-retention-redaction-policy-audit production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-ready-policy-only production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-blocked production-receipt-notification-action-dry-run-result-persistence-authorization-audit-preview persistence-authorization-audit-consumed retention-redaction-guidance-consumed retention-redaction-policy-modeled-only five-retention-redaction-policy-items-present policy-items-ready-enforcement-disabled enforcement-persistence-and-execution-disabled request-creation-dispatch-actions-and-portal-disabled receipt-notification-navigation-and-support-writes-disabled production-and-host-boundary-closed review-receipt-dry-run-result-retention-redaction-policy renew-receipt-dry-run-result-retention-redaction-policy open-compatibility-center-dry-run-result-retention-redaction-policy dismiss-receipt-dry-run-result-retention-redaction-policy support-info-dry-run-result-retention-redaction-policy RetentionRedactionPolicyAuditRequired RetentionRedactionPolicyAuditModeled PersistenceAuthorizationAuditConsumed RetentionRedactionGuidanceConsumed RetentionRedactionPolicyReady RetentionWindowModeled RedactionRulesModeled ResultPersistenceAuthorized RetentionEnforcementEnabled RedactionEnforcementEnabled DispatchDryRunExecuted DryRunResultPersisted ResultVisibilityPersisted PolicyItemCount RequiredPolicyItemCount ReadyPolicyItemCount MissingPolicyItemCount RetentionEnabledItemCount RedactionWriteItemCount PersistedResultItemCount ExecutedDryRunItemCount CreatedRequestObjectCount PortalRequestCreatedCount SideEffectPolicyItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled DispatchDryRunExecutionEnabled DryRunResultPersistenceEnabled ResultVisibilityPersistenceEnabled RetentionPolicyPersistenceEnabled RuntimeDiagnosticsPersisted RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_retention_redaction_policy_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultRetentionRedactionPolicyAuditPreviewModelsPolicy TestProductionReceiptNotificationActionDryRunResultRetentionRedactionPolicyAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-preview production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-ready-policy-only],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_opaque_lookup_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_opaque_lookup_audit.v1 production-receipt-notification-action-dry-run-result-opaque-lookup-audit-preview NewProductionReceiptNotificationActionDryRunResultOpaqueLookupAuditPreview receipt-notification-action-dry-run-result-opaque-lookup-audit production-receipt-notification-action-dry-run-result-opaque-lookup-audit-ready-lookup-disabled production-receipt-notification-action-dry-run-result-opaque-lookup-audit-blocked production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-preview retention-redaction-policy-audit-consumed opaque-lookup-guidance-consumed opaque-lookup-modeled-only five-opaque-lookup-items-present opaque-lookup-items-ready-lookup-disabled lookup-persistence-result-persistence-and-execution-disabled request-creation-dispatch-actions-and-portal-disabled receipt-notification-navigation-and-support-writes-disabled production-and-host-boundary-closed review-receipt-dry-run-result-opaque-lookup renew-receipt-dry-run-result-opaque-lookup open-compatibility-center-dry-run-result-opaque-lookup dismiss-receipt-dry-run-result-opaque-lookup support-info-dry-run-result-opaque-lookup OpaqueLookupAuditRequired OpaqueLookupAuditModeled RetentionRedactionPolicyAuditConsumed OpaqueLookupGuidanceConsumed OpaqueLookupBoundaryReady OwnerManagedOpaqueLookupModeled OpaqueLookupEnabled OpaqueLookupPersisted OpaqueResultIDSupported CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead ResultPersistenceAuthorized RetentionEnforcementEnabled RedactionEnforcementEnabled DispatchDryRunExecuted DryRunResultPersisted ResultVisibilityPersisted RuntimeDiagnosticsPersisted LookupItemCount RequiredLookupItemCount ReadyLookupItemCount MissingLookupItemCount EnabledLookupItemCount PersistedLookupItemCount PathExposedLookupItemCount PersistedResultItemCount ExecutedDryRunItemCount CreatedRequestObjectCount PortalRequestCreatedCount SideEffectLookupItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled DispatchDryRunExecutionEnabled DryRunResultPersistenceEnabled ResultVisibilityPersistenceEnabled RetentionPolicyPersistenceEnabled RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_opaque_lookup_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultOpaqueLookupAuditPreviewModelsLookup TestProductionReceiptNotificationActionDryRunResultOpaqueLookupAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-opaque-lookup-audit-preview production-receipt-notification-action-dry-run-result-opaque-lookup-audit-ready-lookup-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_route_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_route_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupRouteAuthorizationAuditPreview receipt-notification-action-dry-run-result-lookup-route-authorization-audit production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-ready-route-disabled production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-blocked production-receipt-notification-action-dry-run-result-opaque-lookup-audit-preview opaque-lookup-audit-consumed lookup-route-guidance-consumed lookup-route-authorization-modeled-only five-lookup-route-authorization-items-present route-authorization-items-ready-route-disabled route-lookup-persistence-result-persistence-and-execution-disabled request-creation-dispatch-actions-and-portal-disabled receipt-notification-navigation-and-support-writes-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-route-authorization renew-receipt-dry-run-result-lookup-route-authorization open-compatibility-center-dry-run-result-lookup-route-authorization dismiss-receipt-dry-run-result-lookup-route-authorization support-info-dry-run-result-lookup-route-authorization LookupRouteAuthorizationAuditRequired LookupRouteAuthorizationAuditModeled OpaqueLookupAuditConsumed LookupRouteGuidanceConsumed LookupRouteAuthorizationReady OwnerLocalLookupRouteModeled KDEConsumptionAuthorized RuntimeConsumptionAuthorized LookupRouteAuthorized LookupRouteEnabled LookupRoutePersisted OpaqueLookupEnabled OpaqueLookupPersisted OpaqueResultIDSupported CallerStateRootRequired StateRootPathExposed FilePathsExposed FileContentRead ResultPersistenceAuthorized DispatchDryRunExecuted DryRunResultPersisted ResultVisibilityPersisted RuntimeDiagnosticsPersisted RouteItemCount RequiredRouteItemCount ReadyRouteItemCount MissingRouteItemCount AuthorizedRouteItemCount EnabledRouteItemCount PersistedRouteItemCount LookupEnabledItemCount PersistedLookupItemCount PathExposedRouteItemCount PersistedResultItemCount ExecutedDryRunItemCount SideEffectRouteItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled RequestObjectPersistenceEnabled DispatchDryRunExecutionEnabled DryRunResultPersistenceEnabled ResultVisibilityPersistenceEnabled RetentionPolicyPersistenceEnabled RequestObjectsCreated RequestObjectsDispatched PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_route_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupRouteAuthorizationAuditPreviewModelsRoutes TestProductionReceiptNotificationActionDryRunResultLookupRouteAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-ready-route-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_redaction_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_redaction_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerRedactionAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-ready-consumers-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-blocked production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview lookup-route-authorization-audit-consumed consumer-redaction-guidance-consumed consumer-redaction-modeled-only five-consumer-redaction-items-present consumer-redaction-items-ready-consumers-disabled lookup-persistence-result-persistence-and-execution-disabled raw-result-and-path-exposure-disabled request-dispatch-notification-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-redaction renew-receipt-dry-run-result-lookup-consumer-redaction open-compatibility-center-dry-run-result-lookup-consumer-redaction dismiss-receipt-dry-run-result-lookup-consumer-redaction support-info-dry-run-result-lookup-consumer-redaction ConsumerRedactionAuditRequired ConsumerRedactionAuditModeled LookupRouteAuthorizationAuditConsumed ConsumerRedactionGuidanceConsumed ConsumerRedactionReady KDEConsumerRedactionModeled RuntimeConsumerRedactionModeled OpaqueResultIDSupported ConsumerConsumptionAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled LookupRoutePersisted OpaqueLookupEnabled OpaqueLookupPersisted RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted ConsumerItemCount RequiredConsumerItemCount ReadyConsumerItemCount MissingConsumerItemCount RedactedConsumerItemCount EnabledConsumerItemCount RawExposedConsumerItemCount PersistedConsumerItemCount SideEffectConsumerItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_redaction_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerRedactionAuditPreviewModelsConsumers TestProductionReceiptNotificationActionDryRunResultLookupConsumerRedactionAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-ready-consumers-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_gate_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementGateAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-ready-consumers-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-blocked production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview consumer-enablement-gate-audit-required lookup-route-authorization-audit-consumed consumer-redaction-audit-consumed consumer-enablement-guidance-consumed consumer-enablement-gate-modeled-only five-consumer-enablement-gate-items-present lookup-result-persistence-and-execution-disabled request-notification-navigation-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-gate renew-receipt-dry-run-result-lookup-consumer-enablement-gate open-compatibility-center-dry-run-result-lookup-consumer-enablement-gate dismiss-receipt-dry-run-result-lookup-consumer-enablement-gate support-info-dry-run-result-lookup-consumer-enablement-gate ConsumerEnablementGateRequired ConsumerEnablementGateModeled LookupRouteAuthorizationAuditConsumed ConsumerRedactionAuditConsumed ConsumerEnablementGuidanceConsumed ConsumerEnablementGateReady RouteAuthorizationPrerequisiteModeled ConsumerRedactionPrerequisiteModeled OpaqueResultIDSupported ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled LookupRoutePersisted OpaqueLookupEnabled OpaqueLookupPersisted RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted GateItemCount RequiredGateItemCount ReadyGateItemCount MissingGateItemCount AuthorizedGateItemCount EnabledGateItemCount RedactionReadyGateItemCount RouteReadyGateItemCount PersistedGateItemCount RawExposedGateItemCount SideEffectGateItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_gate_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementGateAuditPreviewModelsGate TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementGateAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-ready-consumers-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_authorization_receipt_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_authorization_receipt_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementAuthorizationReceiptAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-ready-receipt-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-preview consumer-enablement-gate-audit-consumed authorization-receipt-guidance-consumed authorization-receipt-boundary-modeled-only five-authorization-receipt-items-present authorization-receipt-items-ready-receipt-disabled receipt-acceptance-consumer-and-lookup-disabled request-notification-navigation-and-support-disabled raw-result-and-path-exposure-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-authorization-receipt renew-receipt-dry-run-result-lookup-consumer-enablement-authorization-receipt open-compatibility-center-dry-run-result-lookup-consumer-enablement-authorization-receipt dismiss-receipt-dry-run-result-lookup-consumer-enablement-authorization-receipt support-info-dry-run-result-lookup-consumer-enablement-authorization-receipt AuthorizationReceiptAuditRequired AuthorizationReceiptAuditModeled ConsumerEnablementGateAuditConsumed AuthorizationReceiptGuidanceConsumed AuthorizationReceiptBoundaryReady ConsumerEnablementGateReady OpaqueAuthorizationReceiptModeled ConsumerAuthorizationReady ReceiptPresent ReceiptAccepted AuthorizationAccepted ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted ReceiptItemCount RequiredReceiptItemCount ReadyReceiptItemCount MissingReceiptItemCount AcceptedReceiptItemCount AuthorizedConsumerItemCount EnabledConsumerItemCount PersistedReceiptItemCount RawExposedReceiptItemCount SideEffectReceiptItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ReceiptWriterEnabled ReceiptPersistenceEnabled ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_authorization_receipt_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementAuthorizationReceiptAuditPreviewModelsReceipt TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementAuthorizationReceiptAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-ready-receipt-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_writer_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_writer_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-writer-authorization-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptWriterAuthorizationAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-writer-authorization-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-writer-authorization-audit-ready-writes-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-writer-authorization-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-preview production-receipt-writer-authorization-review-preview authorization-receipt-audit-consumed base-writer-authorization-review-consumed writer-authorization-guidance-consumed writer-authorization-boundary-modeled-only five-writer-authorization-items-present writer-authorization-items-ready-writes-disabled receipt-writes-persistence-and-replay-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-writer-authorization renew-receipt-dry-run-result-lookup-consumer-enablement-writer-authorization open-compatibility-center-dry-run-result-lookup-consumer-enablement-writer-authorization dismiss-receipt-dry-run-result-lookup-consumer-enablement-writer-authorization support-info-dry-run-result-lookup-consumer-enablement-writer-authorization WriterAuthorizationAuditRequired WriterAuthorizationAuditModeled AuthorizationReceiptAuditConsumed BaseWriterAuthorizationReviewConsumed WriterAuthorizationGuidanceConsumed WriterAuthorizationBoundaryReady AuthorizationReceiptBoundaryReady ConsumerEnablementReceiptWriterReady ReceiptWriterAuthorizationReady ReceiptPresent ReceiptAccepted AuthorizationAccepted ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ReceiptReplayEnabled ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount WriteEnabledAuthorizationItemCount PersistedAuthorizationItemCount AcceptedAuthorizationItemCount EnabledConsumerItemCount RawExposedAuthorizationItemCount SideEffectAuthorizationItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_writer_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptWriterAuthorizationAuditPreviewModelsWriter TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptWriterAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-writer-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-writer-authorization-audit-ready-writes-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_persistence_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_persistence_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-persistence-authorization-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptPersistenceAuthorizationAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-persistence-authorization-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-persistence-authorization-audit-ready-persistence-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-persistence-authorization-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-writer-authorization-audit-preview production-receipt-persistence-threat-review-preview writer-authorization-audit-consumed base-persistence-threat-review-consumed persistence-authorization-guidance-consumed persistence-authorization-boundary-modeled-only five-persistence-authorization-items-present persistence-authorization-items-ready-persistence-disabled receipt-persistence-replay-expiry-revocation-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-persistence-authorization renew-receipt-dry-run-result-lookup-consumer-enablement-persistence-authorization open-compatibility-center-dry-run-result-lookup-consumer-enablement-persistence-authorization dismiss-receipt-dry-run-result-lookup-consumer-enablement-persistence-authorization support-info-dry-run-result-lookup-consumer-enablement-persistence-authorization PersistenceAuthorizationAuditRequired PersistenceAuthorizationAuditModeled WriterAuthorizationAuditConsumed BasePersistenceThreatReviewConsumed PersistenceAuthorizationGuidanceConsumed PersistenceAuthorizationBoundaryReady ReceiptWriterAuthorizationReady ReceiptPersistenceThreatBoundaryReady ConsumerEnablementReceiptPersistenceReady ReceiptPersistenceAuthorizationReady ReceiptPresent ReceiptAccepted AuthorizationAccepted ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ReceiptReplayEnabled ReceiptExpiryWriteEnabled ReceiptRevocationWriteEnabled ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount PersistenceEnabledAuthorizationItemCount ReplayEnabledAuthorizationItemCount ExpiryWriteEnabledAuthorizationItemCount RevocationWriteEnabledAuthorizationItemCount AcceptedAuthorizationItemCount EnabledConsumerItemCount RawExposedAuthorizationItemCount SideEffectAuthorizationItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_persistence_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptPersistenceAuthorizationAuditPreviewModelsPersistence TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptPersistenceAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-persistence-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-persistence-authorization-audit-ready-persistence-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_acceptance_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_acceptance_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-acceptance-authorization-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptAcceptanceAuthorizationAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-acceptance-authorization-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-acceptance-authorization-audit-ready-acceptance-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-acceptance-authorization-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-persistence-authorization-audit-preview production-receipt-acceptance-propagation-preflight-preview persistence-authorization-audit-consumed base-acceptance-propagation-preflight-consumed acceptance-authorization-guidance-consumed acceptance-authorization-boundary-modeled-only five-acceptance-authorization-items-present acceptance-authorization-items-ready-acceptance-disabled receipt-acceptance-and-consumption-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-acceptance-authorization renew-receipt-dry-run-result-lookup-consumer-enablement-acceptance-authorization open-compatibility-center-dry-run-result-lookup-consumer-enablement-acceptance-authorization dismiss-receipt-dry-run-result-lookup-consumer-enablement-acceptance-authorization support-info-dry-run-result-lookup-consumer-enablement-acceptance-authorization AcceptanceAuthorizationAuditRequired AcceptanceAuthorizationAuditModeled PersistenceAuthorizationAuditConsumed BaseAcceptancePropagationPreflightConsumed AcceptanceAuthorizationGuidanceConsumed AcceptanceAuthorizationBoundaryReady ReceiptPersistenceAuthorizationReady ReceiptAcceptancePropagationReady ConsumerEnablementReceiptAcceptanceReady ReceiptAcceptanceAuthorizationReady ReceiptPresent ReceiptPersisted ReceiptAccepted AuthorizationAccepted ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ReceiptReplayEnabled ReceiptExpiryWriteEnabled ReceiptRevocationWriteEnabled ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount AcceptedAuthorizationItemCount PersistedAuthorizationItemCount ConsumerAuthorizedItemCount EnabledConsumerItemCount LookupEnabledAuthorizationItemCount RawExposedAuthorizationItemCount SideEffectAuthorizationItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_acceptance_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptAcceptanceAuthorizationAuditPreviewModelsAcceptance TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptAcceptanceAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-acceptance-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-acceptance-authorization-audit-ready-acceptance-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumption_gate_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumption_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumption-gate-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumptionGateAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumption-gate-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumption-gate-audit-ready-consumption-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumption-gate-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-acceptance-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview acceptance-authorization-audit-consumed consumer-redaction-audit-consumed lookup-route-authorization-audit-consumed consumption-gate-guidance-consumed consumption-gate-modeled-only five-consumption-gate-items-present consumption-gate-items-ready-consumption-disabled receipt-acceptance-and-consumption-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-consumption-gate renew-receipt-dry-run-result-lookup-consumer-enablement-consumption-gate open-compatibility-center-dry-run-result-lookup-consumer-enablement-consumption-gate dismiss-receipt-dry-run-result-lookup-consumer-enablement-consumption-gate support-info-dry-run-result-lookup-consumer-enablement-consumption-gate ConsumptionGateRequired ConsumptionGateModeled AcceptanceAuthorizationAuditConsumed ConsumerRedactionAuditConsumed LookupRouteAuthorizationAuditConsumed ConsumptionGateGuidanceConsumed ConsumptionGateBoundaryReady ReceiptAcceptanceAuthorizationReady ConsumerRedactionBoundaryReady LookupRouteAuthorizationBoundaryReady ConsumerEnablementReceiptConsumptionReady ReceiptConsumptionGateReady ReceiptPresent ReceiptPersisted ReceiptAccepted ReceiptConsumed AuthorizationAccepted ReceiptWriterEnabled ReceiptPersistenceEnabled ReceiptLookupWritesEnabled ReceiptReplayEnabled ReceiptExpiryWriteEnabled ReceiptRevocationWriteEnabled ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted GateItemCount RequiredGateItemCount ReadyGateItemCount MissingGateItemCount AcceptedReceiptItemCount ConsumedReceiptItemCount AuthorizedConsumerItemCount EnabledConsumerItemCount LookupEnabledGateItemCount RawExposedGateItemCount SideEffectGateItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumption_gate_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumptionGateAuditPreviewModelsConsumption TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumptionGateAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumption-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumption-gate-audit-ready-consumption-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumer_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumer_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-authorization-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumerAuthorizationAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-authorization-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-authorization-audit-ready-authorization-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-authorization-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumption-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview consumption-gate-audit-consumed consumer-redaction-audit-consumed lookup-route-authorization-audit-consumed consumer-authorization-guidance-consumed consumer-authorization-boundary-modeled-only five-consumer-authorization-items-present consumer-authorization-items-ready-authorization-disabled receipt-consumption-and-consumer-authorization-disabled consumer-lookup-request-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-consumer-authorization renew-receipt-dry-run-result-lookup-consumer-enablement-consumer-authorization open-compatibility-center-dry-run-result-lookup-consumer-enablement-consumer-authorization dismiss-receipt-dry-run-result-lookup-consumer-enablement-consumer-authorization support-info-dry-run-result-lookup-consumer-enablement-consumer-authorization ConsumerAuthorizationAuditRequired ConsumerAuthorizationAuditModeled ConsumptionGateAuditConsumed ConsumerRedactionAuditConsumed LookupRouteAuthorizationAuditConsumed ConsumerAuthorizationGuidanceConsumed ConsumerAuthorizationBoundaryReady ReceiptConsumptionGateReady ConsumerRedactionBoundaryReady LookupRouteAuthorizationBoundaryReady ConsumerAuthorizationReady ReceiptPresent ReceiptPersisted ReceiptAccepted ReceiptConsumed AuthorizationAccepted ConsumerAuthorizationGranted ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerAuthorized RuntimeConsumerAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount GrantedAuthorizationItemCount AcceptedReceiptItemCount ConsumedReceiptItemCount AuthorizedConsumerItemCount EnabledConsumerItemCount LookupEnabledAuthorizationItemCount RawExposedAuthorizationItemCount SideEffectAuthorizationItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumer_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumerAuthorizationAuditPreviewModelsAuthorization TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumerAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-authorization-audit-ready-authorization-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumer_enablement_gate_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumer_enablement_gate_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumerEnablementGateAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate-audit-ready-consumers-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview consumer-authorization-audit-consumed lookup-route-authorization-audit-consumed consumer-redaction-audit-consumed consumer-enablement-guidance-consumed consumer-enablement-receipt-consumer-enablement-gate-modeled-only five-consumer-enablement-receipt-consumer-enablement-gate-items-present lookup-result-persistence-and-execution-disabled request-notification-navigation-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate renew-receipt-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate open-compatibility-center-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate dismiss-receipt-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate support-info-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate ConsumerEnablementGateRequired ConsumerEnablementGateModeled ConsumerAuthorizationAuditConsumed LookupRouteAuthorizationAuditConsumed ConsumerRedactionAuditConsumed ConsumerEnablementGuidanceConsumed ConsumerEnablementGateReady ConsumerAuthorizationPrerequisiteModeled RouteAuthorizationPrerequisiteModeled ConsumerRedactionPrerequisiteModeled OpaqueResultIDSupported ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteAuthorized LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted RawResultExposed RuntimeDiagnosticsPersisted DryRunResultPersisted DispatchDryRunExecuted GateItemCount RequiredGateItemCount ReadyGateItemCount MissingGateItemCount AuthorizedGateItemCount EnabledGateItemCount PersistedGateItemCount RawExposedGateItemCount SideEffectGateItemCount RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened ProductionReadiness ProductionOwnershipReady SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled DesktopFilesWritten SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_receipt_consumer_enablement_gate_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumerEnablementGateAuditPreviewModelsGate TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementReceiptConsumerEnablementGateAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate-audit-ready-consumers-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_status_fanout_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_status_fanout_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-fanout-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeStatusFanOutAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-fanout-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-fanout-audit-ready-status-only-consumers-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-fanout-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-receipt-consumer-enablement-gate-audit-preview kde-safe-status-fanout-audit-required consumer-enablement-gate-audit-consumed kde-safe-status-guidance-consumed compatibility-center-status-modeled runtime-diagnostics-status-modeled ten-kde-safe-status-fanout-items-present status-fanout-modeled-only consumer-lookup-and-persistence-disabled request-notification-navigation-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-fanout review-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-fanout renew-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-fanout renew-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-fanout open-compatibility-center-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-fanout open-compatibility-center-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-fanout dismiss-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-fanout dismiss-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-fanout support-info-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-fanout support-info-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-fanout StatusFanOutAuditRequired StatusFanOutModeled ConsumerEnablementGateAuditConsumed KDESafeStatusGuidanceConsumed CompatibilityCenterStatusModeled RuntimeDiagnosticsStatusModeled StatusFanOutReady ConsumerEnablementGateClosed OpaqueResultIDSupported StatusItemCount RequiredStatusItemCount ReadyStatusItemCount MissingStatusItemCount CompatibilityCenterStatusItemCount RuntimeDiagnosticsStatusItemCount ConsumerEnabledStatusItemCount PersistedStatusItemCount RawExposedStatusItemCount SideEffectStatusItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_status_fanout_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeStatusFanOutAuditPreviewModelsStatusFanOut TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeStatusFanOutAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-fanout-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-fanout-audit-ready-status-only-consumers-disabled],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_status_persistence_authorization_audit.go" => %w[xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_status_persistence_authorization_audit.v1 production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-persistence-authorization-audit-preview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeStatusPersistenceAuthorizationAuditPreview receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-persistence-authorization-audit production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-persistence-authorization-audit-ready-persistence-disabled production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-persistence-authorization-audit-blocked production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-fanout-audit-preview kde-safe-status-persistence-authorization-audit-required status-fanout-audit-consumed kde-safe-status-persistence-guidance-consumed compatibility-center-persistence-authorization-modeled runtime-diagnostics-persistence-authorization-modeled ten-kde-safe-status-persistence-authorization-items-present persistence-authorization-boundary-modeled-only persistence-writes-consumers-and-lookup-disabled request-notification-navigation-and-support-disabled production-and-host-boundary-closed review-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-persistence-authorization review-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-persistence-authorization renew-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-persistence-authorization renew-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-persistence-authorization open-compatibility-center-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-persistence-authorization open-compatibility-center-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-persistence-authorization dismiss-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-persistence-authorization dismiss-receipt-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-persistence-authorization support-info-dry-run-result-lookup-consumer-enablement-kde-safe-compatibility-center-status-persistence-authorization support-info-dry-run-result-lookup-consumer-enablement-kde-safe-runtime-diagnostics-status-persistence-authorization PersistenceAuthorizationAuditRequired PersistenceAuthorizationModeled StatusFanOutAuditConsumed KDESafeStatusPersistenceGuidanceConsumed CompatibilityCenterPersistenceAuthorizationModeled RuntimeDiagnosticsPersistenceAuthorizationModeled PersistenceAuthorizationBoundaryReady StatusFanOutReady ConsumerEnablementGateClosed KDESafeStatusOnly OpaqueResultIDSupported StatusPersistenceAuthorized KDEStatusPersistenceAuthorized RuntimeDiagnosticsPersistenceAuthorized AuthorizationItemCount RequiredAuthorizationItemCount ReadyAuthorizationItemCount MissingAuthorizationItemCount CompatibilityCenterAuthorizationItemCount RuntimeDiagnosticsAuthorizationItemCount AuthorizedPersistenceItemCount PersistedStatusItemCount ConsumerEnabledAuthorizationItemCount RawExposedAuthorizationItemCount SideEffectAuthorizationItemCount ConsumerConsumptionAuthorized ConsumerEnablementAuthorized KDEConsumerEnabled RuntimeConsumerEnabled LookupRouteEnabled OpaqueLookupEnabled RedactedSummaryPersisted KDEStatusPersisted RuntimeDiagnosticsPersisted DryRunResultPersisted RawResultExposed DispatchDryRunExecuted RequestObjectCreationEnabled RequestObjectDispatchEnabled PortalRequestCreated NotificationActionEnabled CompatibilityCenterOpened SystemServiceStarted ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled SupportBundleExported SnapshotRestoreExecuted StateCleanupExecuted HostRootModified],
      "internal/runtime/owner/production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_status_persistence_authorization_audit_test.go" => %w[TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeStatusPersistenceAuthorizationAuditPreviewModelsAuthorization TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementKDESafeStatusPersistenceAuthorizationAuditPreviewFailsClosedWithoutSources production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-persistence-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-status-persistence-authorization-audit-ready-persistence-disabled],
      "internal/runtime/owner/production_dbus_method_review.go" => %w[xnix.runtime.production_dbus_method_review.v1 production-dbus-method-review-preview NewProductionDBusMethodReviewPreview route-by-route-production-dbus-method-review runtime-method-parity-manifest-preview runtime-owner-route-manifest-preview production-dbus-gate-review-preview runtime-write-gate-preview production-dbus-method-review-ready-production-exposure-disabled dbus-read-only-contract owner-local-candidate reserved-write-method reviewed-read-only-contract-production-owner-disabled owner-local-only-no-production-dbus-method write-method-disabled-no-production-dispatch read-only-contract-methods-reviewed owner-local-candidates-reviewed write-methods-reviewed-disabled no-new-production-methods-requested production-exposure-disabled route-manifest-consumed unsafe-gates-closed ReadOnlyContractMethodCount OwnerLocalCandidateCount WriteMethodCount ReviewedMethodCount ProductionExposureReadyCount NewProductionMethodRequestCount ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled BackendLaunchEnabled HostRootModified],
      "internal/runtime/owner/production_dbus_method_review_test.go" => %w[TestProductionDBusMethodReviewPreviewInventoriesRoutes TestProductionDBusMethodReviewPreviewFailsClosedWithoutSources production-dbus-method-review-preview production-dbus-method-review-ready-production-exposure-disabled],
      "internal/runtime/owner/production_desktop_side_effect_review.go" => %w[xnix.runtime.production_desktop_side_effect_review.v1 production-desktop-side-effect-review-preview NewProductionDesktopSideEffectReviewPreview kde-production-desktop-side-effect-review production-desktop-side-effect-review-ready-side-effects-disabled production-desktop-side-effect-review-blocked production-dbus-gate-review-preview production-rollback-diagnostics-review-preview kde-entrypoints-preview kde-action-queue-preview desktop-activation-manifest-preview kde-shell-integration-preview kde-application-surface-preview production-gate-consumed rollback-diagnostics-consumed seven-kde-surfaces-reviewed runtime-policy-owner desktop-writes-disabled live-shell-activation-disabled notifications-and-requests-disabled host-boundary-closed SurfaceCount RequiredSurfaceCount ReviewedSurfaceCount ActiveSurfaceCount SideEffectSurfaceCount ProductionOwnershipReady DesktopFilesWritten MIMEAppsWritten ShellConfigurationWritten SettingsPersisted KRunnerIndexPersisted TaskManagerEntryActive KWinRuleApplied LiveTrayBridgeEnabled NotificationSent NotificationDeliveryEnabled CompatibilityCenterPersisted PortalRequestCreated RequestObjectsCreated HostRootModified],
      "internal/runtime/owner/production_desktop_side_effect_review_test.go" => %w[TestProductionDesktopSideEffectReviewPreviewInventoriesKDESurfaces TestProductionDesktopSideEffectReviewPreviewFailsClosedWithoutSources production-desktop-side-effect-review-preview production-desktop-side-effect-review-ready-side-effects-disabled],
      "internal/runtime/owner/production_rollback_diagnostics_review.go" => %w[xnix.runtime.production_rollback_diagnostics_review.v1 production-rollback-diagnostics-review-preview NewProductionRollbackDiagnosticsReviewPreview production-dbus-rollback-diagnostics-review production-rollback-diagnostics-review-ready-side-effects-disabled production-rollback-diagnostics-review-blocked production-dbus-gate-review-preview production-dbus-method-review-preview runtime-service-activation-preflight-preview support-bundle-manifest-preview support-case-timeline-preview snapshot-restore-candidates-preview state-root-quota-retention-preview production-gate-consumed method-review-consumed rollback-controls-reviewed diagnostics-controls-reviewed support-side-effects-disabled restore-and-cleanup-disabled unsafe-data-hidden host-boundary-closed ReviewItemCount RollbackControlCount DiagnosticsControlCount ReadyControlCount SideEffectControlCount ProductionOwnershipReady SupportBundleExported SupportCaseCreated NotificationSent SnapshotRestoreExecuted StateCleanupExecuted FileContentRead FilePathsExposed HostRootModified],
      "internal/runtime/owner/production_rollback_diagnostics_review_test.go" => %w[TestProductionRollbackDiagnosticsReviewPreviewConsumesSafetySurfaces TestProductionRollbackDiagnosticsReviewPreviewFailsClosedWithoutSources production-rollback-diagnostics-review-preview production-rollback-diagnostics-review-ready-side-effects-disabled],
      ...
      "cmd/xnix-runtime-go/production_dbus_gate_commands.go" => %w[production-dbus-gate-review-preview runProductionDBusGateReviewPreview NewProductionDBusGateReviewPreview production-dbus-human-authorization-preflight-preview runProductionDBusHumanAuthorizationPreflightPreview NewProductionDBusHumanAuthorizationPreflightPreview production-human-authorization-receipt-consolidation-preview runProductionHumanAuthorizationReceiptConsolidationPreview NewProductionHumanAuthorizationReceiptConsolidationPreview production-authorization-consumption-audit-preview runProductionAuthorizationConsumptionAuditPreview NewProductionAuthorizationConsumptionAuditPreview production-receipt-acceptance-propagation-preflight-preview runProductionReceiptAcceptancePropagationPreflightPreview NewProductionReceiptAcceptancePropagationPreflightPreview production-receipt-writer-authorization-review-preview runProductionReceiptWriterAuthorizationReviewPreview NewProductionReceiptWriterAuthorizationReviewPreview production-receipt-persistence-threat-review-preview runProductionReceiptPersistenceThreatReviewPreview NewProductionReceiptPersistenceThreatReviewPreview production-receipt-revocation-visibility-audit-preview runProductionReceiptRevocationVisibilityAuditPreview NewProductionReceiptRevocationVisibilityAuditPreview production-receipt-notification-delivery-gate-audit-preview runProductionReceiptNotificationDeliveryGateAuditPreview NewProductionReceiptNotificationDeliveryGateAuditPreview production-receipt-notification-action-safety-audit-preview runProductionReceiptNotificationActionSafetyAuditPreview NewProductionReceiptNotificationActionSafetyAuditPreview production-receipt-notification-action-request-object-audit-preview runProductionReceiptNotificationActionRequestObjectAuditPreview NewProductionReceiptNotificationActionRequestObjectAuditPreview production-receipt-notification-action-dispatch-authorization-audit-preview runProductionReceiptNotificationActionDispatchAuthorizationAuditPreview NewProductionReceiptNotificationActionDispatchAuthorizationAuditPreview production-receipt-notification-action-dispatch-dry-run-audit-preview runProductionReceiptNotificationActionDispatchDryRunAuditPreview NewProductionReceiptNotificationActionDispatchDryRunAuditPreview production-receipt-notification-action-dry-run-result-visibility-audit-preview runProductionReceiptNotificationActionDryRunResultVisibilityAuditPreview NewProductionReceiptNotificationActionDryRunResultVisibilityAuditPreview production-receipt-notification-action-dry-run-result-persistence-authorization-audit-preview runProductionReceiptNotificationActionDryRunResultPersistenceAuthorizationAuditPreview NewProductionReceiptNotificationActionDryRunResultPersistenceAuthorizationAuditPreview production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-preview runProductionReceiptNotificationActionDryRunResultRetentionRedactionPolicyAuditPreview NewProductionReceiptNotificationActionDryRunResultRetentionRedactionPolicyAuditPreview production-receipt-notification-action-dry-run-result-opaque-lookup-audit-preview runProductionReceiptNotificationActionDryRunResultOpaqueLookupAuditPreview NewProductionReceiptNotificationActionDryRunResultOpaqueLookupAuditPreview production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview runProductionReceiptNotificationActionDryRunResultLookupRouteAuthorizationAuditPreview NewProductionReceiptNotificationActionDryRunResultLookupRouteAuthorizationAuditPreview production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview runProductionReceiptNotificationActionDryRunResultLookupConsumerRedactionAuditPreview NewProductionReceiptNotificationActionDryRunResultLookupConsumerRedactionAuditPreview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-preview runProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementGateAuditPreview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementGateAuditPreview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-preview runProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementAuthorizationReceiptAuditPreview NewProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementAuthorizationReceiptAuditPreview production-dbus-method-review-preview runProductionDBusMethodReviewPreview NewProductionDBusMethodReviewPreview production-rollback-diagnostics-review-preview runProductionRollbackDiagnosticsReviewPreview NewProductionRollbackDiagnosticsReviewPreview production-desktop-side-effect-review-preview runProductionDesktopSideEffectReviewPreview NewProductionDesktopSideEffectReviewPreview],
      "cmd/xnix-runtime-go/production_dbus_gate_cli_test.go" => %w[TestProductionDBusGateReviewPreviewCommand TestProductionDBusHumanAuthorizationPreflightPreviewCommand TestProductionHumanAuthorizationReceiptConsolidationPreviewCommand TestProductionAuthorizationConsumptionAuditPreviewCommand TestProductionReceiptAcceptancePropagationPreflightPreviewCommand TestProductionReceiptWriterAuthorizationReviewPreviewCommand TestProductionReceiptPersistenceThreatReviewPreviewCommand TestProductionReceiptRevocationVisibilityAuditPreviewCommand TestProductionReceiptNotificationDeliveryGateAuditPreviewCommand TestProductionReceiptNotificationActionSafetyAuditPreviewCommand TestProductionReceiptNotificationActionRequestObjectAuditPreviewCommand TestProductionReceiptNotificationActionDispatchAuthorizationAuditPreviewCommand TestProductionReceiptNotificationActionDispatchDryRunAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultVisibilityAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultPersistenceAuthorizationAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultRetentionRedactionPolicyAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultOpaqueLookupAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultLookupRouteAuthorizationAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultLookupConsumerRedactionAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementGateAuditPreviewCommand TestProductionReceiptNotificationActionDryRunResultLookupConsumerEnablementAuthorizationReceiptAuditPreviewCommand TestProductionDBusMethodReviewPreviewCommand TestProductionRollbackDiagnosticsReviewPreviewCommand TestProductionDesktopSideEffectReviewPreviewCommand production-dbus-gate-review-preview production-dbus-human-authorization-preflight-preview production-human-authorization-receipt-consolidation-preview production-authorization-consumption-audit-preview production-receipt-acceptance-propagation-preflight-preview production-receipt-writer-authorization-review-preview production-receipt-persistence-threat-review-preview production-receipt-revocation-visibility-audit-preview production-receipt-notification-delivery-gate-audit-preview production-receipt-notification-action-safety-audit-preview production-receipt-notification-action-request-object-audit-preview production-receipt-notification-action-dispatch-authorization-audit-preview production-receipt-notification-action-dispatch-dry-run-audit-preview production-receipt-notification-action-dry-run-result-visibility-audit-preview production-receipt-notification-action-dry-run-result-persistence-authorization-audit-preview production-receipt-notification-action-dry-run-result-retention-redaction-policy-audit-preview production-receipt-notification-action-dry-run-result-opaque-lookup-audit-preview production-receipt-notification-action-dry-run-result-lookup-route-authorization-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-redaction-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-gate-audit-preview production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-authorization-receipt-audit-preview production-dbus-method-review-preview production-rollback-diagnostics-review-preview production-desktop-side-effect-review-preview smoke_covered_route_count production_readiness human_authorization_required human_authorization_preflight_ready authorization_receipt_present authorization_accepted receipt_boundary_consolidated owner_managed_opaque_receipt_lookup_ready owner_managed_opaque_boundary_ready receipt_writer_enabled consumed_gate_count missing_gate_count consumed_consumer_count missing_consumer_count side_effect_consumer_count future_acceptance_modeled acceptance_simulation_only consumption_audit_consumed propagation_preflight_ready propagation_ready_target_count missing_target_count acceptance_enabled_target_count writer_authorization_required writer_authorization_modeled acceptance_propagation_consumed writer_review_ready ready_review_item_count write_enabled_review_item_count receipt_replay_enabled persistence_threat_review_required persistence_threat_review_modeled writer_authorization_review_consumed persistence_threat_review_ready ready_threat_item_count persistence_enabled_threat_count receipt_expiry_write_enabled receipt_revocation_write_enabled visibility_audit_required visibility_audit_modeled persistence_threat_review_consumed desktop_side_effect_review_consumed revocation_visibility_ready ready_visibility_item_count revocation_write_enabled_item_count expiry_write_enabled_item_count notification_enabled_item_count notification_gate_required notification_gate_modeled revocation_visibility_audit_consumed notification_delivery_gate_ready ready_gate_item_count delivery_enabled_item_count notification_sent_item_count request_created_item_count action_safety_audit_required action_safety_audit_modeled notification_delivery_gate_consumed notification_action_safety_ready ready_action_item_count enabled_action_item_count navigation_enabled_item_count review_action_enabled renew_action_enabled open_compatibility_center_enabled request_object_audit_required request_object_audit_modeled action_safety_audit_consumed dispatch_request_boundary_consumed request_object_boundary_ready ready_request_object_count created_request_object_count dispatched_request_object_count portal_request_created_count navigation_requested_count request_object_creation_enabled request_object_dispatch_enabled dispatch_authorization_audit_required dispatch_authorization_audit_modeled request_object_audit_consumed receipt_authorization_boundary_consumed dispatch_authorization_ready dispatch_authorization_granted ready_authorization_item_count granted_authorization_item_count dispatched_authorization_item_count dispatch_authorization_persisted dispatch_dry_run_audit_required dispatch_dry_run_audit_modeled dispatch_authorization_audit_consumed dispatch_dry_run_guidance_consumed dispatch_dry_run_plan_ready dispatch_dry_run_executed ready_dry_run_item_count executed_dry_run_item_count dispatched_dry_run_item_count dispatch_dry_run_execution_enabled dry_run_result_persisted result_visibility_audit_required result_visibility_audit_modeled dispatch_dry_run_audit_consumed result_visibility_guidance_consumed result_visibility_plan_ready redacted_kde_visibility_modeled runtime_diagnostics_visibility_modeled ready_visibility_item_count persisted_visibility_item_count dry_run_result_persistence_enabled result_visibility_persistence_enabled runtime_diagnostics_persisted persistence_authorization_audit_required persistence_authorization_audit_modeled result_visibility_audit_consumed persistence_authorization_guidance_consumed persistence_authorization_ready result_persistence_authorized result_visibility_persisted ready_authorization_item_count granted_persistence_item_count persisted_result_item_count retention_redaction_policy_audit_required retention_redaction_policy_audit_modeled persistence_authorization_audit_consumed retention_redaction_guidance_consumed retention_redaction_policy_ready retention_window_modeled redaction_rules_modeled ready_policy_item_count retention_enabled_item_count redaction_write_item_count retention_policy_persistence_enabled opaque_lookup_audit_required opaque_lookup_audit_modeled retention_redaction_policy_audit_consumed opaque_lookup_guidance_consumed opaque_lookup_boundary_ready owner_managed_opaque_lookup_modeled opaque_lookup_enabled opaque_lookup_persisted ready_lookup_item_count enabled_lookup_item_count path_exposed_lookup_item_count state_root_path_exposed file_paths_exposed file_content_read lookup_route_authorization_audit_required lookup_route_authorization_audit_modeled opaque_lookup_audit_consumed lookup_route_guidance_consumed lookup_route_authorization_ready owner_local_lookup_route_modeled lookup_route_authorized lookup_route_enabled lookup_route_persisted ready_route_item_count authorized_route_item_count enabled_route_item_count path_exposed_route_item_count consumer_redaction_audit_required consumer_redaction_audit_modeled lookup_route_authorization_audit_consumed consumer_redaction_guidance_consumed consumer_redaction_ready kde_consumer_redaction_modeled runtime_consumer_redaction_modeled consumer_consumption_authorized kde_consumer_enabled runtime_consumer_enabled redacted_summary_persisted raw_result_exposed consumer_item_count ready_consumer_item_count redacted_consumer_item_count enabled_consumer_item_count raw_exposed_consumer_item_count consumer_enablement_gate_required consumer_enablement_gate_modeled consumer_redaction_audit_consumed consumer_enablement_guidance_consumed consumer_enablement_gate_ready route_authorization_prerequisite_modeled consumer_redaction_prerequisite_modeled consumer_enablement_authorized gate_item_count ready_gate_item_count authorized_gate_item_count enabled_gate_item_count raw_exposed_gate_item_count authorization_receipt_audit_required authorization_receipt_audit_modeled consumer_enablement_gate_audit_consumed authorization_receipt_guidance_consumed authorization_receipt_boundary_ready opaque_authorization_receipt_modeled consumer_authorization_ready receipt_present receipt_accepted authorization_accepted receipt_item_count ready_receipt_item_count accepted_receipt_item_count authorized_consumer_item_count enabled_consumer_item_count raw_exposed_receipt_item_count read_only_contract_method_count owner_local_candidate_count write_method_count production_exposure_ready_count production_owner_enabled production_activation_ready rollback_control_count diagnostics_control_count side_effect_control_count production_ownership_ready snapshot_restore_executed state_cleanup_executed surface_count reviewed_surface_count active_surface_count desktop_files_written settings_persisted notification_sent],
      ...
      "internal/runtime/appidentity/runtime_service_activation_preflight.go" => %w[xnix.runtime.service_activation_preflight.v1 runtime-service-activation-preflight-preview GetRuntimeServiceActivationPreflight production-runtime-service-activation-preflight production-dbus-gate-review-preview production-dbus-human-authorization-preflight-preview production-dbus-gate-review-consumed-activation-still-blocked production-dbus-gate-review human-authorization-preflight human-authorization-receipt restricted-owner-smoke-ready RuntimeServiceActivationProductionDBusGate ProductionActivationReady RestrictedSmokeReady ProductionDBusGateReady HumanAuthorizationPreflightReady HumanAuthorizationRequired HumanAuthorizationGranted AuthorizationReceiptAccepted SystemServiceStarted SessionBusClaimed ProductionBusClaimed WriteMethodsEnabled RuntimeWritesEnabled BackendLaunchEnabled HostRootModified]
    },
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/runtime_write_gate.go" => %w[xnix.runtime.write_gate.v1 runtime-write-gate-preview go-runtime-write-gate runtime-service-activation-preflight-preview production-dbus-gate-review-preview production-dbus-human-authorization-preflight-preview RuntimeWriteGateProductionGate production-dbus-gate-review production-service-activation-preflight human-authorization-receipt production-gates-consumed-write-gate-disabled production-gate-consumption-blocked ProductionGateDecision ServiceActivationPreflightReady ProductionDBusGateReady HumanAuthorizationPreflightReady HumanAuthorizationRequired HumanAuthorizationGranted AuthorizationReceiptAccepted WriteMethodEnabled DispatchEnabled RequestObjectCreated ExecutionStarted BackendLaunchEnabled HostRootModified Launch WriteMethodDisabled]
    },
