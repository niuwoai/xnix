...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/owner/production_dbus_gate_review.go" => %w[xnix.runtime.production_dbus_gate_review.v1 production-dbus-gate-review-preview NewProductionDBusGateReviewPreview owner-local-smoke-covered-production-dbus-gate-review production-dbus-gate-review-ready materialization-fanout-owner-route restricted-smoke-fanout-owner-route redacted-adapter-profile-owner-route smoke-coverage-present production-dbus-disabled human-authorization-required ProductionReadiness HumanAuthorizationRequired ProductionOwnerEnabled ProductionActivationReady WriteMethodsEnabled RuntimeWritesEnabled BackendLaunchEnabled HostRootModified],
      "internal/runtime/owner/production_dbus_gate_review_test.go" => %w[TestProductionDBusGateReviewPreviewInventoriesSmokeCoveredRoutes TestProductionDBusGateReviewPreviewFailsClosedWithoutSources production-dbus-gate-review-ready human-authorization-required],
      ...
      "cmd/xnix-runtime-go/production_dbus_gate_commands.go" => %w[production-dbus-gate-review-preview runProductionDBusGateReviewPreview NewProductionDBusGateReviewPreview],
      "cmd/xnix-runtime-go/production_dbus_gate_cli_test.go" => %w[TestProductionDBusGateReviewPreviewCommand production-dbus-gate-review-preview smoke_covered_route_count production_readiness human_authorization_required production_owner_enabled production_activation_ready],
