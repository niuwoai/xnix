...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      "cmd/xnix-runtime-owner/main.go" => %w[smoke-owner deny-write materialization-fanout-owner-smoke-coverage NewKDETestLaunchMaterializationFanOutOwnerSmokeCoveragePreview],
