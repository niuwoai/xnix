...
DOMAIN_DEFINITIONS = [
  {
    ...
    summary: "The Go owner candidate has full D-Bus read dispatch coverage, lifecycle JSONL, smoke-batch read/write evidence, and C D-Bus bridge evidence for owner self-description, KDE shell, desktop activation payloads, seven-entry-point payloads, and second-ring KDE resource payloads; production ownership remains gated."
  },
  {
