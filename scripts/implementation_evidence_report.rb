...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "runtime/dbus/xnix_compatd_smoke.c" => %w[go_owner_read_dispatch add_go_owner_dispatch_bridge_fields go_owner_write_gate_dispatch go_owner_dispatch_available go_owner_dispatch_json go-runtime-owner-dispatch+c-smoke-bridge],
    ...
    summary: "The Go owner candidate has full D-Bus read dispatch coverage, lifecycle JSONL, smoke-batch read/write evidence, and C D-Bus bridge evidence for owner self-description payloads; production ownership remains gated."
  },
  {
