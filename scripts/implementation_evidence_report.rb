...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/owner/restricted_smoke_receipt_fanout_owner_route_audit.go" => %w[xnix.runtime.restricted_owner_smoke_receipt_fanout_owner_route_audit.v1 restricted-owner-smoke-receipt-fanout-owner-route-audit-preview NewRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditPreview GetRestrictedOwnerSmokeReceiptFanOutOwnerRouteAudit lookup-ready-fanout-cli-only owner-managed-lookup-ready-fanout-cli-only caller-state-root-boundary owner-managed-receipt-lookup route-decision ConsumesExistingReceipt RequiresCallerStateRoot ReceiptLookupOwnerManaged OpaqueReceiptIDSupported FanOutWritesEnabled StateRootWritesEnabled BackendLaunchEnabled HostRootModified],
      "internal/runtime/owner/restricted_smoke_receipt_fanout_owner_route_audit_test.go" => %w[TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditRecognizesOpaqueLookup TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditFailsClosedWithoutSources lookup-ready-fanout-cli-only caller-state-root-boundary owner-managed-receipt-lookup],
      "cmd/xnix-runtime-go/restricted_owner_smoke_receipt_commands.go" => %w[restricted-owner-smoke-receipt-record runRestrictedOwnerSmokeReceiptRecord authorize-restricted-owner-smoke restricted-owner-smoke-receipt-lookup-preview runRestrictedOwnerSmokeReceiptLookupPreview restricted-owner-smoke-receipt-fanout-owner-route-audit-preview runRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditPreview],
      "cmd/xnix-runtime-go/restricted_owner_smoke_receipt_cli_test.go" => %w[TestRestrictedOwnerSmokeReceiptRecordCommandPersistsReceipt TestRestrictedOwnerSmokeReceiptRecordCommandRequiresAuthorization TestRestrictedOwnerSmokeReceiptFanOutPreviewCommandCoversReadinessAndSupportSurfaces TestRestrictedOwnerSmokeReceiptLookupPreviewCommand TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditPreviewCommand xnix.runtime.restricted_owner_smoke_receipt.v1 xnix.runtime.restricted_owner_smoke_receipt_fanout.v1 xnix.runtime.restricted_owner_smoke_receipt_lookup.v1 xnix.runtime.restricted_owner_smoke_receipt_fanout_owner_route_audit.v1],
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/backend_adapter_contract_owner_route_audit.go" => %w[xnix.runtime.backend_adapter_contract_owner_route_audit.v1 backend-adapter-contract-owner-route-audit-preview NewBackendAdapterContractOwnerRouteAuditPreview GetBackendAdapterContractOwnerRouteAudit redacted-profile-route-ready redacted-profile-route-ready-full-contract-fixture-local owner-route-absent production-dbus-absent redacted-route-missing internal-detail-boundary route-decision FixtureMatrixConsumesContract OwnerDispatchRoutePresent ProductionDBusMethodPresent FullContractContainsAdapterIDs RedactedProfileRoutePresent BackendLaunchEnabled HostRootModified],
      "internal/runtime/appidentity/backend_adapter_contract_owner_route_audit_test.go" => %w[TestBackendAdapterContractOwnerRouteAuditKeepsContractFixtureLocal TestBackendAdapterContractOwnerRouteAuditFailsClosedWithoutSources redacted-profile-route-ready redacted-route-missing internal-detail-boundary],
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/kde_test_launch_materialization_owner_route_audit.go" => %w[xnix.runtime.kde_test_launch_materialization_owner_route_audit.v1 kde-test-launch-materialization-owner-route-audit-preview NewKDETestLaunchMaterializationOwnerRouteAuditPreview GetKDETestLaunchMaterializationOwnerRouteAudit consume-ready-opaque-lookup-missing read-only-consume-ready-owner-route-blocked owner-route-absent production-dbus-absent read-only-consume-registered caller-path-boundary receipt-creation-split owner-managed-opaque-lookup route-decision OwnerDispatchRoutePresent ProductionDBusMethodPresent MaterializationWritesStateRoot ReadOnlyReceiptConsumptionReady OwnerManagedOpaqueReceiptLookupReady OpaqueMaterializationReceiptIDSupported OwnerLocalRouteCandidateReady ProductionDBusExposureReady BackendLaunchEnabled HostRootModified],
      "internal/runtime/appidentity/kde_test_launch_materialization_owner_route_audit_test.go" => %w[TestKDETestLaunchMaterializationOwnerRouteAuditSeesConsumeSplit TestKDETestLaunchMaterializationOwnerRouteAuditFailsClosedWithoutSources consume-ready-opaque-lookup-missing caller-path-boundary owner-managed-opaque-lookup],
      ...
      "cmd/xnix-runtime-go/kde_test_launch_materialization_fanout_commands.go" => %w[kde-test-launch-materialization-fanout-preview kde-test-launch-materialization-fanout-consume-preview runKDETestLaunchMaterializationFanOutPreview runKDETestLaunchMaterializationFanOutConsumePreview authorize-restricted-test-preparation test-only materialization-plan-id],
      "cmd/xnix-runtime-go/kde_test_launch_materialization_fanout_cli_test.go" => %w[TestKDETestLaunchMaterializationFanOutPreviewCommandCoversKDESurfaces TestKDETestLaunchMaterializationFanOutConsumePreviewCommandReadsExistingReceipt TestKDETestLaunchMaterializationFanOutConsumePreviewCommandRequiresExistingReceipt TestKDETestLaunchMaterializationFanOutPreviewCommandRequiresAuthorization materialization_receipt_consumed execution_session_fan_out_consumed notification_sent fan_out_writes_enabled state_root_writes_enabled read-only-existing-materialization-receipt],
