...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "cmd/xnix-runtime-go/production_dbus_gate_commands.go" => %w[production-dbus-gate-review-preview runProductionDBusGateReviewPreview NewProductionDBusGateReviewPreview production-dbus-human-authorization-preflight-preview runProductionDBusHumanAuthorizationPreflightPreview NewProductionDBusHumanAuthorizationPreflightPreview],
      "cmd/xnix-runtime-go/production_dbus_gate_cli_test.go" => %w[TestProductionDBusGateReviewPreviewCommand TestProductionDBusHumanAuthorizationPreflightPreviewCommand production-dbus-gate-review-preview production-dbus-human-authorization-preflight-preview smoke_covered_route_count production_readiness human_authorization_required human_authorization_preflight_ready authorization_receipt_present authorization_accepted production_owner_enabled production_activation_ready],
