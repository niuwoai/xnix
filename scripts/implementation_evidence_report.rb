...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "cmd/xnix-runtime-go/restricted_owner_smoke_receipt_cli_test.go" => %w[TestRestrictedOwnerSmokeReceiptRecordCommandPersistsReceipt TestRestrictedOwnerSmokeReceiptRecordCommandRequiresAuthorization xnix.runtime.restricted_owner_smoke_receipt.v1],
