...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/owner/restricted_smoke_receipt_fanout_owner_route_audit.go" => %w[xnix.runtime.restricted_owner_smoke_receipt_fanout_owner_route_audit.v1 restricted-owner-smoke-receipt-fanout-owner-route-audit-preview NewRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditPreview GetRestrictedOwnerSmokeReceiptFanOutOwnerRouteAudit owner-local-route-ready owner-local-read-route-ready-production-dbus-blocked owner-route-present caller-state-root-boundary owner-managed-receipt-lookup route-decision ConsumesExistingReceipt RequiresCallerStateRoot ReceiptLookupOwnerManaged OpaqueReceiptIDSupported OwnerDispatchRoutePresent FanOutWritesEnabled StateRootWritesEnabled BackendLaunchEnabled HostRootModified],
      "internal/runtime/owner/restricted_smoke_receipt_fanout_owner_route_audit_test.go" => %w[TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditRecognizesOpaqueLookup TestRestrictedOwnerSmokeReceiptFanOutOwnerRouteAuditFailsClosedWithoutSources owner-local-route-ready caller-state-root-boundary owner-managed-receipt-lookup],
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/kde_test_launch_materialization_owner_route_audit.go" => %w[xnix.runtime.kde_test_launch_materialization_owner_route_audit.v1 kde-test-launch-materialization-owner-route-audit-preview NewKDETestLaunchMaterializationOwnerRouteAuditPreview GetKDETestLaunchMaterializationOwnerRouteAudit opaque-lookup-ready-owner-route-blocked owner-managed-lookup-ready-fanout-cli-only materialization-fanout-owner-local-read-route owner-route-absent production-dbus-absent read-only-consume-registered caller-path-boundary receipt-creation-split owner-managed-opaque-lookup route-decision OwnerDispatchRoutePresent ProductionDBusMethodPresent MaterializationWritesStateRoot ReadOnlyReceiptConsumptionReady OwnerManagedOpaqueReceiptLookupReady OpaqueMaterializationReceiptIDSupported OwnerLocalRouteCandidateReady ProductionDBusExposureReady BackendLaunchEnabled HostRootModified],
      "internal/runtime/appidentity/kde_test_launch_materialization_owner_route_audit_test.go" => %w[TestKDETestLaunchMaterializationOwnerRouteAuditSeesConsumeSplit TestKDETestLaunchMaterializationOwnerRouteAuditFailsClosedWithoutSources opaque-lookup-ready-owner-route-blocked materialization-owner-route-sources-missing caller-path-boundary owner-managed-opaque-lookup],
