...
DOMAIN_DEFINITIONS = [
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/identity.go" => %w[DesktopIconOptions KRunnerQueryOptions ActivationReceiptBacked ReceiptBackedMatchCount FileOpenOptions TrayStatusOptions NotificationOptions SettingsOptions ActivationReceiptRoot],
    ...
    summary: "KDE activation can stage desktop files, MIME data, service menus, manifests, and receipts under explicit roots, and KDE status, Compatibility Center pages, KRunner query previews, Dolphin file-manager previews, desktop icon previews, tray status previews, notification previews, settings previews, task-manager identity previews, and KWin window-rule previews can consume staged activation receipt evidence."
  },
  {
