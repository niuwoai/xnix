...
DOMAIN_DEFINITIONS = [
  ...
  },
  {
    ...
    gate_tokens: {
      ...
      "internal/runtime/appidentity/identity.go" => %w[KRunnerQueryOptions ActivationReceiptBacked ReceiptBackedMatchCount FileOpenOptions TrayStatusOptions ActivationReceiptRoot]
    },
    summary: "KDE activation can stage desktop files, MIME data, service menus, manifests, and receipts under explicit roots, and KDE status, Compatibility Center pages, KRunner query previews, Dolphin file-manager previews, and tray status previews can consume staged activation receipt evidence."
  },
  {
