...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "runtime/dbus/xnix_compatd_runtime_models.inc" => %w[GetRuntimeServiceBinding GetRuntimeLiveOwnerGate GetRuntimeOwnerSmokePlan GetRuntimeMethodParityManifest GetPortalRequestPlan GetCompatibilityPackageSource GetCompatibilityAcquisitionPreflight GetCompatibilityArtifactManifest GetCompatibilityInstallPlan GetCompatibilitySettings GetCompatibilityCenterSummary],
