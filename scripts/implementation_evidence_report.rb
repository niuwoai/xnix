...
DOMAIN_DEFINITIONS = [
  {
    ...
    gate_tokens: {
      ...
      "runtime/dbus/xnix_compatd_smoke.c" => %w[go_owner_read_dispatch add_go_owner_dispatch_bridge_fields add_go_owner_dispatch_bridge_fields2 add_go_owner_dispatch_bridge_fields3 go_owner_write_gate_dispatch go_owner_dispatch_available go_owner_dispatch_json go-runtime-owner-dispatch+c-smoke-bridge GetRunPlan GetDesktopActivationManifest GetDesktopActivationTransactionPreview GetDesktopActivationStatus GetKDEIntegrationStatus GetKDEShellIntegrationPlan GetKDEApplicationSurfacePlan GetDesktopEntryPlan GetDesktopIconPlan GetTaskManagerIdentityPlan GetDesktopResourceBridgePlan GetKWinWindowRulePlan GetFileAssociationPlan GetNotificationPlan GetTrayStatus GetKRunnerQueryPlan],
      "runtime/dbus/xnix_compatd_runtime_models.inc" => %w[GetRuntimeServiceBinding GetRuntimeLiveOwnerGate GetRuntimeOwnerSmokePlan GetRuntimeMethodParityManifest GetPortalRequestPlan GetCompatibilityPackageSource GetCompatibilityAcquisitionPreflight GetCompatibilityArtifactManifest GetCompatibilityInstallPlan GetBackendBinding GetBackendCapabilityMatrix GetBackendSelectionPlan GetBackendLifecycle GetBackendEnvironmentPlan GetRepairPlan GetTestPlan GetTestResult GetExecutionReadiness GetLaunchIntent GetAIDiagnosticInput GetAIDiagnosticRecommendation GetAIRepairApprovalGate GetSnapshotPlan GetPortalAccessPolicy GetCompatibilitySettings GetCompatibilityCenterSummary],
    ...
    summary: "The Go owner candidate has full D-Bus read dispatch coverage, lifecycle JSONL, smoke-batch read/write evidence, and C D-Bus bridge evidence for owner self-description, KDE shell, desktop activation payloads, seven-entry-point payloads, second-ring KDE resource payloads, install-input payloads, backend lifecycle payloads, execution readiness payloads, and AI safety payloads; production ownership remains gated."
  },
  {
