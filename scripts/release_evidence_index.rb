...
def product_image_claim(domain)
  {
    ...
    evidence_source_files: %w[scripts/full_smoke.rb lib/xnix/full_smoke_report.rb buildroot/configs/xnix_x86_64_defconfig],
    verification_commands: ["ruby scripts/full_smoke.rb"],
    current_evidence: domain ? domain.fetch("summary", "Image acceptance evidence exists but is gated.") : "Product image acceptance evidence is gated.",
    unsafe_gates: disabled_unsafe_gates,
