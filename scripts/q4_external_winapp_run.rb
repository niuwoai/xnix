...
plan = {
  ...
  "go_runtime_plan_schema_version" => "xnix.runtime.q4_external_winapp_run_plan.v1",
  "go_runtime_plan_request_type" => "q4-external-winapp-run-plan-preview",
  "go_runtime_plan_command" => [
    "xnix-runtime-go",
    "q4-external-winapp-run-plan-preview",
    "--executable", local_executable.to_s,
    "--app-id", app_id,
    "--display-name", display_name,
    "--window-match", window_match,
    "--remote", remote_host,
