...
func TestBackendAdapterContractOwnerRouteAuditPreviewCommand(t *testing.T) {
	...
	if payload["version"] != currentProjectVersion(t) ||
		...
		payload["proposed_owner_method"] != "GetBackendAdapterContract" ||
		payload["route_decision"] != "remain-fixture-local" ||
		payload["current_route_status"] != "fixture-local-audit-ready-owner-route-blocked" {
	...
	if payload["cli_command_registered"] != true ||
		...
		payload["redacted_profile_route_present"] != false ||
