...
static const XnixRuntimeApplication applications[] = {
  {
    ...
    .launcher_command = "xnix-compat-launch --app org.xnix.sample.notepad --registry /usr/share/xnix/compatibility/recipes/registry.json %U",
...
#include "xnix_runtime_core_desktop_icon.inc"
