...
#include "xnix_runtime_core_cli_probe.inc"
...
#include "xnix_runtime_core_cli_desktop_resource_bridge_plan.inc"
...
#include "xnix_runtime_core_cli_kde_shell_integration_plan.inc"
