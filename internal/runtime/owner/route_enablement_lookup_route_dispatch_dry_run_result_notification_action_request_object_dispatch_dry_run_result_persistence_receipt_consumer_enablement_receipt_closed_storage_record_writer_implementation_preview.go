...
func (root string) (, error) {
	...
	preview := {
		...
		"result_persistence_receipt_consumer_enablement_receipt_storage_record_contract_accepted_receipt_gate_call_persistence_authorization_evidence_ready":                                                          storageRecordContractReady && storageRecordContractPreview["result_persistence_receipt_consumer_enablement_receipt_closed_persistence_implementation_accepted_receipt_gate_call_persistence_authorization_evidence_ready"] == true,
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementReceiptClosedStorageRecordWriterImplementationItems(mainlineReady, storageRecordContractReady, storageGateReady, closedPersistenceImplementationReady, persistenceAuthorizationReady bool) []map[string]any {
	...
	for _, kind := range kinds {
		...
		items = append(items, map[string]any{
			...
			"persistence_receipt_consumer_enablement_receipt_storage_record_contract_accepted_receipt_gate_call_persistence_authorization_evidence_ready": storageRecordContractReady,
