...
func (root string) (, error) {
	...
	acceptedReceiptGateGrantEvidenceReady := acceptedReceiptGateEnablementGrantEvidenceReady(grantPreview)
	grantAuthorizationAcceptanceCallAuthorizationCallPersistenceAuthorizationEvidenceReady := grantPreview["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_authorization_acceptance_call_authorization_call_persistence_authorization_evidence_ready"] == true &&
		acceptedReceiptGateGrantEvidenceReady
	...
	items := acceptedReceiptGateEnablementItems(grantPreview, mainlineReady, grantReady, acceptedReceiptGateGrantEvidenceReady)
	...
	preview := {
		...
		"result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_call_authorization_receipt_accepted_receipt_gate_grant_evidence_ready":                                                                                                         grantReady && acceptedReceiptGateGrantEvidenceReady,
		...
		"persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_accepted_receipt_gate_grant_evidence_consumed_item_count":                   readyItemCount,
...
func acceptedReceiptGateEnablementGrantEvidenceReady(grantPreview ) bool {
	checkIDs, _ := grantPreview["check_ids"].([]string)
	return grantPreview["route_enablement_lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_accepted_receipt_gate_authorization_evidence_consumed"] == true &&
		grantPreview["lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_call_authorization_receipt_accepted_receipt_gate_authorization_evidence_ready"] == true &&
		grantPreview["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_call_authorization_receipt_accepted_receipt_gate_authorization_evidence_ready"] == true &&
		grantPreview["persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_accepted_receipt_gate_authorization_evidence_consumed_item_count"] == 4 &&
		grantPreview["receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_callable"] == false &&
		grantPreview["receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_granted"] == false &&
		stringSliceContains(checkIDs, "persistence-receipt-consumer-enablement-receipt-storage-record-writer-call-authorization-receipt-accepted-receipt-gate-grant-call-authorization-receipt-accepted-receipt-gate-authorization-evidence-consumed")
}

func acceptedReceiptGateEnablementItems(grantPreview , mainlineReady, grantReady, acceptedReceiptGateGrantEvidenceReady bool) []map[string]any {
	...
	ready := mainlineReady && grantReady && acceptedReceiptGateGrantEvidenceReady
	...
	for _, sourceItem := range sourceItems {
		itemAcceptedReceiptGateGrantEvidenceReady := grantReady &&
			acceptedReceiptGateGrantEvidenceReady &&
			sourceItem["persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_accepted_receipt_gate_authorization_evidence_consumed"] == true &&
			sourceItem["persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_call_authorization_receipt_accepted_receipt_gate_authorization_evidence_ready"] == true
		itemGrantAuthorizationAcceptanceCallAuthorizationCallPersistenceAuthorizationEvidenceReady := grantReady &&
			itemAcceptedReceiptGateGrantEvidenceReady &&
			sourceItem["persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_authorization_acceptance_call_authorization_call_persistence_authorization_evidence_ready"] == true
		itemReady := ready && itemGrantAuthorizationAcceptanceCallAuthorizationCallPersistenceAuthorizationEvidenceReady && itemAcceptedReceiptGateGrantEvidenceReady
		itemStatus := status
		if !itemReady {
		...
		item["persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_authorization_acceptance_call_authorization_call_persistence_authorization_evidence_ready"] = itemGrantAuthorizationAcceptanceCallAuthorizationCallPersistenceAuthorizationEvidenceReady
		item["persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_accepted_receipt_gate_grant_evidence_consumed"] = itemAcceptedReceiptGateGrantEvidenceReady
		item["persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_call_authorization_receipt_accepted_receipt_gate_grant_evidence_ready"] = itemAcceptedReceiptGateGrantEvidenceReady
		...
		item["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_modeled"] = itemReady
		item["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_ready"] = itemReady
		item["receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_boundary_modeled"] = itemReady
		...
		item["notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_status"] = itemStatus
...
func acceptedReceiptGateEnablementChecks(preview ) []map[string]any {
	return []map[string]any{
		...
		routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementGateAuditCheck("storage-record-writer-call-authorization-receipt-accepted-receipt-gate-grant-authorization-acceptance-evidence-consumed", preview["lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_authorization_acceptance_call_authorization_call_persistence_authorization_evidence_ready"] == true && preview["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_authorization_acceptance_call_authorization_call_persistence_authorization_evidence_ready"] == true, "Storage record writer call authorization receipt accepted receipt gate grant carries the predecessor's authorization acceptance call authorization call persistence authorization evidence."),
		routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementGateAuditCheck("persistence-receipt-consumer-enablement-receipt-storage-record-writer-call-authorization-receipt-accepted-receipt-gate-enablement-call-authorization-receipt-accepted-receipt-gate-grant-evidence-consumed", preview["route_enablement_lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_accepted_receipt_gate_grant_evidence_consumed"] == true && preview["lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_call_authorization_receipt_accepted_receipt_gate_grant_evidence_ready"] == true && preview["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_enablement_call_authorization_receipt_accepted_receipt_gate_grant_evidence_ready"] == true, "Storage record writer call authorization receipt accepted receipt gate enablement consumes the v0.2.535 accepted receipt gate grant evidence before modeling the enablement boundary."),
