...
func NewProductionDBusMethodReviewPreview(root string) (ProductionDBusMethodReviewPreview, error) {
	...
	preview := ProductionDBusMethodReviewPreview{
		...
		Source:                          "runtime-method-parity-manifest-preview+runtime-owner-route-manifest-preview+production-dbus-gate-review-preview+runtime-write-gate-preview",
		...
		NextRequirements: []string{
			...
			"Keep owner-local candidates owner-local until an accepted human authorization receipt and rollback diagnostics review exist.",
