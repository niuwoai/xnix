...
const routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditRequest = "production-receipt-notification-action-dry-run-result-lookup-consumer-enablement-kde-safe-redacted-status-closed-record-writer-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-audit-preview"

type  map[string]any

func (root string) (, error) {
	version, err := readProductionDBusGateReviewVersion(root)
	if err != nil {
		return nil, err
	}

	sources := routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditSources(root)
	mainlineReady := routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditMainlineReady(sources.CurrentMainline)
	consumerAuthorizationReady := routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditConsumerAuthorizationReady(sources.RouteEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerAuthorizationAudit)
	consumptionGateReady := routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditConsumptionGateReady(sources.RouteEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumptionGateAudit)
	acceptanceAuditReady := routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditAcceptanceReady(sources.RouteEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptAcceptanceAudit)
	items := routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditItems(mainlineReady, consumerAuthorizationReady, consumptionGateReady, acceptanceAuditReady)
	readyItemCount := routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditReadyCount(items)
	ready := mainlineReady && consumerAuthorizationReady && consumptionGateReady && acceptanceAuditReady && readyItemCount == len(items)
	...
	preview := {
		"version":                   version,
		"schema_version":            "xnix.runtime.production_receipt_notification_action_dry_run_result_lookup_consumer_enablement_kde_safe_redacted_status_closed_record_writer_storage_root_authorization_receipt_dry_run_lookup_result_consumer_projection_route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit.v1",
		"request_type":              routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditRequest,
		...
		"source":                    "docs/xnix-current-mainline.md+route-enable-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-authorization-audit+route-enable-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumption-gate-audit+route-enable-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-acceptance-audit",
		...
		"lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_audit_required":                true,
		"lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_modeled":                       true,
		"lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_ready":                         ready,
		"route_enablement_lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_ready":        ready,
		...
		"kde_notification_delivery_consent_collection_receipt_consumer_enablement_gate_modeled":                                                        ready,
		"notification_center_delivery_consent_collection_receipt_consumer_enablement_gate_modeled":                                                     ready,
		"install_failure_consent_collection_receipt_consumer_enablement_gate_modeled":                                                                  ready,
		"repair_suggestion_consent_collection_receipt_consumer_enablement_gate_modeled":                                                                ready,
		"environment_switch_consent_collection_receipt_consumer_enablement_gate_modeled":                                                               ready,
		"approval_info_consent_collection_receipt_consumer_enablement_gate_modeled":                                                                    ready,
		"notification_delivery_consent_collection_receipt_consumer_enablement_gate_review_only":                                                        true,
		...
		"consumer_enablement_gate_modeled":                     ready,
		"consumer_enablement_gate_ready":                       ready,
		"consumer_enablement_required":                         true,
		"consumer_enablement_modeled":                          ready,
		"consumer_enablement_ready":                            ready,
		...
		"notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count":             len(items),
		"required_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count":    len(items),
		"ready_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count":       readyItemCount,
		"missing_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count":     len(items) - readyItemCount,
		...
		"receipt_consumer_enablement_gate_modeled_item_count":                                              readyItemCount,
		...
		"side_effect_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count": 0,
		"notification_delivery_consent_collection_receipt_consumer_enablement_gate_items":                  items,
		"notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_ids":               routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditItemIDs(items),
		"runtime_owned":                       true,
		...
		"next_requirements": []string{
			"Add a separate notification delivery execution authorization audit before consumer-enabled receipts can issue delivery grants.",
		...
		"desktop_safe_summary": "KDE Notification Center consent collection receipt consumer enablement gate readiness is modeled for redacted lookup route dispatch dry-run result install failure, repair suggestion, environment switch, and approval information events while consent collection, consent persistence, consent receipt creation, consent receipt acceptance, consent receipt consumption, consumer authorization grants, consumer enablement, delivery grants, delivery, events, actions, action cards, raw results, lookup routes, dispatch, persistence, production, backend, and host side effects remain disabled.",
	}
	preview["checks"] = routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditChecks(preview)
	preview["check_ids"] = routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCheckIDs(preview["checks"].([]map[string]any))
	preview["counts"] = routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCountsFor(preview["checks"].([]map[string]any))
	if err := validateNoBackendTerms(preview, "KDE-safe redacted status dry-run lookup result consumer projection route enablement lookup route dispatch dry-run result notification delivery consent collection receipt consumer enablement gate audit preview"); err != nil {
		return nil, err
	}
	return preview, nil
}

type routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditSourceSet struct {
	CurrentMainline                                                                                                      string
	RouteEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerAuthorizationAudit string
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditSources(root string) routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditSourceSet {
	return routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditSourceSet{
		CurrentMainline: productionAuthorizationReadSources(root, []string{"docs/xnix-current-mainline.md"}),
		RouteEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerAuthorizationAudit: productionAuthorizationReadSources(root, []string{
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditMainlineReady(source string) bool {
	...
	continuityReady := productionAuthorizationHasAll(source, []string{
		...
		"notification delivery consent collection receipt consumer enablement gate audit preview",
	})
	return activeTaskReady || continuityReady
}

func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditConsumerAuthorizationReady(source string) bool {
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditConsumptionGateReady(source string) bool {
	return productionAuthorizationHasAll(source, []string{
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditAcceptanceReady(source string) bool {
	return productionAuthorizationHasAll(source, []string{
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditItems(mainlineReady, consumerAuthorizationReady, consumptionGateReady, acceptanceAuditReady bool) []map[string]any {
	kinds := []struct {
		id   string
		kind string
	}{
		{id: "install-failure", kind: "notification-center-install-failure-consent-collection-receipt-consumer-enablement-gate"},
		{id: "repair-suggestion", kind: "notification-center-repair-suggestion-consent-collection-receipt-consumer-enablement-gate"},
		{id: "environment-switch", kind: "notification-center-environment-switch-consent-collection-receipt-consumer-enablement-gate"},
		{id: "approval-info", kind: "notification-center-approval-info-consent-collection-receipt-consumer-enablement-gate"},
	}
	items := make([]map[string]any, 0, len(kinds))
	for _, notification := range kinds {
		ready := mainlineReady && consumerAuthorizationReady && consumptionGateReady && acceptanceAuditReady
		status := "missing-redacted-status-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-evidence"
		if ready {
			status = "redacted-status-storage-root-authorization-receipt-dry-run-lookup-result-consumer-projection-route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-ready-consumers-disabled"
		}
		items = append(items, map[string]any{
			"id":                            "route-enablement-lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-" + notification.id,
			"notification_kind":             notification.id,
			"consumer_enablement_gate_kind": notification.kind,
			...
			"consent_collection_receipt_consumer_enablement_gate_status":                             status,
			"next_requirement":                                                                       "Require separate notification delivery execution authorization before this modeled consumer enablement can issue delivery grants.",
		})
	}
	return items
}

func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditReadyCount(items []map[string]any) int {
	count := 0
	for _, item := range items {
		if item["evidence_present"] == true && item["receipt_consumer_authorization_audit_consumed"] == true && item["receipt_consumption_gate_audit_consumed"] == true && item["receipt_acceptance_audit_consumed"] == true && item["consent_collection_receipt_required"] == true && item["consent_collection_receipt_modeled"] == true && item["consent_collection_receipt_ready"] == true && item["consent_collection_receipt_consumption_gate_required"] == true && item["consent_collection_receipt_consumption_gate_modeled"] == true && item["consent_collection_receipt_consumption_gate_ready"] == true && item["consumer_authorization_required"] == true && item["consumer_authorization_modeled"] == true && item["consumer_authorization_ready"] == true && item["consumer_enablement_gate_required"] == true && item["consumer_enablement_gate_modeled"] == true && item["consumer_enablement_gate_ready"] == true && item["consumer_enablement_required"] == true && item["consumer_enablement_modeled"] == true && item["consumer_enablement_ready"] == true && item["consumer_authorization_granted"] == false && item["kde_consumer_authorized"] == false && item["runtime_consumer_authorized"] == false && item["kde_consumer_enabled"] == false && item["runtime_consumer_enabled"] == false && item["consumer_enabled"] == false && item["consent_collection_receipt_consumption_allowed"] == false && item["consent_collection_receipt_consumption_enabled"] == false && item["consent_collection_allowed"] == false && item["consent_collection_enabled"] == false && item["explicit_user_consent_collected"] == false && item["explicit_user_consent_persisted"] == false && item["consent_receipt_created"] == false && item["consent_receipt_persisted"] == false && item["consent_receipt_accepted"] == false && item["consent_receipt_consumed"] == false && item["delivery_grant_issued"] == false && item["delivery_authorization_granted"] == false && item["delivery_review_only"] == true && item["kde_safe_redacted_result_only"] == true && item["raw_result_hidden"] == true && item["side_effects_disabled"] == true && item["notification_delivery_enabled"] == false && item["notification_sent"] == false && item["notification_center_event_triggered"] == false && item["notification_action_enabled"] == false && item["action_card_enabled"] == false && item["host_root_modified"] == false {
			count++
		}
	}
	return count
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditItemIDs(items []map[string]any) []string {
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditChecks(preview ) []map[string]any {
	return []map[string]any{
		routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCheck("current-mainline-consumed", preview["current_mainline_consumed"] == true, "Current mainline names the notification delivery consent collection receipt consumer enablement gate continuation."),
		...
		routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCheck("lookup-route-dispatch-dry-run-result-notification-delivery-consent-collection-receipt-consumer-enablement-gate-modeled", preview["lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_modeled"] == true && preview["lookup_route_dispatch_dry_run_result_notification_delivery_consent_collection_receipt_consumer_enablement_gate_ready"] == true, "Notification delivery consent collection receipt consumer enablement gate boundary is modeled."),
		routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCheck("four-kde-notification-delivery-events-consent-collection-receipt-consumer-enablement-gate-review-only", preview["notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count"] == 4 && preview["ready_notification_delivery_consent_collection_receipt_consumer_enablement_gate_item_count"] == 4 && preview["consumer_authorization_granted_item_count"] == 0 && preview["enabled_consumer_item_count"] == 0 && preview["consent_receipt_consumed_item_count"] == 0, "Four KDE Notification Center delivery event classes are consent-collection-receipt-consumer-enablement-gate-modeled and remain review-only."),
		routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCheck("consumer-enablements-authorization-grants-consumption-delivery-and-events-disabled", preview["consumer_enabled"] == false && preview["kde_consumer_enabled"] == false && preview["runtime_consumer_enabled"] == false && preview["consumer_authorization_granted"] == false && preview["kde_consumer_authorized"] == false && preview["runtime_consumer_authorized"] == false && preview["consent_collection_receipt_consumption_allowed"] == false && preview["consent_collection_receipt_consumption_enabled"] == false && preview["consent_receipt_consumed"] == false && preview["notification_delivery_grant_issued"] == false && preview["notification_delivery_authorization_granted"] == false && preview["notification_delivery_enabled"] == false && preview["notification_sent"] == false && preview["notification_center_event_triggered"] == false, "Consumer enablement, authorization grants, receipt consumption, delivery grant issuance, notification sending, and Notification Center events remain disabled."),
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCheck(id string, passed bool, summary string) map[string]any {
	status := "blocked"
	if passed {
		status = "pass"
	}
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCheckIDs(checks []map[string]any) []string {
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationDeliveryConsentCollectionReceiptConsumerEnablementGateAuditCountsFor(checks []map[string]any) map[string]int {
