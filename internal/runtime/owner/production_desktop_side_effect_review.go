...
func NewProductionDesktopSideEffectReviewPreview(root string) (ProductionDesktopSideEffectReviewPreview, error) {
	...
	preview := ProductionDesktopSideEffectReviewPreview{
		...
		Source:                   "production-dbus-gate-review-preview+production-rollback-diagnostics-review-preview+kde-entrypoints-preview+kde-action-queue-preview+desktop-activation-manifest-preview+kde-shell-integration-preview+kde-application-surface-preview",
		...
		NextRequirements: []string{
			...
			"Require production gate, method review, rollback diagnostics review, human authorization, and service activation gates before desktop writes.",
