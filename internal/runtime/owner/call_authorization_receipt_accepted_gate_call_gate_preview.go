...
func (root string) (, error) {
	...
	items := acceptedReceiptGateCallGateItems(enablementPreview, mainlineReady, enablementReady)
...
func acceptedReceiptGateCallGateItems(enablementPreview , mainlineReady, enablementReady bool) []map[string]any {
	...
	for _, sourceItem := range sourceItems {
		...
		item["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_call_gate_modeled"] = ready
		item["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_call_gate_ready"] = ready
		item["receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_call_gate_boundary_modeled"] = ready
		...
		item["notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_call_gate_status"] = status
