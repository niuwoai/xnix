...
func routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementReceiptStorageRecordWriterCallAuthorizationReceiptStorageRecordWriterCallAuthorizationReady(source string, preview ) bool {
	return productionAuthorizationHasAll(source, []string{"result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_ready", "receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_callable", "receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_granted"}) &&
