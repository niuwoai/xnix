...
func acceptedReceiptGateCallAuthorizationReceiptAcceptanceItems(receiptPreview , mainlineReady, receiptReady bool) []map[string]any {
	...
	for _, sourceItem := range sourceItems {
		...
		itemReady := ready && itemCallAuthorizationReceiptCallAuthorizationCallGateEnablementGrantAuthorizationAcceptanceCallAuthorizationCallPersistenceAuthorizationEvidenceReady
		itemStatus := status
		if !itemReady {
