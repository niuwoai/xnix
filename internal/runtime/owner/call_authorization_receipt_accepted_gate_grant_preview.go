...
func acceptedReceiptGateGrantItems(authorizationPreview , mainlineReady, authorizationReady bool) []map[string]any {
	...
	for _, sourceItem := range sourceItems {
		...
		item["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_modeled"] = ready
		item["result_persistence_receipt_consumer_enablement_receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_ready"] = ready
		item["receipt_storage_record_writer_call_authorization_receipt_accepted_receipt_gate_grant_boundary_modeled"] = ready
