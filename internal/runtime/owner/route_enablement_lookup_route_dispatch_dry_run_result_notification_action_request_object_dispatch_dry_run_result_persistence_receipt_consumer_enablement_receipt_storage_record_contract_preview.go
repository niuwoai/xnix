...
func (root string) (, error) {
	...
	storageGateEvidenceReady := routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementReceiptStorageRecordContractStorageGateEvidenceReady(sources.StoragePersistenceGate, storageGatePreview)
	...
	items := routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementReceiptStorageRecordContractItems(mainlineReady, storageGateReady, storageGateEvidenceReady, closedPersistenceImplementationReady, persistenceAuthorizationReady, closedImplementationReady, enablementAuditReady, grantAuditReady)
	...
	ready := mainlineReady && storageGateReady && storageGateEvidenceReady && closedPersistenceImplementationReady && persistenceAuthorizationReady && closedImplementationReady && enablementAuditReady && grantAuditReady && readyItemCount == len(items)
	...
	preview := {
		...
		"result_persistence_receipt_consumer_enablement_receipt_closed_persistence_implementation_accepted_receipt_gate_call_persistence_authorization_evidence_ready":                                                                                      storageGateEvidenceReady,
		"route_enablement_lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_contract_storage_persistence_gate_authorization_evidence_consumed": storageGateEvidenceReady,
		"lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_contract_accepted_receipt_gate_call_persistence_authorization_evidence_ready":       ready,
		"result_persistence_receipt_consumer_enablement_receipt_storage_record_contract_accepted_receipt_gate_call_persistence_authorization_evidence_ready":                                                                                                ready,
		...
		"persistence_receipt_consumer_enablement_receipt_storage_record_contract_storage_persistence_gate_authorization_evidence_consumed_item_count":        readyItemCount,
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementReceiptStorageRecordContractStorageGateEvidenceReady(source string, preview ) bool {
	return productionAuthorizationHasAll(source, []string{
		...
		"persistence_receipt_consumer_enablement_receipt_storage_persistence_gate_closed_persistence_implementation_persistence_authorization_evidence_consumed",
		"persistence_receipt_consumer_enablement_receipt_storage_persistence_gate_accepted_receipt_gate_call_persistence_authorization_evidence_ready",
		"persistence-receipt-consumer-enablement-receipt-storage-persistence-gate-accepted-receipt-gate-call-persistence-authorization-evidence-consumed",
	}) && preview["route_enablement_lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_persistence_gate_closed_persistence_implementation_persistence_authorization_evidence_consumed"] == true &&
		preview["lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_persistence_gate_accepted_receipt_gate_call_persistence_authorization_evidence_ready"] == true &&
		preview["result_persistence_receipt_consumer_enablement_receipt_storage_persistence_gate_accepted_receipt_gate_call_persistence_authorization_evidence_ready"] == true
}
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementReceiptStorageRecordContractItems(mainlineReady, storageGateReady, storageGateEvidenceReady, closedPersistenceImplementationReady, persistenceAuthorizationReady, closedImplementationReady, enablementAuditReady, grantAuditReady bool) []map[string]any {
	kinds := []string{"install-failure", "repair-suggestion", "environment-switch", "approval-info"}
	items := make([]map[string]any, 0, len(kinds))
	for _, kind := range kinds {
		ready := mainlineReady && storageGateReady && storageGateEvidenceReady && closedPersistenceImplementationReady && persistenceAuthorizationReady && closedImplementationReady && enablementAuditReady && grantAuditReady
		...
		items = append(items, map[string]any{
			...
			"persistence_receipt_consumer_enablement_receipt_storage_record_contract_storage_persistence_gate_authorization_evidence_consumed":                      storageGateEvidenceReady,
			"persistence_receipt_consumer_enablement_receipt_storage_record_contract_accepted_receipt_gate_call_persistence_authorization_evidence_ready":           ready,
			"persistence_receipt_consumer_enablement_receipt_closed_persistence_implementation_accepted_receipt_gate_call_persistence_authorization_evidence_ready": storageGateEvidenceReady,
...
func routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementReceiptStorageRecordContractChecks(preview ) []map[string]any {
	return []map[string]any{
		...
		routeEnablementLookupRouteDispatchDryRunResultNotificationActionRequestObjectDispatchDryRunResultPersistenceReceiptConsumerEnablementGateAuditCheck("persistence-receipt-consumer-enablement-receipt-storage-record-contract-accepted-receipt-gate-call-persistence-authorization-evidence-consumed", preview["route_enablement_lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_contract_storage_persistence_gate_authorization_evidence_consumed"] == true && preview["lookup_route_dispatch_dry_run_result_notification_action_request_object_dispatch_dry_run_result_persistence_receipt_consumer_enablement_receipt_storage_record_contract_accepted_receipt_gate_call_persistence_authorization_evidence_ready"] == true && preview["result_persistence_receipt_consumer_enablement_receipt_storage_record_contract_accepted_receipt_gate_call_persistence_authorization_evidence_ready"] == true, "Storage record contract consumes the storage persistence gate accepted receipt gate call persistence authorization evidence before modeling storage record contracts."),
