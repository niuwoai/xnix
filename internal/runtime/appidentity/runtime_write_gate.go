...
func NewRuntimeWriteGatePreview(root string, methodName string) (RuntimeWriteGatePreview, error) {
	...
	preview := RuntimeWriteGatePreview{
		...
		Source:                      "go-runtime-write-gate+runtime-service-activation-preflight-preview+production-dbus-gate-review-preview+production-dbus-human-authorization-preflight-preview",
