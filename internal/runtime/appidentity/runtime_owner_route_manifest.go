...
var runtimeOwnerRouteGoCommands = map[string]string{
	...
	"GetCompatibilityInstallPlan":            "compatibility-install-preview",
	"GetBackendCapabilityMatrix":             "backend-capability-matrix-preview",
	"GetBackendLifecycle":                    "backend-lifecycle-preview",
	"GetApplicationStateRoot":                "state-root-preview",
	"GetSnapshotPlan":                        "snapshot-plan-preview",
	"GetPortalAccessPolicy":                  "portal-access-policy-preview",
	...
	"GetRuntimeOwnerProcess":                 "runtime-owner-process-preview",
	...
	"GetRuntimeOwnerRouteManifest":           "runtime-owner-route-manifest-preview",
	"GetRuntimeOwnerRecipeTrust":             "runtime-owner-recipe-trust-preview",
	"GetRuntimeOwnerReadiness":               "runtime-owner-readiness-preview",
	...
	"GetAIDiagnosticInput":                   "ai-diagnostic-input-preview",
	"GetAIDiagnosticRecommendation":          "ai-diagnostic-recommendation-preview",
	"GetAIRepairApprovalGate":                "ai-repair-approval-gate-preview",
