...
func TestRuntimeOwnerRouteManifestPreviewReportsGoAndLegacyRoutes(t *testing.T) {
	...
	assertRuntimeOwnerRoute(t, preview, "GetKDEApplicationSurfacePlan", "go-runtime-cli", "kde-application-surface-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetTaskManagerIdentityPlan", "go-runtime-cli", "task-manager-identity-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetKWinWindowRulePlan", "go-runtime-cli", "kwin-window-rule-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetApplicationStateRoot", "go-runtime-cli", "state-root-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetSnapshotPlan", "go-runtime-cli", "snapshot-plan-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetPortalAccessPolicy", "go-runtime-cli", "portal-access-policy-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetDiagnostics", "go-runtime-cli", "diagnostics-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetAIDiagnosticInput", "go-runtime-cli", "ai-diagnostic-input-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetAIDiagnosticRecommendation", "go-runtime-cli", "ai-diagnostic-recommendation-preview", "go-preview-ready")
	assertRuntimeOwnerRoute(t, preview, "GetAIRepairApprovalGate", "go-runtime-cli", "ai-repair-approval-gate-preview", "go-preview-ready")
...
func TestRuntimeOwnerRouteManifestPreviewBlocksMissingRouteSources(t *testing.T) {
	root := t.TempDir()
	if err := os.WriteFile(filepath.Join(root, "VERSION"), []byte("0.2.249\n"), 0o600); err != nil {
