...
func TestRuntimeOwnerRouteManifestPreviewReportsGoAndLegacyRoutes(t *testing.T) {
	...
	if preview.DesktopSafeSummary != "Runtime owner routes have Go coverage for migrated application catalog, engine catalog, diagnostics, and current Go previews, with C adapter migration still pending." {
