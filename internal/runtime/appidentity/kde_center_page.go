...
func kdeCenterPageKnownAppMatrixCards(evidence []KnownAppSmokeEvidenceSummary) []KDECenterPageKnownAppMatrixCard {
	...
	for _, item := range evidence {
		...
		cards = append(cards, KDECenterPageKnownAppMatrixCard{
			...
			OwnerFileOpenEntrypointInvoked:               item.OwnerFileOpenEntrypointInvoked,
...
func kdeCenterPageExternalWinAppApplicationDetailCards(detail *ExternalWinAppApplicationDetail) []KDECenterPageExternalWinAppCard {
	...
	return []KDECenterPageExternalWinAppCard{{
		...
		Q4KnownPortableWinAppRunAcceptanceConsumed:      detail.Q4KnownPortableWinAppRunAcceptanceConsumed,
		Q4KnownPortableWinAppRunAcceptanceReady:         detail.Q4KnownPortableWinAppRunAcceptanceReady,
		GoOwnedKnownPortableWinAppRunAcceptanceVerified: detail.GoOwnedKnownPortableWinAppRunAcceptanceVerified,
...
func countOwnerFileOpenEntrypointKnownAppGUIEvidence(evidence []KnownAppSmokeEvidenceSummary) int {
	count := 0
	for _, item := range evidence {
		if knownAppGUIEvidenceSource(item.EvidenceSource) &&
			item.SmokeStatus == "passed" &&
