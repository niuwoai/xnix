...
assert(contents.include?("validated-session-gated-dispatch"), "Staged launcher dispatch smoke must verify the session-gated dispatch card state")
...
assert(contents.include?("review-session-gated-dispatch"), "Staged launcher dispatch smoke must verify the session-gated dispatch review action")
