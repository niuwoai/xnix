...
assert(contents.include?("validated-launch-authorization-required"), "Staged launcher dispatch smoke must verify the validated authorization-required card state")
