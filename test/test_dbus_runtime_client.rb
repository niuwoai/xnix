...
class FakeCapture
  ...
  def call(*command)
    ...
    when "org.xnix.Compatibility1.GetDesktopActivationStatus"
      [
        "({'request_type': <'desktop-activation-status-preview'>, 'status_type': <'kde-desktop-activation-status'>, 'activation_state': <'ready-for-runtime-commit'>, 'runtime_method': <'GetDesktopActivationStatus'>, 'read_model_source': <'xnix-runtime-go desktop-activation-status-preview'>, 'application_id': <'org.xnix.sample.notepad'>, 'install_mode': <'development'>, 'transaction_state': <'transaction-ready'>, 'planned_file_count': <5>, 'transaction_step_count': <9>, 'rollback_step_count': <7>, 'status_signal_count': <5>, 'blocked_reason_count': <4>, 'next_safe_action_count': <5>, 'runtime_owned': <true>, 'go_runtime_backed': <true>, 'kde_policy_owner': <false>, 'activation_ready': <true>, 'activation_committed': <false>, 'commit_enabled': <false>, 'launch_enabled': <false>, 'backend_launch_enabled': <false>, 'host_root_modified': <false>, 'network_required': <false>, 'privileged_container_required': <false>, 'backend_details_exposed': <false>},)\n",
        "",
        Status.new(true)
      ]
    ...
    when "org.xnix.Compatibility1.GetBackendSelectionPlan"
      [
        "({'plan_type': <'compatibility-backend-selection-plan'>, 'runtime_method': <'GetBackendSelectionPlan'>, 'recommended_profile_id': <'local-compatibility'>, 'candidate_count': <2>, 'ready_candidate_count': <0>, 'blocked_candidate_count': <2>, 'candidate_profile_ids': <['local-compatibility', 'isolated-compatibility']>, 'runtime_owned': <true>, 'c_runtime_backed': <true>, 'kde_policy_owner': <false>, 'selection_committed': <false>, 'selection_change_enabled': <false>, 'backend_launch_enabled': <false>, 'capability_activation_enabled': <false>, 'environment_created': <false>, 'request_object_created': <false>, 'state_root_created': <false>, 'snapshot_created': <false>, 'host_root_modified': <false>, 'privileged_container_required': <false>, 'backend_details_exposed': <false>},)\n",
        "",
        Status.new(true)
      ]
    ...
    when "org.xnix.Compatibility1.GetKDECenterPage"
      [
        "({'request_type': <'kde-center-page'>, 'page_type': <'compatibility-center-application-page'>, 'runtime_method': <'GetKDECenterPage'>, 'application_id': <'org.xnix.sample.notepad'>, 'backend_selection_runtime_method': <'GetBackendSelectionPlan'>, 'backend_recommended_profile_id': <'local-compatibility'>, 'backend_candidate_count': <2>, 'backend_selection_committed': <false>, 'backend_selection_change_enabled': <false>, 'backend_launch_enabled': <false>, 'activation_status_request_type': <'desktop-activation-status-preview'>, 'activation_state': <'ready-for-runtime-commit'>, 'activation_status_runtime_method': <'GetDesktopActivationStatus'>, 'activation_status_renderer': <'xnix-runtime-go desktop-activation-status-preview'>, 'activation_commit_enabled': <false>, 'activation_launch_enabled': <false>, 'execution_readiness_runtime_method': <'GetExecutionReadiness'>, 'execution_state': <'blocked'>, 'execution_overall_status': <'not-ready'>, 'execution_launch_allowed': <false>, 'execution_launch_enabled': <false>, 'execution_request_created': <false>, 'execution_backend_binding_ready': <false>, 'desktop_entry_launch_visible': <true>, 'launch_intent_type': <'runtime-launch-intent'>, 'launch_intent_runtime_method': <'Launch'>, 'launch_intent_read_method': <'GetLaunchIntent'>, 'launch_intent_allowed': <false>, 'launch_intent_enabled': <false>, 'launch_intent_request_created': <false>, 'window_identity_runtime_method': <'GetTaskManagerIdentityPlan'>, 'window_identity_desktop_file': <'xnix-org.xnix.sample.notepad.desktop'>, 'window_identity_grouping_key': <'org.xnix.sample.notepad'>, 'window_identity_pinning_allowed': <true>, 'window_identity_restore_allowed': <true>, 'window_identity_skip_taskbar': <false>, 'window_identity_show_in_switcher': <true>, 'window_identity_policy_only': <true>, 'window_identity_task_manager_active': <false>, 'window_identity_kwin_rule_applied': <false>, 'file_association_runtime_method': <'GetFileAssociationPlan'>, 'file_association_plan_type': <'file-association-plan'>, 'file_association_desktop_file': <'xnix-org.xnix.sample.notepad.desktop'>, 'file_association_count': <2>, 'file_association_standard_mimeapps': <true>, 'file_association_staged_root_only': <true>, 'file_association_overwrite_existing': <false>, 'file_association_portal_required': <true>, 'file_association_direct_host_file_access': <false>, 'file_association_request_object_created': <false>, 'file_association_permission_granted': <false>, 'file_association_files_written': <false>, 'tray_status_runtime_method': <'GetTrayStatus'>, 'tray_status_type': <'tray-status-plan'>, 'tray_status_active_application_count': <1>, 'tray_status_attention_required_count': <1>, 'tray_status_registered_application_count': <1>, 'tray_status_compatibility_state': <'attention-required'>, 'tray_status_bridge_state': <'planned'>, 'tray_status_bridged_application_count': <0>, 'tray_status_live_bridge_enabled': <false>, 'tray_status_bridge_configuration_persisted': <false>, 'tray_status_ready': <true>, 'notification_runtime_method': <'GetNotificationPlan'>, 'notification_plan_type': <'notification-plan'>, 'notification_event_type': <'approval-required'>, 'notification_id': <'org.xnix.sample.notepad.approval-required'>, 'notification_urgency': <'critical'>, 'notification_category': <'compatibility.approval.required'>, 'notification_title': <'Sample Notepad needs approval'>, 'notification_action_count': <2>, 'notification_requires_user_review': <true>, 'notification_action_execution_enabled': <false>, 'notification_repair_execution_enabled': <false>, 'notification_settings_persistence_enabled': <false>, 'notification_sent': <false>, 'notification_ready': <true>, 'card_count': <7>, 'waiting_card_count': <7>, 'settings_section_count': <5>, 'runtime_owned': <true>, 'go_runtime_backed': <true>, 'user_decision_allows_launch': <true>, 'page_preview_created': <true>, 'page_persisted': <false>, 'card_actions_enabled': <false>, 'settings_persisted': <false>, 'launch_enabled': <false>, 'execution_started': <false>, 'backend_details_exposed': <false>},)\n",
        "",
        Status.new(true)
      ]
    when "org.xnix.Compatibility1.GetKDECenterPageSections"
      [
        "({'request_type': <'kde-center-page-sections'>, 'page_type': <'compatibility-center-application-page'>, 'runtime_method': <'GetKDECenterPageSections'>, 'application_id': <'org.xnix.sample.notepad'>, 'section_count': <12>, 'read_only_section_count': <12>, 'navigation_only_section_count': <12>, 'executable_section_count': <0>, 'primary_section_id': <'overview'>, 'section_ids': <['overview', 'backend', 'activation', 'execution', 'launch', 'window', 'files', 'tray', 'notifications', 'actions', 'settings', 'diagnostics']>, 'runtime_methods': <['GetCompatibilityCenterSummary', 'GetBackendSelectionPlan', 'GetDesktopActivationStatus', 'GetExecutionReadiness', 'GetLaunchIntent', 'GetTaskManagerIdentityPlan', 'GetFileAssociationPlan', 'GetTrayStatus', 'GetNotificationPlan', 'GetCompatibilityActionQueue', 'GetCompatibilitySettings', 'GetDiagnostics']>, 'runtime_owned': <true>, 'go_runtime_backed': <true>, 'sections_preview_created': <true>, 'sections_persisted': <false>, 'section_actions_enabled': <false>, 'settings_persisted': <false>, 'launch_enabled': <false>, 'execution_started': <false>, 'backend_details_exposed': <false>},)\n",
        "",
        Status.new(true)
      ]
    when "org.xnix.Compatibility1.GetKDECenterPageSectionDetail"
      [
        "({'request_type': <'kde-center-page-section-detail'>, 'page_type': <'compatibility-center-application-page'>, 'runtime_method': <'GetKDECenterPageSectionDetail'>, 'application_id': <'org.xnix.sample.notepad'>, 'section_id': <'settings'>, 'section_label': <'Settings'>, 'section_target': <'compatibility-settings'>, 'section_state': <'planned'>, 'section_runtime_method': <'GetCompatibilitySettings'>, 'section_read_model': <'settings-model'>, 'available_section_ids': <['overview', 'backend', 'activation', 'execution', 'launch', 'window', 'files', 'tray', 'notifications', 'actions', 'settings', 'diagnostics']>, 'read_only_navigation': <true>, 'runtime_owned': <true>, 'go_runtime_backed': <true>, 'detail_preview_created': <true>, 'detail_persisted': <false>, 'section_actions_enabled': <false>, 'settings_persisted': <false>, 'launch_enabled': <false>, 'execution_started': <false>, 'backend_details_exposed': <false>},)\n",
        "",
        Status.new(true)
      ]
    else
...
activation_status = client.desktop_activation_status("org.xnix.sample.notepad", "development")
assert(activation_status["request_type"] == "desktop-activation-status-preview", "D-Bus client must parse desktop activation status previews")
assert(activation_status["status_type"] == "kde-desktop-activation-status", "D-Bus client must parse desktop activation status types")
assert(activation_status["runtime_method"] == "GetDesktopActivationStatus", "D-Bus client must parse activation status Runtime methods")
assert(activation_status["read_model_source"] == "xnix-runtime-go desktop-activation-status-preview", "D-Bus client must parse activation status Go source")
assert(activation_status["activation_state"] == "ready-for-runtime-commit", "D-Bus client must parse activation status state")
assert(activation_status["transaction_state"] == "transaction-ready", "D-Bus client must parse activation status transaction state")
assert(activation_status["status_signal_count"] == 5, "D-Bus client must parse activation status signal counts")
assert(activation_status["blocked_reason_count"] == 4, "D-Bus client must parse activation status blocked reason counts")
assert(activation_status["next_safe_action_count"] == 5, "D-Bus client must parse activation status next action counts")
assert(activation_status["go_runtime_backed"], "D-Bus client must parse activation status Go backing")
assert(!activation_status["kde_policy_owner"], "D-Bus client must parse activation status KDE ownership")
assert(activation_status["activation_ready"], "D-Bus client must parse activation status readiness")
assert(!activation_status["activation_committed"], "D-Bus client must parse activation status commit state")
assert(!activation_status["commit_enabled"], "D-Bus client must parse activation status commit gate")
assert(!activation_status["launch_enabled"], "D-Bus client must parse activation status launch gate")
assert(!activation_status["backend_launch_enabled"], "D-Bus client must parse activation status backend launch gate")
assert(!activation_status["host_root_modified"], "D-Bus client must parse activation status host-root safety")
assert(!activation_status["network_required"], "D-Bus client must parse activation status network safety")
assert(!activation_status["privileged_container_required"], "D-Bus client must parse activation status container safety")
assert(!activation_status["backend_details_exposed"], "D-Bus client must parse activation status backend detail status")
...
backend_selection_plan = client.backend_selection_plan("org.xnix.sample.notepad")
assert(backend_selection_plan["plan_type"] == "compatibility-backend-selection-plan", "D-Bus client must parse backend selection plans")
assert(backend_selection_plan["runtime_method"] == "GetBackendSelectionPlan", "D-Bus client must parse backend selection Runtime methods")
assert(backend_selection_plan["candidate_count"] == 2, "D-Bus client must parse backend selection candidate counts")
assert(backend_selection_plan["blocked_candidate_count"] == 2, "D-Bus client must parse blocked backend selection candidates")
assert(!backend_selection_plan["selection_committed"], "D-Bus client must parse backend selection commit gates")
assert(!backend_selection_plan["selection_change_enabled"], "D-Bus client must parse backend selection change gates")
assert(!backend_selection_plan["backend_launch_enabled"], "D-Bus client must parse backend selection launch gates")
assert(!backend_selection_plan["environment_created"], "D-Bus client must parse backend selection environment gates")
assert(!backend_selection_plan["request_object_created"], "D-Bus client must parse backend selection request gates")
assert(!backend_selection_plan["host_root_modified"], "D-Bus client must parse backend selection host gates")
assert(!backend_selection_plan["backend_details_exposed"], "D-Bus client must parse backend selection detail gates")
...
kde_center_page = client.kde_center_page("org.xnix.sample.notepad", "approved")
assert(kde_center_page["request_type"] == "kde-center-page", "D-Bus client must parse KDE center pages")
assert(kde_center_page["page_type"] == "compatibility-center-application-page", "D-Bus client must parse KDE center page types")
assert(kde_center_page["runtime_method"] == "GetKDECenterPage", "D-Bus client must parse KDE center page Runtime methods")
assert(kde_center_page["backend_selection_runtime_method"] == "GetBackendSelectionPlan", "D-Bus client must parse KDE center page backend selection Runtime methods")
assert(kde_center_page["backend_recommended_profile_id"] == "local-compatibility", "D-Bus client must parse KDE center page backend recommendations")
assert(kde_center_page["backend_candidate_count"] == 2, "D-Bus client must parse KDE center page backend candidate counts")
assert(!kde_center_page["backend_selection_committed"], "D-Bus client must parse disabled KDE center page backend selection commits")
assert(!kde_center_page["backend_selection_change_enabled"], "D-Bus client must parse disabled KDE center page backend selection changes")
assert(!kde_center_page["backend_launch_enabled"], "D-Bus client must parse disabled KDE center page backend launch")
assert(kde_center_page["activation_status_request_type"] == "desktop-activation-status-preview", "D-Bus client must parse KDE center page activation status snapshots")
assert(kde_center_page["activation_status_runtime_method"] == "GetDesktopActivationStatus", "D-Bus client must parse KDE center page activation status Runtime methods")
...
assert(kde_center_page["launch_intent_type"] == "runtime-launch-intent", "D-Bus client must parse KDE center page launch intent snapshots")
assert(kde_center_page["launch_intent_runtime_method"] == "Launch", "D-Bus client must parse KDE center page launch intent Runtime methods")
assert(kde_center_page["launch_intent_read_method"] == "GetLaunchIntent", "D-Bus client must parse KDE center page launch intent read methods")
assert(!kde_center_page["launch_intent_allowed"], "D-Bus client must parse disabled KDE center page launch intent allowance")
assert(!kde_center_page["launch_intent_enabled"], "D-Bus client must parse disabled KDE center page launch intent")
assert(!kde_center_page["launch_intent_request_created"], "D-Bus client must parse disabled KDE center page launch intent request creation")
assert(kde_center_page["window_identity_runtime_method"] == "GetTaskManagerIdentityPlan", "D-Bus client must parse KDE center page window identity Runtime methods")
assert(kde_center_page["window_identity_desktop_file"] == "xnix-org.xnix.sample.notepad.desktop", "D-Bus client must parse KDE center page window desktop files")
assert(kde_center_page["window_identity_grouping_key"] == "org.xnix.sample.notepad", "D-Bus client must parse KDE center page task-manager grouping")
assert(kde_center_page["window_identity_pinning_allowed"], "D-Bus client must parse KDE center page task-manager pinning")
assert(kde_center_page["window_identity_restore_allowed"], "D-Bus client must parse KDE center page restore allowance")
assert(!kde_center_page["window_identity_skip_taskbar"], "D-Bus client must parse KDE center page taskbar visibility")
assert(kde_center_page["window_identity_show_in_switcher"], "D-Bus client must parse KDE center page switcher visibility")
assert(kde_center_page["window_identity_policy_only"], "D-Bus client must parse KDE center page window policy gates")
assert(!kde_center_page["window_identity_task_manager_active"], "D-Bus client must parse disabled task-manager activation")
assert(!kde_center_page["window_identity_kwin_rule_applied"], "D-Bus client must parse disabled KWin rule application")
assert(kde_center_page["file_association_runtime_method"] == "GetFileAssociationPlan", "D-Bus client must parse KDE center page file association Runtime methods")
assert(kde_center_page["file_association_plan_type"] == "file-association-plan", "D-Bus client must parse KDE center page file association plan types")
assert(kde_center_page["file_association_desktop_file"] == "xnix-org.xnix.sample.notepad.desktop", "D-Bus client must parse KDE center page file association desktop files")
assert(kde_center_page["file_association_count"] == 2, "D-Bus client must parse KDE center page file association counts")
assert(kde_center_page["file_association_standard_mimeapps"], "D-Bus client must parse KDE center page standard MIME associations")
assert(kde_center_page["file_association_staged_root_only"], "D-Bus client must parse KDE center page staged file associations")
assert(!kde_center_page["file_association_overwrite_existing"], "D-Bus client must parse disabled MIME overwrites")
assert(kde_center_page["file_association_portal_required"], "D-Bus client must parse Portal file-open routing")
assert(!kde_center_page["file_association_direct_host_file_access"], "D-Bus client must parse disabled direct host file access")
assert(!kde_center_page["file_association_request_object_created"], "D-Bus client must parse disabled file-open request creation")
assert(!kde_center_page["file_association_permission_granted"], "D-Bus client must parse disabled file permission grants")
assert(!kde_center_page["file_association_files_written"], "D-Bus client must parse disabled file association writes")
assert(kde_center_page["tray_status_runtime_method"] == "GetTrayStatus", "D-Bus client must parse KDE center page tray Runtime methods")
assert(kde_center_page["tray_status_type"] == "tray-status-plan", "D-Bus client must parse KDE center page tray status types")
assert(kde_center_page["tray_status_active_application_count"] == 1, "D-Bus client must parse KDE center page active tray applications")
assert(kde_center_page["tray_status_attention_required_count"] == 1, "D-Bus client must parse KDE center page tray attention counts")
assert(kde_center_page["tray_status_registered_application_count"] == 1, "D-Bus client must parse KDE center page registered tray applications")
assert(kde_center_page["tray_status_compatibility_state"] == "attention-required", "D-Bus client must parse KDE center page tray compatibility state")
assert(kde_center_page["tray_status_bridge_state"] == "planned", "D-Bus client must parse KDE center page tray bridge state")
assert(kde_center_page["tray_status_bridged_application_count"].zero?, "D-Bus client must parse disabled live bridged tray applications")
assert(!kde_center_page["tray_status_live_bridge_enabled"], "D-Bus client must parse disabled live tray bridge")
assert(!kde_center_page["tray_status_bridge_configuration_persisted"], "D-Bus client must parse disabled tray bridge persistence")
assert(kde_center_page["tray_status_ready"], "D-Bus client must parse tray status readiness")
assert(kde_center_page["notification_runtime_method"] == "GetNotificationPlan", "D-Bus client must parse KDE center page notification Runtime methods")
assert(kde_center_page["notification_plan_type"] == "notification-plan", "D-Bus client must parse KDE center page notification plan types")
assert(kde_center_page["notification_event_type"] == "approval-required", "D-Bus client must parse KDE center page notification events")
assert(kde_center_page["notification_id"] == "org.xnix.sample.notepad.approval-required", "D-Bus client must parse KDE center page notification ids")
assert(kde_center_page["notification_urgency"] == "critical", "D-Bus client must parse KDE center page notification urgency")
assert(kde_center_page["notification_category"] == "compatibility.approval.required", "D-Bus client must parse KDE center page notification categories")
assert(kde_center_page["notification_action_count"] == 2, "D-Bus client must parse KDE center page notification action counts")
assert(kde_center_page["notification_requires_user_review"], "D-Bus client must parse KDE center page notification review requirements")
assert(!kde_center_page["notification_action_execution_enabled"], "D-Bus client must parse disabled notification actions")
assert(!kde_center_page["notification_repair_execution_enabled"], "D-Bus client must parse disabled notification repair execution")
assert(!kde_center_page["notification_settings_persistence_enabled"], "D-Bus client must parse disabled notification settings persistence")
assert(!kde_center_page["notification_sent"], "D-Bus client must parse disabled notification delivery")
assert(kde_center_page["notification_ready"], "D-Bus client must parse notification readiness")
...
assert(kde_center_page["runtime_owned"], "D-Bus client must parse KDE center page Runtime ownership")
assert(kde_center_page["go_runtime_backed"], "D-Bus client must parse KDE center page Go backing")
assert(kde_center_page["user_decision_allows_launch"], "D-Bus client must parse KDE center page review decisions")
assert(kde_center_page["page_preview_created"], "D-Bus client must parse KDE center page preview status")
assert(!kde_center_page["page_persisted"], "D-Bus client must parse disabled KDE center page persistence")
assert(!kde_center_page["card_actions_enabled"], "D-Bus client must parse disabled KDE center page actions")
assert(!kde_center_page["settings_persisted"], "D-Bus client must parse disabled KDE center page settings persistence")
assert(!kde_center_page["launch_enabled"], "D-Bus client must parse disabled KDE center page launch")
assert(!kde_center_page["execution_started"], "D-Bus client must parse disabled KDE center page execution")
assert(!kde_center_page["backend_details_exposed"], "D-Bus client must parse KDE center page backend detail status")

kde_center_page_sections = client.kde_center_page_sections("org.xnix.sample.notepad", "approved")
...
assert(kde_center_page_sections["section_count"] == 12, "D-Bus client must parse KDE center page section counts")
assert(kde_center_page_sections["read_only_section_count"] == 12, "D-Bus client must parse KDE center page read-only section counts")
assert(kde_center_page_sections["navigation_only_section_count"] == 12, "D-Bus client must parse KDE center page navigation-only section counts")
...
assert(kde_center_page_sections["section_ids"] == %w[overview backend activation execution launch window files tray notifications actions settings diagnostics], "D-Bus client must parse KDE center page section ids")
assert(kde_center_page_sections["runtime_methods"] == %w[GetCompatibilityCenterSummary GetBackendSelectionPlan GetDesktopActivationStatus GetExecutionReadiness GetLaunchIntent GetTaskManagerIdentityPlan GetFileAssociationPlan GetTrayStatus GetNotificationPlan GetCompatibilityActionQueue GetCompatibilitySettings GetDiagnostics], "D-Bus client must parse KDE center page section read methods")
...
assert(!kde_center_page_sections["sections_persisted"], "D-Bus client must parse disabled KDE center page section persistence")
assert(!kde_center_page_sections["section_actions_enabled"], "D-Bus client must parse disabled KDE center page section actions")
assert(!kde_center_page_sections["settings_persisted"], "D-Bus client must parse disabled KDE center page section settings persistence")
assert(!kde_center_page_sections["launch_enabled"], "D-Bus client must parse disabled KDE center page section launch")
assert(!kde_center_page_sections["execution_started"], "D-Bus client must parse disabled KDE center page section execution")
assert(!kde_center_page_sections["backend_details_exposed"], "D-Bus client must parse KDE center page section backend detail status")

kde_center_page_section_detail = client.kde_center_page_section_detail("org.xnix.sample.notepad", "settings", "approved")
assert(kde_center_page_section_detail["request_type"] == "kde-center-page-section-detail", "D-Bus client must parse KDE center page section details")
assert(kde_center_page_section_detail["page_type"] == "compatibility-center-application-page", "D-Bus client must parse KDE center page section detail page types")
assert(kde_center_page_section_detail["runtime_method"] == "GetKDECenterPageSectionDetail", "D-Bus client must parse KDE center page section detail Runtime methods")
assert(kde_center_page_section_detail["section_id"] == "settings", "D-Bus client must parse selected KDE center page section ids")
...
assert(kde_center_page_section_detail["available_section_ids"] == %w[overview backend activation execution launch window files tray notifications actions settings diagnostics], "D-Bus client must parse selected section navigation ids")
...
assert(kde_center_page_section_detail["detail_preview_created"], "D-Bus client must parse KDE center page section detail preview status")
assert(!kde_center_page_section_detail["detail_persisted"], "D-Bus client must parse disabled KDE center page section detail persistence")
assert(!kde_center_page_section_detail["section_actions_enabled"], "D-Bus client must parse disabled KDE center page section detail actions")
assert(!kde_center_page_section_detail["settings_persisted"], "D-Bus client must parse disabled KDE center page section detail settings persistence")
assert(!kde_center_page_section_detail["launch_enabled"], "D-Bus client must parse disabled KDE center page section detail launch")
assert(!kde_center_page_section_detail["execution_started"], "D-Bus client must parse disabled KDE center page section detail execution")
assert(!kde_center_page_section_detail["backend_details_exposed"], "D-Bus client must parse KDE center page section detail backend detail status")
