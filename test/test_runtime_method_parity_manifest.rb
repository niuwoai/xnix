...
assert(manifest["version"] == "0.2.89", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 38, "Runtime method parity manifest must count read-only methods")
