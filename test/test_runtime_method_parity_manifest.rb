...
assert(manifest["version"] == "0.2.81", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 31, "Runtime method parity manifest must count read-only methods")
