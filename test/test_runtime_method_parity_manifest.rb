...
assert(manifest["version"] == "0.2.163", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 55, "Runtime method parity manifest must count read-only methods")
