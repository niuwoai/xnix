...
assert(manifest["version"] == "0.2.80", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 30, "Runtime method parity manifest must count read-only methods")
