...
assert(manifest["version"] == "0.2.105", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 46, "Runtime method parity manifest must count read-only methods")
