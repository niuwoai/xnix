...
assert(manifest["version"] == "0.2.106", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 47, "Runtime method parity manifest must count read-only methods")
