...
assert(manifest["version"] == "0.2.150", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 52, "Runtime method parity manifest must count read-only methods")
