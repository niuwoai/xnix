...
assert(manifest["version"] == "0.2.98", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 40, "Runtime method parity manifest must count read-only methods")
