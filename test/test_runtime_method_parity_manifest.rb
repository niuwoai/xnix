...
assert(manifest["version"] == "0.2.152", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 54, "Runtime method parity manifest must count read-only methods")
