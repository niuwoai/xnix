...
assert(manifest["version"] == "0.2.83", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 33, "Runtime method parity manifest must count read-only methods")
