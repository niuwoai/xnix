...
assert(manifest["version"] == "0.2.96", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 39, "Runtime method parity manifest must count read-only methods")
