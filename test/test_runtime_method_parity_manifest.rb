...
assert(manifest["version"] == "0.2.107", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 48, "Runtime method parity manifest must count read-only methods")
