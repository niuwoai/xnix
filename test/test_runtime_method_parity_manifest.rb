...
assert(manifest["version"] == "0.2.101", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 42, "Runtime method parity manifest must count read-only methods")
