...
assert(manifest["version"] == "0.2.151", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 53, "Runtime method parity manifest must count read-only methods")
