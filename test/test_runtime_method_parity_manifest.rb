...
assert(manifest["version"] == "0.2.113", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 51, "Runtime method parity manifest must count read-only methods")
