...
assert(manifest["version"] == "0.2.103", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 44, "Runtime method parity manifest must count read-only methods")
