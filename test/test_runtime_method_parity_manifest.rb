...
assert(manifest["version"] == "0.2.85", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 35, "Runtime method parity manifest must count read-only methods")
