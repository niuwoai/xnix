...
assert(manifest["version"] == "0.2.104", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 45, "Runtime method parity manifest must count read-only methods")
