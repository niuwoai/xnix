...
assert(manifest["version"] == "0.2.79", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 29, "Runtime method parity manifest must count read-only methods")
