...
assert(manifest["version"] == "0.2.82", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 32, "Runtime method parity manifest must count read-only methods")
