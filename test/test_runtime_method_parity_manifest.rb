...
assert(manifest["version"] == "0.2.100", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 41, "Runtime method parity manifest must count read-only methods")
