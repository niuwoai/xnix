...
assert(manifest["version"] == "0.2.102", "Runtime method parity manifest must expose the current version")
...
assert(manifest["method_count"] == 43, "Runtime method parity manifest must count read-only methods")
