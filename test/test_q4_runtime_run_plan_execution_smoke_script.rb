...
assert(source.include?("known-app-verified-catalog-run-plan-preview"), "q4 Runtime run-plan execution smoke must generate the run plan through Go Runtime")
assert(source.include?("known-app-verified-catalog-run-plan-execution"), "q4 Runtime run-plan execution smoke must execute the run plan through Go Runtime")
...
assert(payload.fetch("runtime_command") == "known-app-verified-catalog-run-plan-execution", "plan must use the Runtime run-plan execution command")
