...
assert(contents.include?("known-app-launch-authorization-receipt-preview"), "D-Bus controlled launch owner fixture smoke must create a Runtime launch authorization receipt fixture")
assert(contents.include?("known-app-controlled-execution-session-record"), "D-Bus controlled launch owner fixture smoke must persist a controlled execution session fixture")
assert(contents.include?("known-app-session-gated-launch-review-receipt-record"), "D-Bus controlled launch owner fixture smoke must record a session-gated review receipt fixture")
assert(contents.include?("known-app-kde-runtime-status-launch-evidence-record"), "D-Bus controlled launch owner fixture smoke must persist the Runtime-status evidence handoff")
assert(contents.include?("known-app-kde-runtime-status-launch-delegated-evidence"), "D-Bus controlled launch owner fixture smoke must use the delegated Runtime-status evidence projection")
