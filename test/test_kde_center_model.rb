...
assert(model["version"] == "0.2.109", "KDE center model must expose the current version")
...
assert(application["runtime_method_parity_manifest"]["method_count"] == 50, "KDE center model must expose Runtime method counts")
