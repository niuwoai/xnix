...
assert(model["version"] == "0.2.165", "KDE center model must expose the current version")
...
assert(application["runtime_method_parity_manifest"]["method_count"] == 55, "KDE center model must expose Runtime method counts")
