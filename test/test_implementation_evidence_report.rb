...
assert(domains.fetch("runtime-owner-service").fetch("summary").include?("owner self-description and KDE shell payloads"), "Runtime owner service summary must mention owner self-description and KDE shell bridge evidence")
