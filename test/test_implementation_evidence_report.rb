...
assert(domains.fetch("runtime-owner-service").fetch("summary").include?("seven-entry-point payloads"), "Runtime owner service summary must mention seven-entry-point bridge evidence")
