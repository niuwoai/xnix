...
if go_available
  ...
  assert(kde_center_page_payload.fetch("source") == "compatibility-center-preview+backend-selection-preview+desktop-activation-status-preview+execution-readiness-preview+kde-action-card-deck-preview+settings-preview", "KDE center page preview must compose existing Runtime read models")
