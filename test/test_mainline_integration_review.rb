...
begin
  ...
  fixture.write(" M runtime/recipes/org.xnix.sample.notepad.json\n")
  ...
  fixture.write("?? cmd/xnix-runtime-go/q4_sample_notepad_acceptance_commands.go\n")
  fixture.write("?? cmd/xnix-runtime-go/q4_sample_notepad_acceptance_cli_test.go\n")
  fixture.write("?? cmd/xnix-runtime-go/q4_winapp_acceptance_commands.go\n")
  fixture.write("?? cmd/xnix-runtime-go/q4_winapp_acceptance_cli_test.go\n")
  fixture.write("?? internal/runtime/appidentity/q4_sample_notepad_acceptance.go\n")
  fixture.write("?? internal/runtime/appidentity/q4_sample_notepad_acceptance_test.go\n")
  fixture.write("?? internal/runtime/appidentity/q4_winapp_acceptance.go\n")
  fixture.write("?? internal/runtime/appidentity/q4_winapp_acceptance_test.go\n")
  fixture.write("?? scripts/q4_sample_notepad_smoke.rb\n")
  fixture.write("?? scripts/q4_winapp_smoke.rb\n")
  fixture.write("?? scripts/q4_messagebox_smoke.rb\n")
  fixture.write(" M scripts/staged_desktop_notepad_smoke.rb\n")
  fixture.write(" M scripts/staged_desktop_external_winapp_smoke.rb\n")
  fixture.write(" M scripts/staged_launcher_smoke.rb\n")
  fixture.write("?? test/test_q4_sample_notepad_smoke_script.rb\n")
  fixture.write("?? test/test_q4_winapp_smoke_script.rb\n")
  fixture.write("?? test/test_q4_messagebox_smoke_script.rb\n")
  fixture.write(" M scripts/implementation_evidence_report.rb\n")
  fixture.write(" M scripts/remote_go_test.rb\n")
  fixture.write("?? test/test_local_go_compile_guarded_smoke_scripts.rb\n")
  ...
  assert(report.fetch("changed_file_count") == 46, "mainline integration review must count included fixture files")
  ...
  assert(lanes.fetch("cw2-recipe-artifact-trust").fetch("paths").include?("runtime/recipes/org.xnix.sample.notepad.json"), "CW2 lane must include recipe registry work")
  ...
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("cmd/xnix-runtime-go/q4_sample_notepad_acceptance_commands.go"), "CW9 lane must include q4 Sample Notepad acceptance CLI work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("cmd/xnix-runtime-go/q4_sample_notepad_acceptance_cli_test.go"), "CW9 lane must include q4 Sample Notepad acceptance CLI tests")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("cmd/xnix-runtime-go/q4_winapp_acceptance_commands.go"), "CW9 lane must include q4 Windows app acceptance CLI work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("cmd/xnix-runtime-go/q4_winapp_acceptance_cli_test.go"), "CW9 lane must include q4 Windows app acceptance CLI tests")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("internal/runtime/appidentity/q4_sample_notepad_acceptance.go"), "CW9 lane must include q4 Sample Notepad acceptance model work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("internal/runtime/appidentity/q4_sample_notepad_acceptance_test.go"), "CW9 lane must include q4 Sample Notepad acceptance model tests")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("internal/runtime/appidentity/q4_winapp_acceptance.go"), "CW9 lane must include q4 Windows app acceptance model work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("internal/runtime/appidentity/q4_winapp_acceptance_test.go"), "CW9 lane must include q4 Windows app acceptance model tests")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("scripts/q4_sample_notepad_smoke.rb"), "CW9 lane must include q4 Sample Notepad smoke work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("scripts/q4_winapp_smoke.rb"), "CW9 lane must include generic q4 Windows app smoke work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("scripts/q4_messagebox_smoke.rb"), "CW9 lane must include q4 MessageBox external app smoke work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("scripts/staged_desktop_notepad_smoke.rb"), "CW9 lane must include staged desktop Notepad smoke work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("scripts/staged_desktop_external_winapp_smoke.rb"), "CW9 lane must include staged desktop external Windows app smoke work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("scripts/staged_launcher_smoke.rb"), "CW9 lane must include staged launcher smoke work")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("test/test_q4_sample_notepad_smoke_script.rb"), "CW9 lane must include q4 Sample Notepad smoke tests")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("test/test_q4_winapp_smoke_script.rb"), "CW9 lane must include generic q4 Windows app smoke tests")
  assert(lanes.fetch("cw9-windows-app-runner-path").fetch("paths").include?("test/test_q4_messagebox_smoke_script.rb"), "CW9 lane must include q4 MessageBox external app smoke tests")
  ...
  assert(lanes.fetch("cw10-evidence-drift-harness").fetch("paths").include?("scripts/remote_go_test.rb"), "CW10 lane must include q4-first remote Go test harness work")
  assert(lanes.fetch("cw10-evidence-drift-harness").fetch("paths").include?("test/test_local_go_compile_guarded_smoke_scripts.rb"), "CW10 lane must include local Go compile guard tests")
