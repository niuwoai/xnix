...
begin
  ...
  assert(report.fetch("changed_file_count") == 21, "mainline integration review must count included fixture files")
  ...
  assert(lanes.fetch("cw11-product-image-acceptance").fetch("paths") == [".dockerignore", "docs/kde-image-pipeline.md", "docs/release-evidence/v0.2.320-rc7-kde-product-smoke.json"], "CW11 lane must classify Docker context, image documentation, and persisted smoke evidence")
