...
assert(payload.fetch("delegated_command").any? { |value| value.include?("<verified-bundle-manifest>") }, "plan must show the Runtime-owned bundle path is resolved after import")
