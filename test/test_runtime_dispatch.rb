...
assert(kde_center_page_sections["section_count"] == 9, "dispatch must expose KDE center page section counts")
assert(kde_center_page_sections["read_only_section_count"] == 9, "dispatch must keep KDE center page sections read-only")
...
assert(kde_center_page_section_detail["available_section_ids"] == %w[overview backend activation execution launch window actions settings diagnostics], "dispatch must expose selected section navigation")
