...
assert(source.read.include?("go_service_call_materialization_available"), "D-Bus smoke adapter must expose Go service call materialization availability")
assert(source.read.include?("desktop-trigger-service-call-materialization-preview"), "D-Bus smoke adapter must consume Go service call materialization preview metadata")
assert(source.read.include?("--human-authorized-smoke"), "D-Bus smoke adapter must request human-authorized smoke candidate materialization")
