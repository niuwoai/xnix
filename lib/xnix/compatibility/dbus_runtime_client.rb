  ...
  module Compatibility
    class DBusRuntimeClient
      ...
      def desktop_activation_status(application_id, mode = "development")
        parse_dictionary(call("GetDesktopActivationStatus", application_id, mode))
      end
      ...
      def desktop_icon_plan(application_id)
        parse_dictionary(call("GetDesktopIconPlan", application_id))
      end
      ...
      def kde_center_page_sections(application_id, decision = "approved")
        parse_dictionary(call("GetKDECenterPageSections", application_id, decision))
      end

      def kde_center_page_section_detail(application_id, section_id, decision = "approved")
        parse_dictionary(call("GetKDECenterPageSectionDetail", application_id, section_id, decision))
      end
