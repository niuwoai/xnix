...
The project is currently at `v0.1.16`. Its first target is a minimal x86_64 Linux system that boots in QEMU and manages OpenSSH `sshd` through its init process.
