...
> Last updated: 2026-07-12 | Current version: v0.2.1
...
- [ ] C1: Activated Runtime implementation and signed recipe storage. The local daemon core and managed recipe-store loader are in place; D-Bus ownership and signature validation are still pending.
