...
> Last updated: 2026-07-12 | Current version: v0.2.4
...
- [ ] C1: Activated Runtime implementation and signed recipe storage. The local daemon core, managed recipe-store loader, read-only method dispatcher, packaged activation wrapper, and activation-file installer are in place and smoke-tested in the constrained container; D-Bus ownership and signature validation are still pending.
