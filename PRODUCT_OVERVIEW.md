...
> Last updated: 2026-07-14 | Current version: v0.2.75
...
- Compatibility Center action queues delegate to `xnix-compat-action-queue`, which groups install readiness, settings changes, AI repair review, Runtime service ownership, and Portal policy review into non-executing task cards for KDE.
- Compatibility Center action review receipts delegate to `xnix-compat-action-review`, which records KDE review intent without treating that intent as Runtime execution approval.
