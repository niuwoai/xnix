...
> Last updated: 2026-07-14 | Current version: v0.2.74
...
- Compatibility install planning delegates to `xnix-compat-install-plan`, which joins artifact manifest, acquisition preflight, package source, state root, and recipe install gate readiness before any artifact download, desktop activation, host-root mutation, or backend launch is enabled.
...
| Compatibility install plan | Runtime joins artifact, acquisition, package source, state, and recipe gate readiness before desktop activation or backend launch |
