...
> Last updated: 2026-07-12 | Current version: v0.2.5
...
- [ ] C1: Activated Runtime implementation and signed recipe storage. The local daemon core, managed recipe-store loader, read-only method dispatcher, packaged activation wrapper, activation-file installer, and Linux D-Bus session smoke adapter are in place; production daemon binding and signature validation are still pending.
