...
- `docs/claude-code-priority-implementation-packages.md`
...
Those files provide deeper package details. `docs/claude-code-priority-implementation-packages.md` is the copy-first board for assigning the next large Claude Code implementation package, `docs/claude-code-domain-dispatch.md` provides deeper domain detail, and `docs/claude-code-large-empty-domain-assignments.md` remains the coarse dispatcher for branch-sized empty-domain work. This file provides the mainline dispatch order and copyable task boundaries.
