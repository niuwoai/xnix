...
For large empty-domain packages where existing contracts need durable implementation evidence, use `docs/claude-code-empty-domain-implementation-packages.md`.
