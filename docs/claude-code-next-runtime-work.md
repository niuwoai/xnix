...
> Last updated: 2026-07-24 | Baseline: v0.2.637
...
The current baseline is `v0.2.637`.
...
- The KDE-facing action stub now has a Go-owned restricted session-bus smoke plan, but no smoke harness consumes the plan yet.
