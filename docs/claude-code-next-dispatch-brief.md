...
| 1 | `C9W3` Merge readiness consumes request preflight smoke evidence | `codex/merge-readiness-preflight-smoke-evidence` | Dispatch after `C9W2` is reviewed. |
| 2 | `C9W4` Release evidence index consumes request preflight smoke evidence | `codex/release-evidence-preflight-smoke-evidence` | Dispatch after `C9W2` lands and `C9W3` is reviewed. |
| 3 | `C9W5` Runtime owner request receipt preview | `codex/runtime-owner-request-receipt-preview` | Dispatch after formal `v0.2.640` promotion or explicit Codex approval to continue pre-release modeling. |
| 4 | `C9W6` KDE Center desktop-trigger preflight card | `codex/kde-center-desktop-trigger-preflight-card` | Dispatch after `C9W5` lands. |
