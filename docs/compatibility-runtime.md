...
- The Compatibility Center may show Runtime service binding status and live owner gates, but Runtime code must own D-Bus activation, systemd hardening, production bus ownership, and smoke-adapter boundaries.
