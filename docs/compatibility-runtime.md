...
- The C Runtime core must expose stable Runtime identity, safe application catalog records, compatibility engine catalog records, and write-gate decisions without enabling backend execution.
