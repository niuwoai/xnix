...
- The Compatibility Center may show Runtime service binding status, live owner gates, and owner smoke plans, but Runtime code must own D-Bus activation, systemd hardening, production bus ownership, smoke-adapter boundaries, and write-method rejection.
