...
1. `C8W5` from `docs/claude-code-live-delegation-brief.md`: Managed launcher acceptance report.
2. `C8W6` from `docs/claude-code-live-delegation-brief.md`: Post-checkpoint promotion checklist.
3. `C8W7` from `docs/claude-code-live-delegation-brief.md`: Desktop-trigger dry-run request review.
...
| 1 | `C8W5` Managed launcher acceptance report | `docs/claude-code-live-delegation-brief.md` | `codex/managed-launcher-acceptance-report` | Tie known-app smoke evidence, launcher bridge evidence, and Compatibility Center projection into a user-safe acceptance report. |

## Best First Pick

Start with `C8W5` from `docs/claude-code-live-delegation-brief.md`.

`C8W1` is already present locally in v0.2.640-rc2, `C8W2` is present locally in v0.2.640-rc3, `C8W3` is present locally in v0.2.640-rc4, and `C8W4` is present locally in v0.2.640-rc5. Dispatch `C8W5` next to connect the managed launcher evidence chain into a user-safe acceptance report.
