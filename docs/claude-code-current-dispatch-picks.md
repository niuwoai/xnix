...
1. `C8W4` from `docs/claude-code-live-delegation-brief.md`: KDE controlled-launch action surface audit.
2. `C8W5` from `docs/claude-code-live-delegation-brief.md`: Managed launcher acceptance report.
3. `C8W6` from `docs/claude-code-live-delegation-brief.md`: Post-checkpoint promotion checklist.
...
| --- | --- | --- | --- | --- |
| Done | `C8W2` Desktop-trigger staged invocation readiness packet | `docs/claude-code-next-work-after-0640-rc1.md` | `codex/desktop-trigger-staged-invocation-readiness` | Present locally in v0.2.640-rc3. Do not dispatch again unless a reviewer asks for repair. |
| Done | `C8W3` Runtime owner service launch request envelope guard | `docs/claude-code-live-delegation-brief.md` | `codex/owner-service-launch-envelope-guard` | Present locally in v0.2.640-rc4. Do not dispatch again unless a reviewer asks for repair. |
| 1 | `C8W4` KDE controlled-launch action surface audit | `docs/claude-code-live-delegation-brief.md` | `codex/kde-controlled-launch-action-surface-audit` | Verify KDE controlled-launch action metadata stays presentation-only before real desktop-trigger smoke work begins. |

## Best First Pick

Start with `C8W4` from `docs/claude-code-live-delegation-brief.md`.

`C8W1` is already present locally in v0.2.640-rc2, `C8W2` is present locally in v0.2.640-rc3, and `C8W3` is present locally in v0.2.640-rc4. Dispatch `C8W4` next to audit the KDE controlled-launch action surface before any broader desktop-triggered staged launch work.
