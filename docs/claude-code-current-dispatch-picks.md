...
> Last updated: 2026-07-19 | Baseline: v0.2.336
...
| --- | --- | --- | --- | --- |
| 1 | Restricted owner smoke fan-out owner-local read route | `docs/windows-app-compatibility-implementation-brief.md` | `codex/restricted-owner-smoke-fanout-owner-route` | Use the v0.2.335 opaque receipt lookup to route the read-only fan-out without caller state-root paths, while keeping missing receipts fail-closed. |
| 2 | Materialization fan-out owner-managed receipt lookup | `docs/windows-app-compatibility-implementation-brief.md` | `codex/materialization-fanout-owner-receipt-lookup` | Add the owner-managed opaque materialization receipt lookup identified by the v0.2.336 route audit before adding an owner-local fan-out route. |
