...
> Last updated: 2026-07-19 | Baseline: v0.2.338
...
| --- | --- | --- | --- | --- |
| 1 | Materialization fan-out owner-local read route | `docs/windows-app-compatibility-implementation-brief.md` | `codex/materialization-fanout-owner-route` | Consume the v0.2.338 owner-managed opaque materialization receipt lookup from owner dispatch without caller registry or state-root paths. |
| 2 | Restricted owner smoke fan-out owner smoke coverage | `docs/windows-app-compatibility-implementation-brief.md` | `codex/restricted-owner-smoke-fanout-owner-smoke-coverage` | Add restricted owner smoke evidence for the v0.2.337 owner-local fan-out route before considering broader exposure. |
