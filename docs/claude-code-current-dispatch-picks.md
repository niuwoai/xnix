...
1. `C8W2` from `docs/claude-code-next-work-after-0640-rc1.md`: Desktop-trigger staged invocation readiness packet.
2. `C8W3` from `docs/claude-code-next-work-after-0640-rc1.md`: Runtime owner service launch request envelope guard.
3. `C8W4` from `docs/claude-code-next-work-after-0640-rc1.md`: KDE controlled-launch action surface audit.
...
Start with `C8W2` from `docs/claude-code-next-work-after-0640-rc1.md`.

`C8W1` is already present locally in v0.2.640-rc2. Dispatch `C8W2` and then `C8W3` to prepare the real desktop-triggered staged launch lane while preserving Runtime ownership boundaries.
