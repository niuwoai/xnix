...
1. `C8W6` from `docs/claude-code-current-execution-queue.md`: Post-checkpoint promotion checklist.
2. `C8W7` from `docs/claude-code-current-execution-queue.md`: Desktop-trigger dry-run request review.
