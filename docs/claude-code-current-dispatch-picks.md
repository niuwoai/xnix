...
> Last updated: 2026-07-19 | Baseline: v0.2.339
...
| --- | --- | --- | --- | --- |
| 1 | Materialization fan-out owner smoke coverage | `docs/windows-app-compatibility-implementation-brief.md` | `codex/materialization-fanout-owner-smoke-coverage` | Cover the v0.2.339 owner-local materialization fan-out route in restricted owner smoke evidence before considering broader exposure. |
